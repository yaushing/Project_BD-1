...
Επιθυμεί κάποιος να παρέμβει υπέρ αυτής της πρότασης ; Κυρία Πρόεδρε , παρεμβαίνω για να υποστηρίξω την απόφαση της Διάσκεψης των Προέδρων και δράττομαι της ευκαιρίας προκειμένου να πω ότι , όπως εγώ άσκησα δημόσια κριτική στο Προεδρείο τον Ιανουάριο , αυτή τη στιγμή , εξ ονόματος εμού του ιδίου καθώς και της Σοσιαλιστικής Ομάδας , θεωρούμε ότι οι δηλώσεις που έκανε το Προεδρείο για αυτό το θέμα ήταν οι πρέπουσες , τις ασπαζόμαστε ως προς την ουσία , ως προς τον χρόνο και ως προς τη διατύπωση .
( Χειροκροτήματα ) Κατόπιν τούτου , κυρία Πρόεδρε , πραγματικά είναι δύσκολο να βρούμε συζήτηση που να είναι πιο ενδεδειγμένη βάσει του άρθρου 50 του Κανονισμού μας .
Πρόκειται για μια συζήτηση επί επίκαιρου , εξαιρετικά σημαντικού και επείγοντος θέματος .
Για τον λόγο αυτό , πιστεύουμε ότι οφείλουμε να τροποποιήσουμε την ημερήσια διάταξη προκειμένου να συμπεριληφθεί αυτή η συζήτηση .
( Χειροκροτήματα ) .
Επιθυμεί κάποιος συνάδελφος να παρέμβει κατά αυτής της πρότασης ; Κυρία Πρόεδρε , θα παρέμβω πράγματι κατά αυτής της πρότασης για έναν λόγο αρχής που θεωρώ απολύτως ουσιαστικό και που σχετίζεται την τήρηση των Συνθηκών , και ιδίως του άρθρου 7 της Συνθήκης του Αμστερνταμ .
...
Ακούσαμε μια παρέμβαση υπέρ και μια παρέμβαση κατά .
Θα θέσω επομένως σε ψηφοφορία την πρόταση τροποποίησης της ημερήσιας διάταξης .
( Το Σώμα εγκρίνει την πρόταση ) ( Χειροκροτήματα ) Η εν λόγω συζήτηση εγγράφεται ως πρώτο θέμα της ημερήσιας διάταξης .
...
Κυρία Πρόεδρε , κύριοι βουλευτές , ζητήθηκε από εμένα να καταθέσω ενώπιον αυτού του Κοινοβουλίου , εξ ονόματος της πορτογαλικής Προεδρίας της Ευρωπαϊκής Ένωσης , τη θέση που υιοθετούμε έναντι της πολιτικής κατάστασης που επικρατεί σήμερα στην Αυστρία , καθώς και έναντι των συνεπειών αυτής της κατάστασης στις σχέσεις της συγκεκριμένης χώρας με τα υπόλοιπα κράτη που απαρτίζουν την Ένωση .
Καταρχάς , θα ήθελα να καταστήσω σαφές ότι η δήλωση που κοινοποίησε στις 31 Ιανουαρίου ο Πορτογάλος Πρωθυπουργός , εκπροσωπώντας και τρεις άλλες χώρες που επίσης είναι κράτη μέλη της Ένωσης , κινείται προς αυτήν ακριβώς την κατεύθυνση , συνιστά δηλαδή μία πολιτική τοποθέτηση επί του συγκεκριμένου προβλήματος , την οποία ενέκριναν οι αρχηγοί κρατών και κυβερνήσεων δεκατεσσάρων χωρών και που η Πορτογαλία δημοσιοποίησε εξ ονόματος όλων .
Το κείμενο της εν λόγω κοινής θέσης εντάσσεται σε ένα ξεκάθαρο πλαίσιο και προσδιορίζει με σαφήνεια τις επιπτώσεις της δήλωσης : αφορά τις διμερείς σχέσεις που θα διαμορφωθούν ανάμεσα στην καθεμιά εκ των προαναφερόμενων δεκατεσσάρων χωρών και μία αυστριακή κυβέρνηση , στην οποία ενδεχομένως θα συμμετείχαν μέλη του Κόμματος της Ελευθερίας εκείνης της χώρας .
Σας υπενθυμίζω το περιεχόμενο αυτής της δήλωσης .
1 - Οι κυβερνήσεις των δεκατεσσάρων κρατών μελών δεν θα προωθήσουν ούτε θα αποδεχθούν οποιαδήποτε επίσημη διμερή επαφή σε πολιτικό επίπεδο με μία αυστριακή κυβέρνηση στην οποία θα συμμετέχει το FPΦ .
...
Εκτιμώ ότι τις τελευταίες ημέρες κατέστησαν αρκετά εμφανείς οι λόγοι που οδήγησαν στην ανάληψη της παραπάνω θέσης από πλευράς των δεκατεσσάρων κρατών μελών .
Επί της ουσίας , η ερμηνεία της εσωτερικής πολιτικής κατάστασης στην Αυστρία , στην οποία προέβησαν από κοινού τα δεκατέσσερα κράτη μέλη , οδήγησε στο συμπέρασμα ότι μια πιθανή συμμετοχή ενός κόμματος , όπως το FPΦ , στην κυβέρνηση της Βιέννης , ενδέχεται να επιφέρει αλλαγές , όσον αφορά την προσήλωση στα πρότυπα των κοινών αξιών , τις οποίες δεσμεύθηκαν να διαφυλάξουν οι χώρες που απαρτίζουν την Ευρωπαϊκή Ένωση .
Όλοι γνωρίζουμε τις θέσεις που εξέφρασε δημοσίως ο κ. Jφrg Haider , όπως επίσης και ορισμένες αντιλήψεις επί θεμάτων συγκεκριμένων πολιτικών τις οποίες το κόμμα του έχει κατά καιρούς υπερασπιστεί .
Νομίζω πως δεν χρειάζεται να σας υπενθυμίσω τις δηλώσεις του με τις οποίες απαλλάσσει από ευθύνες το ναζιστικό καθεστώς , τη στάση του έναντι των παροικιών των αλλοδαπών ή των κοινοτήτων των μεταναστών , καθώς και την προπαγάνδιση ενός λαϊκιστικού εθνικισμού που μας παραπέμπει σε άλλες εποχές .
Η κοινή μας ερμηνεία της κατάστασης συνίσταται στο ότι το συγκεκριμένο κόμμα πρεσβεύει μια άποψη η οποία βρίσκεται σε κατάφωρη αντίθεση με τις αξίες που θεωρούμε θεμελιώδεις σε ευρωπαϊκό επίπεδο , αξίες άλλωστε οι οποίες διαμορφώνουν το πλαίσιο αναφοράς που η Ένωση έχει προωθήσει στις εξωτερικές της σχέσεις , τόσο όσον αφορά την επικείμενη διεύρυνση όσο και στο πλαίσιο της κοινής της εξωτερικής πολιτικής και πολιτικής ασφαλείας .
Θα μπορούσε κανείς να ισχυριστεί ότι η παρούσα κατάσταση απορρέει από την ελεύθερη ετυμηγορία του εκλογικού σώματος της Αυστρίας , που πρέπει να γίνει σεβαστή , και ότι οιαδήποτε στάση τηρούμε σε αυτό το ζήτημα θα μπορούσε να αποτελέσει ανάμειξη στις εσωτερικές υποθέσεις εκείνης της χώρας .
Καταρχάς , κυρία Πρόεδρε και κύριοι βουλευτές , κανείς δεν θέτει υπό αμφισβήτηση τη λειτουργία ενός δημοκρατικού πολιτεύματος στην Αυστρία , ούτε την ετυμηγορία που εκφράστηκε στο αποτέλεσμα των πρόσφατων εκλογών .
Οι εκλογές αυτές ανέδειξαν το γεγονός - και πρέπει και αυτό να καταστεί σαφές - ότι η μεγάλη πλειοψηφία των Αυστριακών συνεχίζει να τάσσεται κατά του κόμματος του κυρίου Jφrg Haider .
Εκεί όπου προβάλλουμε ένσταση , και συγχρόνως εκφράζουμε τη λύπη μας , είναι στο ότι προκρίθηκε μία κυβερνητική λύση , βάσει της οποίας ένα μέρος της πολιτικής εξουσίας αυτής της χώρας εναποτίθεται στα χέρια ενός κόμματος του οποίου οι ηγέτες δεν προσφέρουν έστω και το παραμικρό εχέγγυο ότι θα παραμείνουν προσηλωμένοι στις θεμελιώδεις αρχές που η Αυστρία δεσμεύθηκε να σεβαστεί , να υπερασπιστεί και να προωθήσει .
( Χειροκροτήματα ) Η Αυστρία έχει κάθε δικαίωμα να επιλέξει την κυβέρνηση που θεωρεί ενδεδειγμένη , αλλά και εμείς , από την πλευρά μας , έχουμε επίσης το δικαίωμα και το καθήκον να εκφράσουμε τη γνώμη μας σχετικά με όλες τις επιλογές πολιτικού χαρακτήρα που εκτιμούμε πως αντίκεινται στις δεσμεύσεις που ανέλαβε η Αυστρία σε διεθνή κλίμακα .
Αυτό ισχύει σήμερα για την Αυστρία , όπως θα ισχύει στο μέλλον για οποιαδήποτε άλλη χώρα της Ευρωπαϊκής Ένωσης .
( Χειροκροτήματα ) Επαναλαμβάνω : αυτό ισχύει σήμερα για την Αυστρία , όπως θα ισχύει στο μέλλον για οποιοδήποτε άλλο κράτος μέλος της Ευρωπαϊκής Ένωσης .
Από την άλλη μεριά , όλοι γνωρίζουμε ότι , τη σήμερον ημέρα , τα ζητήματα που αφορούν τα ανθρώπινα δικαιώματα , τα θεμελιώδη δικαιώματα , τις βασικές δημοκρατικές αρχές και τις αρχές του κράτους δικαίου , τους κανόνες προστασίας των μειονοτήτων και την πάλη κατά του ρατσισμού , της ξενοφοβίας και της μισαλλοδοξίας δεν συνιστούν πλέον αποκλειστικά εσωτερικές υποθέσεις της οποιασδήποτε χώρας .
Και προπαντός όταν η εν λόγω χώρα είναι μέλος μίας κοινότητας κρατών η οποία τοποθετεί αυτά τα πρότυπα στο επίκεντρο του πολιτισμικού σχεδίου που πρεσβεύει .
Η Ευρώπη που προσδοκούμε να οικοδομήσουμε και να εδραιώσουμε έπαυσε πλέον να αποτελεί ένα αμιγώς οικονομικό εγχείρημα , και συνιστά στο εξής μία κοινότητα αξιών και αρχών που ενδέχεται να αποτελέσει το υπόβαθρο για τη δημιουργία μίας πολιτικής ένωσης και την εγκαθίδρυση ενός μεγάλου χώρου ελευθερίας , ασφάλειας και δικαιοσύνης , ο οποίος θα διαπνέεται από τις αρχές της αλληλεγγύης .
( Χειροκροτήματα ) Για το λόγο αυτό , κυρία Πρόεδρε και κύριοι βουλευτές , θεωρούμε ότι έχουμε το δικαίωμα αλλά και το χρέος να επισημάνουμε στους Αυστριακούς φίλους μας , όπως άλλωστε το έπραξαν και άλλες χώρες εκτός Ευρωπαϊκής Ένωσης , ότι η κυβερνητική επιλογή που προέκριναν δεν μπορεί να μην έχει συνέπειες σε ό , τι αφορά τις μορφές σχέσεων που θα αναπτύξουμε μαζί τους στο μέλλον , σε περίπτωση που το κόμμα του κυρίου Haider συμμετάσχει στην κυβέρνηση της χώρας .
Αναφορικά με τις επιπτώσεις επί του πρακτέου , τις οποίες άφησε κάπως να εννοηθούν η δήλωση που δημοσιοποίησε εχθές η Επιτροπή , η Ευρωπαϊκή Ένωση θα επιδιώξει να συνεχίσει να λειτουργεί , παρακολουθώντας ωστόσο με ιδιαίτερη προσοχή την εξέλιξη της συμπεριφοράς και της δράσης της προσεχούς αυστριακής κυβέρνησης , προφανώς στο πλαίσιο της αυστηρής τήρησης των Συνθηκών .
Το κοινοτικό πλαίσιο συνιστά ένα ειδικό πεδίο δραστηριότητας που διέπεται από πολύ συγκεκριμένους πολιτικούς και νομικούς κανόνες , οπότε και αυτό θα αποτελέσει το αντικείμενο ιδιαίτερων χειρισμών .
Θα προσπαθήσουμε , επομένως , να εξασφαλίσουμε ότι η παρούσα κατάσταση δεν θα επηρεάσει τη λειτουργία της κοινοτικής μηχανής .
( Παρατεταμένα χειροκροτήματα ) Κυρία Πρόεδρε , κυρίες και κύριοι βουλευτές , η Επιτροπή συνεδρίασε χθες το πρωί και έλαβε , στο πλαίσιο της αυτονομίας της και με την κοινή βούληση όλων των μελών της Διάσκεψης των Προέδρων , πολιτικές αποφάσεις εξαιρετικής σημασίας .
Είχε ήδη δηλώσει χθες ότι συμμερίζεται τις ανησυχίες που εξέφρασαν 14 χώρες μέλη της Ένωσης και οι οποίες επαναδιατυπώθηκαν εδώ από την αντιπροσωπία της Προεδρίας .
Σήμερα , ενώπιόν σας , εξ ονόματος ολόκληρης της Διάσκεψης των Προέδρων , έχω τη δυνατότητα να επαναλάβω αυτές τις ανησυχίες .
Επιτρέψτε μου , κυρίως , να επιστήσω ιδιαίτερα την προσοχή σας σε όσα περιλαμβάνει , σε μια στιγμή όπως η παρούσα , ο πολιτικός ρόλος της Επιτροπής .
Όπως ακριβώς και το Κοινοβούλιο , η Επιτροπή είναι ένα υπερεθνικό θεσμικό όργανο της Ένωσης το οποίο , λόγω της ιδιότητάς του αυτής , δεν διατηρεί διμερείς διπλωματικές σχέσεις με τα κράτη μέλη .
Τη στιγμή ακριβώς κατά την οποία η συνέχεια , η συνοχή και η προστασία των αξιών της Ένωσης φαίνεται να απειλούνται , ο πολιτικός ρόλος της Επιτροπής αποβαίνει πιο ισχυρός και πιο σαφής .
Ας θυμηθούμε , κυρίες και κύριοι βουλευτές , ότι η Συνθήκη της Ρώμης δεν προβλέπει καμία ρήτρα εξόδου , ούτε εθελοντικής ούτε αναγκαστικής , για ένα κράτος μέλος .
Και αυτό γιατί η λογική , η ίδια η προϋπόθεση αυτού του εξαιρετικού οικοδομήματος που αποτελεί η Ευρωπαϊκή Ένωση , είναι ότι κάθε κράτος , από τη στιγμή κατά την οποία γίνεται μέλος της Ένωσης , αποδέχεται εις βάθος και δια παντός τις θεμελιώδεις αρχές .
Εξάλλου , οι Συνθήκες περιέχουν συγκεκριμένες διατάξεις ώστε οι αρχές αυτές να γίνονται σεβαστές .
Κατά την έννοια αυτή , η Επιτροπή θα παραιτούνταν από το ρόλο της στην περίπτωση που έπαυε να διατηρεί σχέσεις εργασίας με την Αυστρία , καθώς και με το καθένα από τα κράτη μέλη .
Κυρίες και κύριοι βουλευτές , όταν ένα από τα μέλη της αντιμετωπίζει δυσκολίες , ολόκληρη η Ένωση αντιμετωπίζει δυσκολίες .
( Χειροκροτήματα ) Το καθήκον ενός ισχυρού υπερεθνικού θεσμικού οργάνου δεν είναι να απομονώνει ένα από τα μέλη του , αλλά να το συνδέει με άρρηκτο τρόπο με τις βαθύτερες αξίες του .
Σε αυτό το καθήκον θα αφιερωθεί η Επιτροπή επιδεικνύοντας τη μέγιστη επιμονή .
Αφ ' ετέρου , δεν υπάρχει καμία ανάγκη να πούμε ότι η Επιτροπή θα συνεχίσει να παρακολουθεί βήμα προς βήμα τις εξελίξεις της κατάστασης στην Αυστρία .
Η Ευρωπαϊκή Ένωση , πράγματι , δεν μπορεί να επιζήσει χωρίς τις αρχές ελευθερίας , δημοκρατίας και σεβασμού των ανθρωπίνων δικαιωμάτων .
Αυτά είναι τα θεμέλια της Ένωσης .
Αυτά είναι ο ίδιος ο λόγος ύπαρξης της Ένωσης .
Είναι ο καρπός και η αντανάκλαση της επίσημης δέσμευσης που ανέλαβαν όλα τα κράτη μέλη για το σεβασμό των ατόμων και των λαών , όποια και αν είναι η πίστη τους , η προέλευσή τους και η κατάστασή τους .
Αυτές οι αρχές είναι συνυφασμένες με το σεβασμό του κράτους δικαίου και η Επιτροπή , που είναι ο εγγυητής του κράτους δικαίου , θα είναι αμείλικτη όσον αφορά την προστασία τους .
Έχουμε σκοπό να τιμωρούμε με το σκληρότερο τρόπο , ακόμα και την παραμικρή παραβίαση στο επίπεδο των δικαιωμάτων των ατόμων και της οποιασδήποτε μειονότητας .
Η Ευρώπη , όπως μου είπε βουλευτής κοινοβουλίου μιας εκ των υποψηφίων χωρών , είναι μια ένωση μειονοτήτων και , ως τέτοια , απαιτεί ένα βαθύ αίσθημα σεβασμού από την πλευρά όλων μας .
Κυρία Πρόεδρε , κυρίες και κύριοι βουλευτές , επιτρέψτε μου και έναν ακόμα πολύ σύντομο συλλογισμό .
Με τα 900 και πλέον χρόνια ζωής του , το Πανεπιστήμιο της Μπολόνια , η alma mater μου , είναι το αρχαιότερο πανεπιστήμιο του κόσμου .
Στους τοίχους μιας από τις ωραιότερες αίθουσές του υπάρχουν ακόμα τα οικόσημα των σπουδαστών και των καθηγητών που είχαν επιλέξει αυτό το πανεπιστήμιο , πριν από πολλούς αιώνες , ως τόπο μάθησης .
Υπάρχουν ακόμα 7000 οικόσημα από ολόκληρη την Ευρώπη , από την Τρανσυλβανία έως την Αγγλία .
Αυτή ήταν η Ευρώπη , από τότε ακόμα : ένας χώρος στον οποίο τα ιδεολογικά σύνορα δεν γνώριζαν τα όρια και τους περιορισμούς της πολιτικής του καιρού εκείνου : μια κοινότητα που μοιραζόταν τις ίδιες αξίες , ιδανικά και γνώσεις .
Αλλά η ιστορία της Ευρώπης δεν υφάνθηκε μόνο από πολιτιστικές ανταλλαγές , από τη διάδοση των γνώσεων και από τη συμμετοχή σε έναν ανθεκτικό πυρήνα κοινά αποδεκτών αξιών .
Απέναντι στα οικόσημα των πανεπιστημιακών κοινοτήτων , σε κάθε μικρό χωριό ή χώρα της Ευρώπης τα μνημεία για τους πεσόντες στους πολέμους μαρτυρούν τις τραγωδίες της ηπείρου μας .
Η ευρωπαϊκή ιστορία σημαδεύτηκε με την πάροδο των αιώνων από μια αδιάκοπη αλληλουχία πολέμων και συγκρούσεων .
Λίκνο πολιτισμού , η Ευρώπη γέννησε τις πιο τρομακτικές φρικαλεότητες της ανθρώπινης ιστορίας .
Για το λόγο αυτό , ως πρώτη ενέργεια της προεδρίας μου , επέλεξα να μεταβώ προσκυνητής στο Αουσβιτς , για να διακηρύξω δυναμικά , με τη σιγή που απαιτείται σε αυτόν τον κατ ' εξοχήν χώρο μνήμης , ότι η Ευρώπη δεν ξεχνά και για να επαναλάβω ότι η Ευρώπη του σήμερα και του αύριο είναι , δεν μπορεί παρά να είναι και θα είναι για πάντα , μια ένωση ελευθερίας , δικαίου , ασφάλειας και ειρήνης .
Ελευθερία , δίκαιο , ασφάλεια και ειρήνη : αυτό ακριβώς ήταν , πράγματι , η Ευρωπαϊκή Ένωση και αυτό εξακολουθεί να είναι .
Το πιο εκπληκτικό , θαρραλέο και ευτυχές πολιτικό οικοδόμημα του αιώνα που μόλις έκλεισε , κατάφερε να εγγυηθεί στους πολίτες της ελευθερία , δίκαιο , ασφάλεια και ειρήνη .
Και αυτό ακριβώς θέλει να προσφέρει η ενωμένη Ευρώπη , κατά τον αιώνα που ξεκινά , σε αυτούς που ετοιμάζονται να ενταχθούν σε αυτήν .
Σήμερα το απόγευμα , αυτήν ακριβώς τη στιγμή , έπρεπε να βρίσκομαι στο Πανεπιστήμιο του Λοβάνιο για να λάβω , μαζί με το γάλλο Πρωθυπουργό και τη γενική διευθύντρια της Παγκόσμιας Οργάνωσης Υγείας , κυρία Brundtland , ένα δίπλωμα τιμής ένεκεν .
Θα φτάσω με λίγη καθυστέρηση στην τελετή αυτή αλλά πιστεύω ότι δεν υπάρχει σωστότερος τρόπος για τιμήσω ένα πανεπιστήμιο , το οποίο είναι ένα από τα υψηλότερα σύμβολα της ευρωπαϊκής γνώσης , από το να έρθω εδώ , ενώπιον του Κοινοβουλίου , που αποτελεί την υψηλότερη έκφραση της λαϊκής κυριαρχίας , για να δηλώσω την ένθερμη δέσμευση , εμού προσωπικά αλλά και της Ευρωπαϊκής Επιτροπής , για την προστασία των αρχών εκείνων που αποτελούν το συστατικό θεμέλιο της ενωμένης Ευρώπης .
( Χειροκροτήματα ) Κυρία Πρόεδρε , κύριε Πρόεδρε της Eπιτροπής , συνάδελφοι , η ομάδα του Ευρωπαϊκού Λαϊκού Κόμματος ( Χριστιανοδημοκράτες ) και των Ευρωπαίων Δημοκρατών παρακολουθεί τα γεγονότα και τη συζήτηση για τις εξελίξεις στην Αυστρία με ανησυχία και ένταση .
Στους κόλπους της Ομάδας μας διεξαγάγαμε μια συναισθηματικά πολύ φορτισμένη συζήτηση - και αυτό το ομολογώ ευχαρίστως μια και το θεωρώ δείγμα δύναμης για την Ομάδας μας .
Για κανένα άλλο πρόβλημα , για κανένα άλλο ζήτημα δεν έχει ποτέ ζητηθεί τόσο πολλές φορές ο λόγος όπως έγινε σήμερα στην Ομάδα μας και ευχαριστώ όλους τους συναδέλφους που εκφράστηκαν με τέτοια σοβαρότητα .
Και για να είμαστε σαφείς , η Ομάδα του Ευρωπαϊκού Λαϊκού Κόμματος ( Χριστιανοδημοκράτες ) και των Ευρωπαίων Δημοκρατών έχει ενιαία άποψη όσον αφορά την κριτική της σε πολλές από τις δηλώσεις του αρχηγού του Κόμματος της Ελευθερίας στην Αυστρία .
Καταδικάζουμε τους πρόσφατους εκτροχιασμούς του και ειδικά εκείνους κατά του Γάλλου Προέδρου Jacques Chirac και της βελγικής κυβέρνησης , και τους απορρίπτουμε κατηγορηματικότατα .
( Χειροκροτήματα ) Εμείς , η Ομάδα του Ευρωπαϊκού Λαϊκού Κόμματος ( Χριστιανοδημοκράτες ) και των Ευρωπαίων Δημοκρατών τασσόμαστε υπέρ της ανθρώπινης αξιοπρέπειας , του κράτους δικαίου , της δημοκρατίας και της ελευθερίας και υπερασπιζόμαστε τις αξίες αυτές τόσο προς το αριστερό όσο και προς το δεξιό άκρο του πολιτικού φάσματος .
( Χειροκροτήματα ) Οι Χριστιανοδημοκράτες , οι οποίοι αποτελούν σημαντικό πυρήνα της Ομάδας μας -πράγμα που ίσως να μην το γνωρίζουν πολλοί -δημιουργήθηκαν μέσα από την αντίσταση στον ολοκληρωτισμό του εθνικοσοσιαλισμού ο οποίος περιφρονούσε την ανθρώπινη αξιοπρέπεια , αλλά επίσης και μέσα από την αντίσταση στον ολοκληρωτισμό του κομμουνισμού που περιφρονούσε εξίσου την ανθρώπινη αξιοπρέπεια .
( Χειροκροτήματα ) Υποστηρίζουμε και σήμερα ως Ομάδα του Ευρωπαϊκού Λαϊκού Κόμματος ( Χριστιανοδημοκράτες ) και των Ευρωπαίων Δημοκρατών τις αξίες των ιδρυτών της Ευρωπαϊκής Ένωσης Robert Schuman , Alcide de Gasperi , Konrad Adenauer και Winston Churchill , αλλά και πολλών άλλων .
Οι αξίες αυτές εξακολουθούν και σήμερα , το έτος 2000 , να είναι και δικές μας αξίες .
Οι αρχές αυτές αποτελούν επίσης το μέτρο με το οποίο κρίνουμε τις δραστηριότητες , τις πράξεις και τα λόγια όχι μόνο στα κράτη μέλη αλλά και στις κυβερνήσεις στις οποίες ανήκουμε .
Εδώ τονίζω ότι έχουμε εμπιστοσύνη στους Αυστριακούς φίλους μας του Ευρωπαϊκού Λαϊκού Κόμματος της Αυστρίας .
( Χειροκροτήματα ) Οφείλουμε να υπενθυμίσουμε ότι το Αυστριακό Λαϊκό Κόμμα με επικεφαλής τους Alois Mock και Wolfgang Schόssel - ο ένας ήταν Υπουργός Οικονομικών και ο άλλος Εξωτερικών - ήταν εκείνο που περισσότερο από κάθε άλλο κόμμα προετοίμασε την πορεία της Αυστρίας προς την Ευρωπαϊκή Ένωση .
Θυμόμαστε επίσης πολύ καλά ότι το 1998 - δεν έχει περάσει δηλαδή πολύς καιρός - όλοι εδώ στο Κοινοβούλιο είχαν εκφραστεί με θετικά λόγια για την αυστριακή Προεδρία καθώς επίσης και ότι ο Wolfgang Schόssel , ο Πρόεδρος του Αυστριακού Κόμματος των Φιλελευθέρων είχε αφιερωθεί στα καθήκοντά του με ιδιαίτερο ζήλο .
Η Αυστρία ψήφισε και θεωρώ ότι δεν έχει νόημα να περιυβρίζουμε τους ψηφοφόρους .
Οφείλουμε να υπενθυμίσουμε ότι έγιναν διαπραγματεύσεις και με το Σοσιαλιστικό Κόμμα της Αυστρίας .
Λυπάμαι που δεν στέφθηκαν με επιτυχία , αλλά ποιος να είναι άραγε ο λόγος ; Ο λόγος είναι ότι το τμήμα του Σοσιαλιστικού Κόμματος της Αυστρίας που είναι προσανατολισμένο προς τα συνδικάτα δεν ήταν διατεθειμένο να στηρίξει τις δηλώσεις του καγκελάριου Klima · ( Χειροκροτήματα από τη δεξιά πτέρυγα , έντονες παρεμβάσεις από την αριστερή πτέρυγα ) · , και συγκεκριμένα ένα πρόγραμμα εξυγίανσης για την οικονομία και τα δημόσια οικονομικά .
Αυτή είναι η αλήθεια και όσο και να φωνάζετε , δεν μπορείτε να την καταργήσετε με εκδηλώσεις δυσαρέσκειας .
Οι δικές μας προσδοκίες είναι ότι μια κυβέρνηση υπό την ηγεσία του Αυστριακού Λαϊκού Κόμματος θα στηρίξει και θα επιβάλει στη δεδομένη στιγμή τις αξίες και τις αρχές του Ευρωπαϊκού Λαϊκού Κόμματος .
Οι αρχές αυτές συνίστανται στην αδιαμφισβήτητη υποστήριξη της αξιοπρέπειας όλων των ανθρώπων καθώς και της ανεκτικότητας απέναντι σε όλους τους ανθρώπους αλλά κυρίως στην υποστήριξη της συνεπούς συνέχισης της πολιτικής για την ευρωπαϊκή ενοποίηση , όπως την έχει ασκήσει εδώ και δεκαετίες η Δημοκρατία της Αυστρίας και μάλιστα με υποδειγματικό τρόπο .
Εάν η αυστριακή κυβέρνηση συσταθεί υπό την ηγεσία του Αυστριακού Λαϊκού Κόμματος , θα κρίνουμε τις πράξεις της με γνώμονα τη διασφάλιση του κράτους δικαίου , της δημοκρατίας και της ελευθερίας .
Κύριε Πρόεδρε της Επιτροπής , θέλουμε να ευχαριστήσουμε απερίφραστα εσάς και ολόκληρη την Επιτροπή για το ότι εκδώσατε ήδη από χθες μια συνετή και εξισορροπημένη τοποθέτηση η οποία είναι σύμφωνη με τις Συνθήκες της Ευρωπαϊκής Ένωσης και δεν περιμένατε τη σημερινή ημέρα .
Όταν πρόκειται για την ανάληψη του ρόλου σας ως θεματοφύλακα των Συνθηκών , είμαστε στο πλευρό σας .
Ας προχωρήσουμε λοιπόν μαζί προς αυτή την κατεύθυνση .
Ως Ομάδα του Ευρωπαϊκού Λαϊκού Κόμματος ( Χριστιανοδημοκράτες ) και των Ευρωπαίων Δημοκρατών αναμένουμε και δηλώνουμε ότι επιθυμούμε μιαν Ευρώπη του δικαίου , μιαν Ευρώπη της ειρήνης και της ανεκτικότητας .
Δεν επιθυμούμε μιαν Ευρώπη της απομόνωσης , θέλουμε αντίθετα να ενώσουμε τους λαούς της Ευρώπης , ώστε τον 21ο αιώνα να ανοίγεται για την ήπειρό μας ένα μέλλον όπου θα επικρατεί η ελευθερία , η δημοκρατία και η ειρήνη !
( Ζωηρά χειροκροτήματα από την Ομάδα του Ευρωπαϊκού Λαϊκού Κόμματος ( Χριστιανοδημοκράτες ) και των Ευρωπαίων Δημοκρατών ) Κυρία Πρόεδρε , κύριε Πρόεδρε της Επιτροπής , κύριε Προεδρεύων του Συμβουλίου , η Ομάδα του Κόμματος των Ευρωπαίων Σοσιαλιστών θέλει με αυτή την πράξη να στείλει τρία μηνύματα στην ευρωπαϊκή κοινή γνώμη .
Και να καταγραφεί το εξής : έχουμε αρραγή ενότητα ως προς τα τρία μηνύματα .
Καταρχάς , θέλουμε να εκφράσουμε την πλήρη υποστήριξή μας και την απόλυτη συνταύτισή μας με τη δήλωση της ασκούσας την Προεδρία του Συμβουλίου χώρας και των 14 κρατών μελών , διότι πιστεύουμε ότι αυτή η δήλωση ανταποκρίνεται στην κοινότητα αξιών που όλοι μας , και όχι μόνο μια πολιτική δύναμη , οικοδομήσαμε .
Σε κάθε περίπτωση , πρόκειται για μια κοινότητα αξιών που αντίκειται σε εκείνη που υπερασπίζεται αυτό το κόμμα που , σαρκαστικά , αποκαλείται αυστριακό Φιλελεύθερο Κόμμα .
Η Ευρώπη που οικοδομούμε είναι ακριβώς απότοκος πικρών εμπειριών που όλοι μας βιώσαμε , και η Σοσιαλιστική Ομάδα καταδικάζει τις ύβρεις που εκτοξεύθηκαν κατά του Προέδρου της Γαλλικής Δημοκρατίας και κατά της βελγικής κυβέρνησης , αλλά και κατά των σοσιαλιστών , που επίσης είμαστε ευρωπαίοι πολίτες , διότι , αυτή τη στιγμή , κυρίες και κύριοι συνάδελφοι , αναφέρουνε τους Αυστριακούς σοσιαλιστές ως προδότες της πατρίδας τους .
Και σας λέω ένα πράγμα : εγώ για πολλά χρόνια υπήρξα προδότης της πατρίδας μου , τουλάχιστον έτσι έλεγε ο στρατηγός Φράνκο .
( Χειροκροτήματα ) Και ο Πρόεδρος Guterres ήταν προδότης για τον Salazar , και πιστεύω ότι αυτό θα έπρεπε να το επιβεβαιώσει και να συμφωνήσει το Ευρωπαϊκό Λαϊκό Κόμμα .
Και πέραν αυτού , πιστεύω ότι η Επιτροπή , Πρόεδρε Prodi , υπήρξε θεματοφύλακας των Συνθηκών .
Υπενθυμίζω όμως στον Πρόεδρο Prodi ότι , στη συζήτηση κατά την τελετή ανάληψης καθηκόντων του ανέφερε την Επιτροπή ως ευρωπαϊκή κυβέρνηση .
Μια κυβέρνηση όμως πρέπει να διαθέτει περισσότερη πυγμή και περισσότερο θάρρος .
Και αυτό ακριβώς ζητώ από τον Πρόεδρο Prodi αυτή τη στιγμή .
( Χειροκροτήματα ) Και με όλο τον σεβασμό προς έναν Επίτροπο τόσο αποτελεσματικό όσο ο κ. Fischler , δεδομένου ότι έγιναν αντιφατικές δηλώσεις , ανάλογα με το πώς αποδόθηκαν στην κάθε γλώσσα , σε σχέση με το πιθανό αίτημα από πλευράς του κ. Prodi για υποβολή παραίτησης του κ. Fischler , θα τον παρακαλούσα πολύ να διευκρινίσει αυτό το σημείο στο Κοινοβούλιο .
Δεύτερον , κυρία Πρόεδρε , θέλουμε να στείλουμε ένα πολύ σαφές μήνυμα στον αυστριακό λαό .
Ένα κάλεσμα στην πλειοψηφία του αυστριακού λαού που δεν ψήφισε τον Haider , που ψήφισε λύσεις με σαφώς δημοκρατικό χαρακτήρα , σε συστράτευση με την Ευρώπη - και οφείλω να επισημάνω ότι , ναι μεν ο κ. Schόssel διετέλεσε υπουργός Οικονομικών , όμως ο Καγκελάριος Vranitzky συνέβαλε και αυτός στη διαδικασία ένταξης της Αυστρίας .
Δεν μπορεί να γίνεται ένας τόσο σαφής πολιτικός διαχωρισμός .
Την είσοδο της Αυστρίας στην Κοινότητα την πραγματοποιήσαμε από κοινού .
Υπήρξε έργο όλων , όχι μόνο μιας Ομάδας .
Κατά συνέπεια , κυρία Πρόεδρε , πιστεύω ότι δικαιούμαστε και έχουμε την υποχρέωση να ζητήσουμε από τους Αυστριακούς να αναθεωρήσουν και να προβληματισθούν , διότι αυτού του είδους η πανούκλα που ήδη βιώσαμε στην Ευρώπη μπορεί να βλάψει όχι μόνο την Αυστρία , μπορεί στην περίπτωσή της , να επεκταθεί , και μιλώ με βάση την ιστορική μνήμη .
Κατά συνέπεια , θα ήθελα να ξέρω εάν το Ευρωπαϊκό Λαϊκό Κόμμα , πέραν της απολογίας στην οποία προέβη για λογαριασμό του κ. Schόssel , ότι θα εγγυηθεί για τα πάντα , όπως έκαναν το 1938 ο Τσάμπερλεν και ο Νταλαντιέ στο Μόναχο , προτίθεται να λάβει μέτρα σε σχέση με το αυστριακό Λαϊκό Κόμμα εάν δώσει συνέχεια σε αυτό το παράλογο σχέδιο .
Τρίτον , εάν δεν εναντιωθούμε σε αυτή την παρά φύσει συμμαχία , σας διαβεβαιώνω , κυρίες και κύριοι συνάδελφοι , ότι ο βασικός στόχος της Ευρωπαϊκής Ένωσης , που είναι η διεύρυνση , μπορεί να θεωρηθεί λήξας αφού , εάν ήσασταν Τσέχοι ή Σλοβένοι ή Ούγγροι , τι θα λέγατε άραγε εάν είχατε ένα γείτονα που σας αντιμετωπίζει με φυλετικά κριτήρια και δεν θέλει να ενταχθείτε ; Συνεπώς , κυρίες και κύριοι συνάδελφοι , πιστεύω ότι αυτή είναι μια μεγάλη μέρα για την απαρχή της πολιτικής Ευρώπης .
Στηρίζουμε το Συμβούλιο και πιστεύουμε ότι δικαιούμαστε και έχουμε την υποχρέωση να απευθυνθούμε στον αυστριακό λαό προκειμένου να αναθεωρήσει ριζικά αυτή την απολύτως παράλογη επιλογή .
( Χειροκροτήματα από την Ομάδα του Κόμματος των Ευρωπαίων Σοσιαλιστών ) Κυρία Πρόεδρε , η Ομάδα μου χαιρετίζει τη σημερινή συζήτηση που διεξάγεται στην καθοριστική αυτή στιγμή .
Είναι η πρώτη φορά στην ιστορία του σύγχρονου ευρωπαϊκού εγχειρήματος που φθάνουμε σε σημείο να βλέπουμε την επικράτηση ενός ακροδεξιού κόμματος , γεγονός άκρως ανησυχητικό .
Το Φιλελεύθερο Κόμμα της Αυστρίας διατείνεται πως , εάν κανείς διαβάσει τα έντυπα και το πρόγραμμά τους , θα συμφωνήσει σε πολλά σημεία .
Ίσως να είναι αλήθεια , αλλά επιτρέψτε μου να καταθέσω σήμερα επισήμως μια μακρά και δύσκολη εμπειρία που ζήσαμε εμείς οι Φιλελεύθεροι Δημοκράτες με το Φιλελεύθερο Κόμμα της Αυστρίας στους κόλπους της Διεθνούς των Φιλελευθέρων .
Ήδη το 1986 είχαμε λόγους να πιστεύουμε πως ο κ. Jφrg Haider ήταν κάποιος του οποίου οι αρχές και η στάση δεν συμβάδιζαν με την ευπρέπεια και τον σύγχρονο φιλελευθερισμό .
Τον Νοέμβριο του 1991 , μετά από μια μακρά εσωτερική συζήτηση στη Διεθνή των Φιλελευθέρων και πολλές επισκέψεις στη Βιέννη για τη συζήτηση διαφόρων θεμάτων , αναστείλαμε την ιδιότητα μέλους του Φιλελεύθερου Κόμματος της Αυστρίας και , τον Ιούλιο του 1993 , το διαγράψαμε .
( Χειροκροτήματα ) Τους διαγράψαμε τότε και συνεχίζουμε να απορρίπτουμε όσα υποστηρίζει σήμερα ο κ. Haider .
Επιτρέψτε μου να εκφράσω τι αποκομίσαμε από τη μακρά αυτή εμπειρία .
Πολλοί μεταξύ μας είπαν " διάβασε το κείμενο " .
Πολλοί περισσότεροι μεταξύ μας είπαν " διάβασε ανάμεσα στις σειρές του κειμένου » , « κοίταξε τα συμφραζόμενα " .
Οι λέξεις στην πολιτική μπορούν να εξοργίζουν , να εξάπτουν ή να συμφιλιώνουν .
Διαπιστώσαμε πως ο κ. Jφrg Haider είναι ένας ρήτορας που κηρύττει υπέρ του ρατσισμού και της ξενοφοβίας .
Είναι κάποιος που παίζει με τον φόβο και εκμεταλλεύεται την τρωτότητα .
Γι ' αυτό η σημερινή συζήτηση είναι σημαντική : γιατί δείχνει πως η αποδοχή του εξτρεμισμού σημαίνει πως στη σημερινή Ευρώπη συντελείται μια βαθιά αλλαγή .
( Χειροκροτήματα ) Σπεύδω να προσθέσω πως δεν διαπληκτιζόμαστε με τον αυστριακό λαό .
Σεβόμαστε τα δικαιώματα του αυστριακού λαού να έχει τη δική του δημοκρατική διαδικασία .
Προασπιζόμαστε τα δικαιώματα και τα συνταγματικά προνόμια του αυστριακού λαού , αλλά καθήκον δικό μας εδώ στο Ευρωπαϊκό Κοινοβούλιο είναι να θυμόμαστε τις θεμελιώδεις αξίες μας , όπως αναφέρονται στο άρθρο 6 της Συνθήκης - τις αξίες της ελευθερίας , της δημοκρατίας και του σεβασμού των ανθρωπίνων δικαιωμάτων .
Κάθε ορθώς σκεπτόμενο άτομο στο Ευρωπαϊκό Κοινοβούλιο πιστεύει πως οι αξίες αυτές είναι παγκόσμιες και αδιαίρετες , ανεξαρτήτως χρώματος , κοινωνικής τάξης ή θρησκείας .
Πρέπει να προωθήσουμε και να προασπίσουμε τα εν λόγω δικαιώματα , διαβεβαιώνοντας παράλληλα τον αυστριακό λαό πως δεν διαπληκτιζόμαστε μαζί του .
Αναφορικά με την πρωτοβουλία της πορτογαλικής Προεδρίας , θέλω να δηλώσω πως υποστηρίζουμε το πνεύμα και την πολιτική πρόθεση από την οποία εκπορεύεται .
Μπορεί να μην είναι ιδανική η πρωτοβουλία από άποψη δομής , αλλά αναγνωρίζουμε , κύριε Προεδρεύοντα του Συμβουλίου , το ιδεαλιστικό της υπόβαθρο και γι ' αυτό είμαστε διατεθειμένοι να την υποστηρίξουμε .
Συμμερίζομαι την προτίμηση του Προέδρου Prodi για την κοινοτική μέθοδο , και πρέπει να στραφούμε στο άρθρο 6 και στο άρθρο 7 της Συνθήκης .
Στο άρθρο 7 μνημονεύεται η δυνατότητα αναστολής ορισμένων δικαιωμάτων σε περίπτωση σοβαρής και διαρκούς παραβίασης των θεμελιωδών μας αξιών .
Ως θεσμικά όργανα πρέπει να εξεύρουμε τρόπο να καθορίσουμε ένα σχετικό κριτήριο και να δώσουμε νόημα σε αυτή τη διάταξη ούτως ώστε να αποκτήσει ουσιαστική υπόσταση .
Τότε μπορούμε να εργαστούμε από κοινού βάσει της κοινοτικής μεθόδου για να ξεριζώσουμε αυτό το καρκίνωμα που βρίσκεται ανάμεσα μας .
Θέλω , κυρία Πρόεδρε , να πω δυο λέξεις στον κ. Schόssel .
Ο κ. Schόssel έχει ένα ευυπόληπτο παρελθόν στην ευρωπαϊκή πολιτική .
Τώρα προτίθεται να ανεβεί στην εξουσία στην πλάτη μιας πολιτικής τίγρης .
Κύριε Schόssel , αναλαμβάνετε μια πολύ σοβαρή προσωπική , εθνική και ευρωπαϊκή ευθύνη .
Η εν λόγω ευθύνη , την οποία επωμίζεστε τώρα εσείς , κύριε Schόssel , συνίσταται στην τήρηση του γράμματος και του πνεύματος των Ευρωπαϊκών Συνθηκών .
Τέλος , κυρία Πρόεδρε , η σημερινή συζήτηση αγγίζει την πεμπτουσία των δημοκρατικών μας αξιών και θεσμών και υπενθυμίζει πως το τίμημα της ελευθερίας είναι η διαρκής επαγρύπνηση .
Στην ευρωπαϊκή ήπειρο , περισσότερο από οπουδήποτε αλλού , μετά από την οδυνηρή εμπειρία που είχαμε στο παρελθόν λόγω του απεχθούς ρατσισμού και την οποία πληρώσαμε τόσο ακριβά , πρέπει να επιμείνουμε ώστε το αντικείμενο της σημερινής συζήτησης να μην είναι η ανάμειξη στα κυρίαρχα δικαιώματα ενός κράτους .
Το δημοκρατικά εκλεγμένο μέρος των θεσμικών οργάνων της Ευρωπαϊκής Ένωσης επιμένει πεισματικά να μην επιτρέψουμε ως Ευρωπαίοι μια οπισθοδρόμηση .
( Ζωηρά χειροκροτήματα ) Κυρία Πρόεδρε , αυτό που συμβαίνει σήμερα στην Αυστρία είναι πολύ σοβαρό .
Για πρώτη φορά η Ευρωπαϊκή Ένωση αντιμετωπίζει το ενδεχόμενο να βρίσκονται μεταξύ μας στο Συμβούλιο των Υπουργών εκπρόσωποι ενός κόμματος το οποίο προβαίνει απροκάλυπτα σε δηλώσεις και αποδέχεται πράξεις που αντιτίθενται στις αξίες της Ευρωπαϊκής Ένωσης .
Θα διατυπώσω σχετικά τρεις παρατηρήσεις για να αποδείξω τη σοβαρότητα του προβλήματος .
Προσωπικά πιστεύω πως πρόκειται για ένα πρώτο βήμα , εάν βεβαίως πραγματοποιηθεί , προς την καθιέρωση της παρουσίας εξτρεμιστικών στοιχείων στις κυβερνήσεις .
Πιστεύω επίσης πως αποτελεί ένα εξαιρετικά αρνητικό πολιτικό μήνυμα προς τις εύθραυστες δημοκρατίες που έχουν υποβάλει υποψηφιότητα και θα ενταχθούν στην Ευρωπαϊκή Ένωση .
( Χειροκροτήματα ) Πιστεύω τέλος πως συνιστά μια πολιτική οπισθοδρόμηση της ίδιας της Ευρωπαϊκής Ένωσης , και συνεπώς ένα εξίσου αρνητικό μήνυμα στο εξωτερικό της Ένωσης , όταν μιλάμε στο όνομα της δημοκρατίας και των δικαιωμάτων του ανθρώπου .
Είπαν ορισμένοι πως επεμβαίνουμε σε εσωτερικά προβλήματα της Αυστρίας .
Είπαν κάποιοι άλλοι πως στηλιτεύουμε τον αυστριακό λαό και πως ουσιαστικά κατηγορούμε μια μελλοντική κυβέρνηση για κακές προθέσεις .
Είναι άραγε κατηγορία για κακές προθέσεις να προσέχει κανείς όσα λέει ένας πολιτικός αρχηγός εδώ και πολλά χρόνια και τα οποία καθιστούν πρόδηλη μια τάση που αντιστρατεύεται σε όλα όσα θέλουμε ; Δεν αποδίδουμε κατηγορία για κακές προθέσεις ούτε στηλιτεύουμε τον αυστριακό λαό όταν του απευθύνουμε ένα φιλικό κάλεσμα λέγοντας του : αγαπητοί φίλοι , προσέχετε αυτό που κινδυνεύει να συμβεί σύντομα στην πατρίδα σας και να μεταδοθεί σε ολόκληρη την Ευρώπη : δεν πρόκειται για βίαιη αλλαγή - θεωρώ τον κ. Haider πολύ έξυπνο για κάτι τέτοιο - παρά για μια αργή διάβρωση των δημοκρατικών δικαιωμάτων , μια αργή διάβρωση που μεταδίδεται μέσω του πολιτισμού , γεγονός εξαιρετικά επικίνδυνο .
( Χειροκροτήματα ) Θα ήθελα , κυρία Πρόεδρε , να σας ευχαριστήσω για την παρέμβασή σας εξ ονόματος του Κοινοβουλίου .
Ήταν εύστοχη και παράλληλα πολιτικά ευφυής .
( Χειροκροτήματα ) Θα ήθελα επίσης να ευχαριστήσω την Προεδρία του Συμβουλίου για την αποφασιστική , εύστοχη και σταθμισμένη ομιλία της .
( Χειροκροτήματα ) Τέλος , θα ήθελα να απευθυνθώ στην πολιτική ομάδα στην οποία , είτε το θέλουμε είτε όχι , στρέφονται τα λεγόμενά μας , δηλαδή στην Ομάδα του Ευρωπαϊκού Λαϊκού Κόμματος και των Ευρωπαίων Δημοκρατών .
Θα ήθελα να απευθυνθώ στον κ. Poettering και έμμεσα στον κ. Martens , συμπατριώτη και τέως συνάδελφό μας .
Ακουσα , κύριε Poettering , πως παρακολουθήσατε τα γεγονότα στην Αυστρία .
Θα προτιμούσα να τα είχατε προλάβει και κυρίως να είχατε καταδικάσει , εξ ονόματος της πολιτικής σας ομάδας , την ίδια την αρχή μιας συμμαχίας με ανθρώπους που ασκούν βία μέσω των λόγων , που στιγματίζουν τους αδύνατους , που προβαίνουν σε δηλώσεις ξενοφοβίας και που επιδεικνύουν αβροφροσύνη έναντι των Ναζί .
( Χειροκροτήματα ) Κύριε Poettering , δεν αμφισβητώ πως ενδιαφέρεστε για τη δημοκρατία , νομίζω όμως ότι διαπράττετε ένα σοβαρό πολιτικό σφάλμα .
Παραφράζοντας μάλιστα έναν από τους διακεκριμένους συμπατριώτες μου , πατέρα της Ευρώπης , τον Paul-Henri Spaak , θα έλεγα πως για σας δεν είναι πολύ αργά , αλλά είναι καιρός να αλλάξετε γνώμη .
Κυρία Πρόεδρε , κατά τη γνώμη της Ομάδας μου , η Ευρωπαϊκή Ένωση βρίσκεται σήμερα αντιμέτωπη με μια πολιτική και ηθική πρόκληση , η οποία είναι άνευ προηγουμένου από την δημιουργία της .
Βέβαια έχει βρεθεί αντιμέτωπη με καταστάσεις όπου η κυβέρνηση ενός κράτους μέλους περιελάμβανε ανθρώπους , των οποίων οι ιδέες και η πρακτική ήταν αντίθετες προς τις αξίες στις οποίες αναφέρεται η Ένωση .
Ωστόσο , στην περίπτωση του κ. Haider και των ανδρών του , αυτό που προωθείται σε θέση συνδιαχειριστή της Κοινότητάς μας είναι η έκδηλα ρατσιστική , αντισημιτική και ξενόφοβη ακροδεξιά .
Το να εγγραφούμε σε μια παρόμοια προοπτική , θα ισοδυναμούσε , έστω και παρά τη θέλησή μας , με παροχή εγγύησης για σεβασμό μιας δύναμης η οποία είναι ανάξια σεβασμού .
Θα σήμαινε ότι καθιερώνουμε αυτό το απαράδεκτο γεγονός σε πανευρωπαϊκή κλίμακα , θα σήμαινε ότι καθιστούμε άχρηστες τις επίσημες διακηρύξεις των ευρωπαϊκών θεσμικών οργάνων σχετικά με τις θεμελιώδεις αξίες που μας συνδέουν και τις οποίες δικαίως απαιτούμε να σεβαστούν οι υποψήφιες προς ένταξη χώρες .
Για αυτό τον λόγο στηρίζουμε το πνεύμα της διακήρυξης της προεδρίας και των δεκατεσσάρων κρατών μελών , καθώς και την διακήρυξη της Προέδρου του Ευρωπαϊκού Κοινοβουλίου , στο βαθμό που αντίθετα με την ανούσια και αμφιλεγόμενη θέση της Επιτροπής , αξιολογεί τον κίνδυνο και ετοιμάζει μια αντίδραση .
Φυσικά , δεν τίθεται ζήτημα στιγματισμού του αυστριακού λαού .
Κάθε μέτρο που θα ληφθεί θα πρέπει να έχει στα μάτια μας ως διττό στόχο αφενός την καταδίκη του κ. Haider και αφετέρου την αποφυγή απομόνωσης της αυστριακής κοινωνίας .
( Χειροκροτήματα ) Περισσότερο από ποτέ , οι δημοκράτες αυτής της χώρας έχουν ανάγκη την αλληλεγγύη μας .
Η μεγάλη κινητοποίηση της 12ης του περασμένου Νοεμβρίου στη Βιέννη πρέπει να συνοδευτεί από εξελίξεις προσαρμοσμένες στη νέα κατάσταση .
Πρέπει να κάνουμε διάλογο μαζί τους , να συμφωνήσουμε , να ενεργήσουμε στο πλευρό τους , προκειμένου να συμβάλουμε από κοινού στο άνοιγμα μια άλλης προοπτικής για τον αυστριακό λαό .
Τέλος , θα πρέπει να αναρωτηθούμε το εξής : πώς μπορέσαμε να φτάσουμε σε αυτό το σημείο ; Κατ ' αρχάς , βέβαια , σε αυτό το υπαρξιακό για το μέλλον της δημοκρατίας ερώτημα θα πρέπει να απαντήσουν οι πολιτικοί ιθύνοντες της Αυστρίας , και πρώτοι εκείνοι που πριν από λίγο καιρό πήραν το τεράστιο ρίσκο να επιτρέψουν στην άκρα δεξιά να επιτύχει .
Όμως , πέρα από αυτό , κανένας , ούτε η Ευρωπαϊκή Ένωση , δεν μπορεί να μην αναρωτηθεί ενώπιόν μας για τις αιτίες που επιτρέπουν σε έναν δημαγωγό να εκμεταλλεύεται , χωρίς ενδοιασμούς , τις απογοητεύσεις και τους φόβους που προκλήθηκαν από πολιτικές από τις οποίες πάρα πολλοί άνθρωποι δεν βγάζουν άκρη .
Η συζήτηση αυτή είναι μπροστά μας , όμως χωρίς αναβολή , καθεμιά και καθένας από εμάς θα αναλάβει τις ευθύνες του .
( Χειροκροτήματα ) Κυρία Πρόεδρε , θα μπορούσαμε να είχαμε συζητήσει για την ανάγκη να ενισχύσουμε περισσότερο τις ιδρυτικές αρχές της Ένωσης , ώστε να μπορέσουμε να τις υπερασπίσουμε όλες μαζί .
Απεναντίας , είμαστε αναγκασμένοι να συζητάμε σχετικά με τα τυπικά και ουσιαστικά λάθη που έγιναν αυτές τις ημέρες .
Είμαστε κατάπληκτοι μπροστά στην πολιτική αμάθεια αυτών οι οποίοι , με απερίσκεπτα λόγια , ενίσχυσαν τον Ηaider στην Αυστρία και γελοιοποίησαν την Ένωση , καταπατώντας το άρθρο 7 της Συνθήκης και αναγγέλλοντας αντισυνταγματικές ρυθμίσεις .
Δεν μας έχει συμβεί ποτέ να παραστούμε σε μια τόσο σοβαρή και χονδροειδή παρέμβαση στις εσωτερικές υποθέσεις ενός κράτους μέλους .
Σίγουρα , δεν μπορεί κανείς να αθετεί τις θεμελιώδεις αξίες της Ευρώπης , και σχετικά με αυτό ο αρχηγός της ιταλικής κυβέρνησης δήλωσε ότι αυτές οι αρχές έχουν συμπεριληφθεί σε μια συνθήκη : ανέφερε τη Συνθήκη της Κοπεγχάγης , που σε εμένα - όπως και σε όλους εσάς - είναι άγνωστη καθότι ανύπαρκτη .
Ίσως να αναφερόταν στο Αμστερνταμ , που στο άρθρο 6 αναφέρει ορισμένες αρχές και στο άρθρο 7 τις διαδικασίες , για τη διαπίστωση μιας σοβαρής και επίμονης παραβίασης των αρχών των άρθρου 6 , από την πλευρά ενός κράτους μέλους .
Έως σήμερα όμως δεν υπάρχει καμία παραβίαση , ούτε σοβαρή ούτε επίμονη , από την πλευρά της Αυστρίας .
Πέραν του ότι αποτελεί παρέμβαση , η δήλωση της Προεδρίας αποβαίνει μεροληπτική γιατί επιτρέπει την τιμωρία ενός λαού και την άρνηση του δικαιώματός του να επιλέγει ποιον θα ψηφίσει .
Έως τώρα δεν έχει υλοποιηθεί η πολιτική συνοχή ούτε για τον αγώνα κατά του οργανωμένου εγκλήματος , ώστε να προστατευθούν τα θύματα των γενοκτονιών .
Δεν έχει δημιουργηθεί ένα νόμισμα με ένα κατώτατο όριο σταθερότητας ή μια οικονομία που μάχεται έμπρακτα κατά της ανεργίας και της φτώχειας .
Μέσα σε μια στιγμή όμως καταστράφηκε , με εικονοκλαστική μανία , η αξιοπιστία της Ένωσης .
Οι κυρώσεις μπορούν να επιβληθούν μετά από παραβίαση των Συνθηκών και όχι στην περίπτωση που μπαίνει στην κυβέρνηση ένα κόμμα το οποίο εξελέγη δημοκρατικά .
Διαφορετικά , τι σκοπεύουμε να κάνουμε με τις κομμουνιστικές χώρες , που δηλώνουν εκ νέου κομμουνιστικές : θα τις πετάξουμε και αυτές έξω από την Ένωση εάν μπουν στην κυβέρνηση , ή μήπως για τα εγγόνια του Στάλιν όλα θα έχουν συγχωρεθεί ; ( Χειροκροτήματα από τη δεξιά πτέρυγα ) Μόνο με τη διπλωματία , την πειθώ , τον πολιτισμό και την αλληλεγγύη και όχι με τις απειλές , μπορούν τα θεσμικά όργανα να γίνουν σεβαστά και να κάνουν σεβαστές τις αρχές , και όχι μέσω αντισυνταγματικών οδών .
Οι διμερείς σχέσεις αφορούν τα κράτη , και όχι τους 14 .
Κάτι τέτοιο αποτελεί παραβίαση των ευρωπαϊκών οργάνων με σκοπό την προάσπιση λογικών πολιτικής φύσης , και χαρακτηρίζεται από αναρμοδιότητα που ταιριάζει σε κόμματα που μόλις εξήλθαν από ολοκληρωτικά καθεστώτα και όχι σε αντιπροσώπους δημοκρατικών παραδόσεων .
Από τον Haider μας χωρίζουν πολλά , πάρα πολλά πράγματα - όπως γράψαμε πολλές φορές - μεταξύ των οποίων η διεκδίκησή του για την ιταλικότατη περιοχή του Αlto Adige .
Αυτό όμως το γνωρίζαμε : σήμερα μαθαίνουμε με ανησυχία ότι κάποιοι άλλοι εκπρόσωποι της Ένωσης φαίνεται ότι απαρνήθηκαν το δημοκρατικό της ρόλο .
Εμείς είμαστε υπέρ της νομιμότητας και της δημοκρατίας που εξέφρασαν οι λαοί , υπέρ του σεβασμού της εθνικής κυριαρχίας , εφόσον η κυριαρχία αυτή δεν παραβιάζει τις αρχές της Συνθήκης ή τα ανθρώπινα δικαιώματα .
Εμείς πιστεύουμε στην Ευρώπη , ενώ άλλοι φαίνεται ότι ξεκίνησαν τη διαδικασία διάλυσης της Ένωσης .
Αυτά είναι τα αποτελέσματα των βεβιασμένων διευρύνσεων και της έλλειψης σαφήνειας όσων αφορά τους ρόλους και τα καθήκοντα .
Δημιουργήθηκε η Ευρώπη της ασταθούς αγοράς , και όχι αυτή των αρχών , των δικαιωμάτων και της πολιτικής .
Και ιδού οι συνέπειες !
Δεν μπορούμε συνεπώς παρά να καλέσουμε την Επιτροπή να συνεχίσει να παίζει το μετριοπαθή της ρόλο και να εκτιμήσει εκείνους οι οποίοι εργάζονται για τη διατήρηση της αυτονομίας και της κυριαρχίας του αυστριακού λαού , φροντίζοντας ώστε ο λαός αυτός να παραμείνει ελεύθερος και αλληλέγγυος προς τους άλλους λαούς .
( Χειροκροτήματα ) Κυρία Πρόεδρε , αγαπητοί συνάδελφοι , σήμερα έχουμε ραντεβού με την υποκρισία .
...
( Η Πρόεδρος αφαιρεί τον λόγο από τον ομιλητή ) Κυρία Πρόεδρε , η Ομάδα μου , η Ομάδα για την Ευρώπη της Δημοκρατίας και της Διαφοράς , και ιδιαίτερα το κόμμα μου , παρακολουθεί με μεγάλη ανησυχία την παρούσα συζήτηση .
...
Πρόκειται να αναμιχθείτε και στο Κοινοβούλιο της Μεγάλης Βρετανίας σε περίπτωση εκλογής μας ; Κυρία Πρόεδρε , ο αυστριακός λαός αποφάνθηκε εκλέγοντας τον κύριο Haider στο αυστριακό κοινοβούλιο .
...
Κυρία Πρόεδρε , ως βουλευτής του Εθνικού Φιλελεύθερου Κόμματος σέβομαι τις ανησυχίες μερικών συναδέλφων ως προς την εξέλιξη της δημοκρατίας στην Αυστρία .
Ίσως να σας ξενίσει η αντίδρασή μου , όταν θα σας πω ότι προσωπικά έχω κατανόηση για την ιδιαίτερη ευαισθησία που επιδεικνύετε απέναντι στην Αυστρία , θέτοντας ερωτηματικά ως προς τον σεβασμό των ανθρωπίνων δικαιωμάτων και την επίγνωση της ευθύνης απέναντι στο ίδιο της το παρελθόν και τη σταθερότητα της δημοκρατίας .
Για την συχνά αμφίβολη εικόνα που έχει δικαιολογημένα ή αδικαιολόγητα η Αυστρία στο εξωτερικό ευθύνεται η ίδια .
Το γεγονός ότι οι κυβερνήσεις μας αρνιόνταν για χρόνια να ομολογήσουν ότι Αυστρία ήταν συνυπεύθυνη για τα φρικιαστικά εγκλήματα του 2ου Παγκοσμίου Πολέμου καθώς και να καταβάλουν δίκαιες αποζημιώσεις στα θύματα των Εβραίων και σε όσους αναγκάστηκαν να εκτελέσουν καταναγκαστική εργασία , συνέβαλε ουσιαστικά στη δημιουργία αυτής της αρνητικής εικόνας .
Τώρα όμως το Φιλελεύθερο Κόμμα της Αυστρίας σχημάτισε κυβέρνηση συνασπισμού με το Λαϊκό Κόμμα της Αυστρίας με βάση την λαϊκή εντολή που προέκυψε από τις εκλογές στις 3 Οκτωβρίου 1999 , όταν δόθηκε αρνητική ψήφος στην παλαιά κυβέρνηση .
Τούτο συνιστά δικαίωμα των πολιτών ενός κράτους , καθότι είναι η θεμελιώδης αρχή της δημοκρατίας .
Μετά από την αποτυχία των διαπραγματεύσεων μεταξύ Σοσιαλιστικού και Λαϊκού Κόμματος , οι σοσιαλιστές επιχείρησαν να σχηματίσουν κυβέρνηση μειοψηφίας και παρακάλεσαν το Φιλελεύθερο Κόμμα να τους στηρίξει .
( Διαμαρτυρίες ) Μας προσέφεραν τρία υπουργεία - μπορείτε να το διαβάσετε στις εφημερίδες .
Τα προσέφεραν ειδικά σ ' αυτό το κόμμα που εδώ καταγγέλλεται ως φασιστοειδές .
Όταν ξαφνικά απορρίψαμε τη συγκεκριμένη προσφορά , οι σοσιαλδημοκράτες άρχισαν μια παθιασμένη δημαγωγία και μια προπαγάνδα που ακόμα και σήμερα μας φαίνεται ακατανόητη .
Το Εθνικό Φιλελεύθερο Κόμμα της Αυστρίας είναι ένα κόμμα καθιερωμένο στην αυστριακή πολιτική σκηνή .
Ο Πρόεδρος ενός από τα εννέα ομοσπονδιακά κρατίδια ανήκει στο Κόμμα αυτό το οποίο συμμετέχει και στις κυβερνήσεις όλων των υπολοίπων κρατιδίων .
Πάρα πολλοί αυστριακοί αναρωτιούνται σήμερα γιατί η επιλογή τους που έγινε με δημοκρατικές διαδικασίες ερμηνεύεται ξαφνικά ως έκφραση φασιστοειδούς φρονήματος , και γιατί άρχισε η δημαγωγία , μόλις οι φιλελεύθεροι αρνήθηκαν να υποστηρίξουν την κυβέρνηση μειοψηφίας του αυστριακού σοσιαλιστικού κόμματος .
Εδώ προδικάζεται μια καταδίκη - χωρίς να ληφθεί υπόψη το πολιτικό μας πρόγραμμα - η οποία συρρικνώνει την πιο φρικιαστική εποχή της ευρωπαϊκής ιστορίας σε ένα πολιτικό εντυπωσιασμό .
Μου προκαλεί αηδία το γεγονός ότι μερικοί από τους πολιτικούς μας αντιπάλους εκμεταλλεύονται τον θάνατο εκατομμυρίων ανθρώπων στους θαλάμους αερίων των στρατοπέδων συγκέντρωσης , κάνοντας φτηνή προπαγάνδα , όπως για παράδειγμα ο Ιταλός βουλευτής Bertinotti , ο οποίος κατηγόρησε χθες μέσω της ιταλικής τηλεόρασης τον κ. Haider ότι αρνείται πως έγινε πράγματι το ολοκαύτωμα .
Πρέπει να ντρέπεστε , κύριε συνάδελφε !
Ακόμα και αν έχετε ξεμείνει από πολιτικά επιχειρήματα δεν έχετε το δικαίωμα να χρησιμοποιείτε τα θύματα αυτής της μαζικής δολοφονίας για τη φτηνή σας προπαγάνδα .
Δεν αποδεικνύετε εδώ το αντιφασιστικό σας φρόνημα , όταν κατηγορείτε έναν δημοκρατικά εκλεγμένο πολιτικό ως Ναζί !
Αντίθετα μάλιστα , περιπαίζετε τα πραγματικά θύματα του εθνικοσοσιαλισμού και μειώνετε την σημασία των φασιστικών δικτατοριών .
Ενεργείτε με βάση τις δικές σας προκαταλήψεις , και δεν επιζητείτε την πολιτική αντιπαράθεση , ενεργείτε ακριβώς με τον ίδιο τρόπο τον οποίο ισχυρίζεστε ότι καταπολεμείτε .
Η επίθεση κατά την νέας αυστριακής κυβέρνησης , η προσπάθεια να ασκήσετε πολιτική επιρροή σε ένα κράτος μέλος αποτελεί προσβολή για τους πολίτες της Αυστρίας .
Ως εκ τούτου είμαστε ευγνώμονες για την ιδιαίτερη στάση που τήρησε η Επιτροπή .
Στη νέα συμφωνία του κυβερνητικού συνασπισμού θεματοποιείται η μεταρρύθμιση της δημοκρατίας , τα δικαιώματα της αντιπολίτευσης , η υποχρέωση να καταβληθεί αποζημίωση σε όσους υποβλήθηκαν σε καταναγκαστικά έργα · ( Η Πρόεδρος αφαιρεί τον λόγο από τον ομιλητή ) Κυρία Πρόεδρε , αξιότιμοι συνάδελφοι , αρχίζοντας , θέλω να αποσαφηνίσω το εξής : Στην Αυστρία δεν υπάρχει κίνδυνος να επιστρέψει το μονοκομματικό σύστημα ή κάποιο απολυταρχικό σύστημα με δεξιούς προσανατολισμούς .
Η Αυστρία είναι μια σταθερή δημοκρατία όπου τα ανθρώπινα δικαιώματα και οι θεμελιώδεις ελευθερίες διασφαλίζονται από το σύνταγμα και προστατεύονται από την ανεξάρτητη δικαιοσύνη .
Η Αυστρία είναι μια χώρα ανοικτή προς όλον τον κόσμο όπου ο ρατσισμός και οι διακρίσεις δεν έχουν θέση .
Αυτό που συμβαίνει στην Αυστρία είναι μια εντελώς φυσιολογική διαδικασία αλλαγής εξουσίας μετά από δημοκρατικές εκλογές με τις οποίες καταψηφίσθηκε το παλαιό σύστημα και αναζητήθηκε και μάλιστα βρέθηκε μια σταθερή κοινοβουλευτική πλειοψηφία που θα μεριμνήσει για τις απαιτούμενες οικονομικές και κοινωνικές μεταρρυθμίσεις .
Θα υπάρξει μια πλειοψηφία που θα λειτουργεί , όπως θα λειτουργεί επίσης και η αντιπολίτευση .
Το αυστριακό Λαϊκό Κόμμα , το οποίο εκπροσωπώ εδώ στο Κοινοβούλιο , ήταν και είναι ένα κόμμα που υποστήριζε πάντα με συνέπεια την ένταξη της χώρας μου στην Ευρωπαϊκή Ένωση και το οποίο αισθάνεται βαθύτατα δεσμευμένο ως προς την κοινότητα αξιών της Ευρωπαϊκής Ένωσης και τις βασικές γραμμές της πολιτικής της για εμβάθυνση και διεύρυνση .
Σεβόμαστε και αποδεχόμαστε τη συζήτηση και έχουμε κατανόηση για την ανησυχία που εκφράστηκε σε πολλά από τα κράτη μέλη σχετικά με την μελλοντική πορεία της Αυστρίας .
Έχουμε κατανόηση , επειδή γνωρίζουμε ότι , λόγω της ιστορίας μας στο εγγύτερο παρελθόν φέρουμε σήμερα ιδιαίτερη πολιτική ευθύνη .
Η χώρα μας δεν ήταν μόνο το πρώτο θύμα της δικτατορίας του Χίτλερ , πολλοί Αυστριακοί ήταν οι ίδιοι δράστες και το λέω αυτό ακόμα και αν απορρίπτω κάθε ιδέα μιας συλλογικής ευθύνης .
Η Αυστρία βρήκε τον δρόμο της προς την Ευρωπαϊκή Ένωση κατά κύριο λόγο χάρη στο Λαϊκό Κόμμα της Αυστρίας .
Η θέση της χώρας μου δεν είναι εκτός αλλά εντός της Ευρωπαϊκής Ένωσης · ( Χειροκροτήματα ) · και μάλιστα με όλα τα δικαιώματα και τα καθήκοντα που αυτό συνεπάγεται .
Συνεπώς και η μελλοντική κυβέρνηση θα πρέπει να κριθεί σύμφωνα με τις αξίες και τις θεμελιώδεις αρχές που υποστηρίζει στο πρόγραμμά της και όχι σύμφωνα με την εκ προοιμίου καταδίκη της που διατυπώνεται εν μέρει από τους πολιτικούς της αντιπάλους και εν μέρει από τα διεθνή μέσα ενημέρωσης .
Η δήλωση πίστης στον σεβασμό των ανθρωπίνων δικαιωμάτων , στη δημοκρατία και στο κράτος δικαίου καθώς και στην ειλικρινή επεξεργασία του ρόλου που διαδραμάτισε η Αυστρία στο παρελθόν , και στην μετάδοση των πληροφοριών για το μεγαλύτερο έγκλημα της ανθρωπότητας που διαπράχθηκε τον 20ο αιώνα , των πληροφοριών για το ολοκαύτωμα , θα αποδειχθεί συστατικό στοιχείο των αντιλήψεων μιας μελλοντικής κυβέρνησης συνασπισμού μεταξύ του Λαϊκού και του Φιλελεύθερου Κόμματος της Αυστρίας .
Το κόμμα μου θα είναι εγγυητής για τη σταθερή εμμονή της χώρας μου στην γραμμή της ευρωπαϊκής πολιτικής και την παραμονή της στο πλαίσιο της κοινότητας αξιών της Ευρωπαϊκής Ένωσης .
( Χειροκροτήματα ) Κυρία Πρόεδρε , κύριε Πρόεδρε του Συμβουλίου , εκπρόσωποι της Επιτροπής , είναι μια μαύρη ημέρα τόσο για την Αυστρία όσο και για την Ευρώπη και αυτό δεν αλλάζει ούτε με τις ψευδολογίες του κ. Sichrovsky , ούτε με τα κατευναστικά λόγια της κ. Stenzel .
Γιατί το κακό έγινε : δύο ανεύθυνοι πολιτικοί που τους έχει φάει το σαράκι της εξουσίας ξεπουλούν την εικόνα της Αυστρία , τον πολιτικό της ρόλο και εν μέρει και τα οικονομικά της συμφέροντα .
( Χειροκροτήματα , παρεμβάσεις ) Τα ανταλλάσσουν όλα αυτά με τη θέση του αρχηγού της κυβέρνησης και για τη συμμετοχή τους σε μια κυβέρνηση .
Αποδέχονται το τίμημα ότι η Αυστρία , από χώρα που χαίρει εκτίμησης θα γίνει περιφρονητέα χώρα καθώς και το τίμημα της απομόνωσης που απειλεί τη χώρας και κατά συνέπεια εν μέρει και τους πολίτες της .
Όπως πολλοί που αγωνίστηκαν για πολλά χρόνια ενάντια στον Haider και στην πολιτική του , ειδικά μάλιστα οι συνάδελφοί μου της σοσιαλδημοκρατικής αντιπροσωπείας στο Σώμα , θεωρώ και εγώ ότι είναι πολύ σοβαρά και για την περίπτωση ανάρμοστα τα διάφορα μέτρα που ανακοινώθηκαν από την πλευρά της Διεθνούς Κοινότητας , στο βαθμό βέβαια που δεν αναφέρονται στην κυβέρνηση και στους εκπροσώπους της .
Η κριτική όμως - και το λέω ανοικτά - ο θυμός μου επικεντρώνονται αποκλειστικά σε αυτούς που προκάλεσαν και συνεχίζουν να προκαλούν αυτές τις αντιδράσεις , στους κυρίους Schόssel και Haider και στα κόμματά τους · ( Χειροκροτήματα ) συμπεριλαμβανομένων και των εκπροσώπων τους σε αυτό το Κοινοβούλιο .
Συνάδελφε Poettering , είναι πολύ ενδιαφέρον το γεγονός ότι σήμερα βρισκόσαστε σε μια θέση σχεδόν το ίδιο δύσκολη όπως και η δική μου , ακόμα και αν η αιτία είναι διαφορετική .
Και τούτο διότι είσαστε υποχρεωμένος να υπερασπίσετε κάτι που δεν θέλετε να υπερασπισθείτε .
Υπερασπιζόσαστε έναν κ. Schόssel και θα πρέπει να έχετε κατά νου τον σημερινό κ. Schόssel που , όπως άκουσα , ακυρώσατε πριν από λίγες ημέρες την πρόσκλησή του στη συνάντηση κορυφής των εκπροσώπων του χριστιανοδημοκρατικού κόμματος .
Εδώ όμως ισχύει το επιχείρημα που χρησιμοποίησε και ο συνάδελφος Poettering .
Μόνο η ένταξή του στο πολιτικό σύστημα θα απομυθοποιήσει τον Haider .
Ισχυρίζομαι ωστόσο ότι ο ίδιος , ακριβώς όπως και άλλα ακροδεξιά κινήματα , ούτε θέλει ούτε μπορεί να ενταχθεί στο δικό μας πολιτικό σύστημα , και σε αυτήν την Ευρώπη .
Όποιος θρέφεται από τις προκαταλήψεις κατά των αλλοδαπών και των μειονοτήτων και από την άλλη πλευρά δίνει και ο ίδιος τροφή στις προκαταλήψεις αυτές , όποιος έχει για πρόγραμμά του την στενοκεφαλιά και τον αντιφιλελευθερισμό , όποιος συνηθίζει να επιδεικνύει άξεστη συμπεριφορά και υπεροψία στις διεθνείς του σχέσεις και όποιος δεν έχει ποτέ αποστασιοποιηθεί σαφώς και απροκάλυπτα από τον εθνικοσοσιαλισμό , δεν έχει ούτε την πρόθεση ούτε τη διάθεση να ενταχθεί .
( Χειροκροτήματα ) Πρόκειται για την μεγάλη ιστορική ευθύνη των συντηρητικών που πηγαίνουν με τη θέλησή τους στο κρεβάτι με τον λύκο και περιμένουν πότε θα τους κατασπαράξει .
Έτσι αντί να έχουν τον λύκο υπό τον έλεγχό τους τον θρέφουν και τον δυναμώνουν , ακόμα και αν αυτό σημαίνει ότι το Αυστριακό Λαϊκό Κόμμα θυσιάζει έτσι τον εαυτό του .
Αντιλαμβάνομαι ότι η Ευρώπη και γενικότερα ο πολιτισμένος κόσμος θέλει να έχει όσο το δυνατόν λιγότερα πάρε δώσε με μια τέτοια κυβέρνηση .
Υπάρχει όμως και η άλλη Αυστρία .
Εκείνη η Αυστρία όπου έγιναν διαδηλώσεις με τη συμμετοχή χιλιάδων πολιτών που ήθελαν να διαμαρτυρηθούν κατά της συμμετοχής του Φιλελεύθερου Κόμματος στην κυβέρνηση και όπου οι διαδηλώσεις εναντίον αυτής της κυβέρνησης θα συνεχιστούν .
Παρακαλώ την Ευρώπη να υποστηρίξει και να βοηθήσει αυτήν την Αυστρία !
( Χειροκροτήματα ) Όσο πιο δυνατή γίνεται η Ευρώπη αυτή , όσο πιο μεγαλύτερη είναι η επαγρύπνησή της ενάντια στις αυταρχικές τάσεις σε αυτήν την Ευρώπη , τόσο μεγαλύτερη θα είναι και η επιτυχία μας όταν καταπολεμούμε τις ρίζες της ακροδεξιάς .
Γιατί η Ευρώπη είναι και παραμένει η καλύτερη εγγύηση ενάντια στο μίσος απέναντι στους ξένους καθώς και ενάντια στη δημαγωγία ή ακόμα και ενάντια στην επιστροφή στη βαρβαρότητα .
Υποστηρίξτε τον λαό της Αυστρίας ενάντια σε αυτήν την κυβέρνηση !
( Χειροκροτήματα ) Αξιότιμη κυρία Πρόεδρε , αυτή η στιγμή είναι ιστορική , διότι τώρα είναι πλέον εντελώς σαφές σε όλους μας ότι η Ευρωπαϊκή αΕνωση έχει εξελιχθεί βαθμιαία σε κοινότητα αξιών .
...
Και τούτο διότι ο σεβασμός και το απαραβίαστο των ανθρώπινων αξιών , καθώς και τα δικαιώματα των μειονοτήτων , αλλά και τα δικαιώματα όλων των ανθρώπων που κατοικούν στην επικράτεια της Ευρωπαϊκής αΕνωσης , αποτελούν ουσιαστικό στοιχείο της αρχής του κράτους δικαίου της Ευρωπαϊκής αΕνωσης .
Για τον λόγο αυτόν ο Χάρτης των Θεμελιωδών Δικαιωμάτων θα πρέπει επίσης να αποκτήσει νομικά δεσμευτική ισχύ .
...
Γνωρίζουμε τις κοινωνικές αιτίες που συμβάλλουν , με την ανεργία και την αβεβαιότητα , στην τροφοδότηση των τάσεων που οδεύουν προς αυτήν την κατεύθυνση .
Γνωρίζουμε τις συνυπάρχουσες πολιτιστικές αιτίες - ξενόφοβες και ρατσιστικές - αλλά δεν μπορούμε να μην υποδείξουμε την πιθανότητα να δημιουργηθεί ένα εκρηκτικό μείγμα στην Ευρώπη , λόγω της ανικανότητας και της έλλειψης βούλησης αυτών των δυνάμεων της άκρας δεξιάς να τακτοποιήσουν τους λογαριασμούς τους με το ναζισμό .
...
Η Ευρώπη δείχνει να μην έχει ξεχάσει το Αουσβιτς .
Η Ευρώπη δείχνει να έχει ψυχή .
...
Κυρία Πρόεδρε , κύριοι συνάδελφοι , στα πλαίσια της θεμελιώδους δημοκρατικής αρχής του σεβασμού των ανθρωπίνων δικαιωμάτων και της ελευθερίας και κυριαρχίας των λαών , ενάντια σε κάθε νέο ή παλιό φασισμό , ναζισμό ή κομμουνισμό , και δεδομένου ότι όλοι οι προηγούμενοι ομιλητές μίλησαν για κυριαρχία του αυστριακού λαού , εμείς βλέπουμε , σήμερα , ότι αυτό ακριβώς το Κοινοβούλιο αρνείται αυτήν την κυριαρχία .
Από την ανάγνωση του προγράμματος του αυστριακού Κόμματος των φιλελεύθερων-δημοκρατών δεν προκύπτουν στοιχεία ικανά να δικαιολογήσουν τις κατηγορίες για επιβουλή κατά των αρχών της ελευθερίας , δημοκρατίας και σεβασμού των ανθρωπίνων δικαιωμάτων , των θεμελιωδών ελευθεριών και του κράτους δικαίου , που κυρώθηκαν από το άρθρο 6 των Συνθηκών .
Θα ήθελα αντίθετα να επιστήσω την προσοχή των συναδέλφων στο γεγονός ότι ο Προεδρεύων , που ήταν τόσο επικριτικός απέναντι στην Αυστρία , παρέδωσε πρόσφατα τους κατοίκους του Μακάο στην κυριαρχία της Λαϊκής Δημοκρατίας της Κίνας .
Ίσως όμως , για να ενισχύσουμε τη δημοκρατία της Ένωσης , να πρέπει σήμερα να απομονώσουμε την Αυστρία , να ενοχοποιήσουμε ένα δημοκρατικά εκλεγμένο κόμμα από τους αυστριακούς πολίτες και να εντάξουμε στην Ευρώπη την Τουρκία των Γκρίζων Λύκων .
...
( Χειροκροτήματα ) Ο Κόνραντ Αντενάουερ είχε πει κάποτε - και ήξερε τι έλεγε - ότι ο πιο ασφαλής τρόπος για να ηρεμήσεις μια τίγρη είναι να της επιτρέψεις να σε καταβροχθίσει .
...
( Ζωηρά χειροκροτήματα ) Κυρία Πρόεδρε , αγαπητοί συνάδελφοι , η Ένωσή μας δημιουργήθηκε γύρω από αυτήν την ιδέα : " ποτέ ξανά αυτό " .
Και αυτό υποδήλωνε " ποτέ ξανά ξενοφοβία , στρατόπεδα συγκεντρώσεως , αντισημιτισμός , ποτέ ξανά εθνικιστικές εξάρσεις , ποτέ ξανά πόλεμοι " .
...
Η ευρωπαϊκή δημοκρατία και η αυστριακή δημοκρατία δεν έχουν να διδαχθούν τίποτα από κανέναν - και οπωσδήποτε όχι από τη βελγική κυβέρνηση στην οποία συμμετέχουν διεφθαρμένα κόμματα που χρηματοδοτούνται από εμπόρους όπλων .
Τη βελγική κυβέρνηση η οποία όρισε Επίτροπο τον πρόεδρο ενός διεφθαρμένου κόμματος που έχει καταδικαστεί από το Δικαστήριο .
...
Κυρία Πρόεδρε , τη συζήτηση αυτή άνοιξε ο κ. Da Costa , ο οποίος απλώς επιβεβαιώνει πως η Προεδρία της ΕΕ προσπαθεί να επηρεάσει τη σύνθεση μιας κυβέρνησης ενός από τα κράτη μέλη .
Η σημερινή συζήτηση και το γενικό πλαίσιο στο οποίο εντάσσεται ενίσχυσαν την άποψη πως στο Συμβούλιο , στην Επιτροπή και στο ίδιο το Ευρωπαϊκό Κοινοβούλιο κυριαρχούν οι σοσιαλιστές .
Η αντιπροσωπεία μου των 37 Βρετανών βουλευτών του Συντηρητικού και Ενωτικού Κόμματος απορρίπτει πλήρως τη φιλοσοφία στην οποία βασίζεται το Φιλελεύθερο Κόμμα της Αυστρίας , καθώς και το πρόγραμμά του και το ύφος που χρησιμοποιεί .
Συμμεριζόμαστε τη γενικευμένη αγανάκτηση που προκαλεί η στάση του εν λόγω κόμματος έναντι της ιστορίας , και ιδιαίτερα έναντι του Δευτέρου Παγκοσμίου Πολέμου , αλλά και οι πολιτικές του όσον αφορά τη διεύρυνση , τη μετανάστευση και φυλετικά θέματα , καθώς και η στάση του έναντι της ίδιας της Ευρωπαϊκής Ένωσης .
Ωστόσο , η οργή μας στρέφεται και κατά της ανοχής της Αριστεράς για την τυραννία , την τρομοκρατία και τις υπερβάσεις εξουσίας της πρώην Σοβιετικής Ένωσης .
Έστω και σήμερα , είναι ασφαλώς καιρός να σπάσει το Κόμμα των Ευρωπαίων Σοσιαλιστών τους αδελφικούς δεσμούς του με το Κομμουνιστικό Κόμμα της Κίνας .
Δεν ακούστηκε λέξη από τις ίδιες αυτές κυβερνήσεις της ΕΕ σχετικά με κυβερνήσεις συνασπισμού όπου συμμετέχουν κομμουνιστές σύντροφοι στη Γαλλία , στην Ιταλία και στη Γερμανία , ούτε βέβαια σχετικά με την προθυμία της βρετανικής κυβέρνησης να τους προωθήσει σήμερα ως υπουργούς στη Βόρειο Ιρλανδία , συμπράττοντας με τρομοκρατικές οργανώσεις .
Αυτό , κυρία Πρόεδρε , αποτελεί υποκρισία εκ μέρους της Αριστεράς .
Καταδικάζουμε λοιπόν αυτή την υποκρισία και τη χρησιμοποίηση διπλών μέτρων και σταθμών , ιδιαίτερα εκ μέρους της βρετανικής κυβέρνησης και των υπόλοιπων κυβερνήσεων της ΕΕ των οποίων προΐστανται σε μεγάλο βαθμό σοσιαλιστές , συμπεριλαμβανομένης της κυβέρνησης των Ηνωμένων Πολιτειών .
Οφείλουμε ωστόσο να αναγνωρίσουμε πως η δημοκρατική διαδικασία καταλήγει μερικές φορές σε δυσάρεστα αποτελέσματα .
Σε αυτή την περίπτωση απαιτείται η λήψη μέτρων για την αντιμετώπιση των υποκείμενων αιτίων , συμπεριλαμβανομένης εξέτασης της ίδιας της εκλογικής διαδικασίας .
Αυτό θα πρέπει να είναι το καθήκον μας και όχι μια πολιτική υποκριτική στάση .
( Χειροκροτήματα ) Κυρία Πρόεδρε , κύριε εκπρόσωπε του Συμβουλίου , κύριε Επίτροπε , πριν από μία εβδομάδα ολοκληρώθηκε στη Στοκχόλμη η μεγάλη Διεθνής Διάσκεψη για το Ολοκαύτωμα .
...
Κυρία Πρόεδρε , όλος ο κόσμος επεσήμανε ότι σήμερα είναι μια πολύ σημαντική μέρα , είναι η μέρα της πρώτης συζήτησης σχετικά με τον ευρωπαϊκό πολιτικό βίο .
Και δεν είναι τυχαίο .
Κατά τη γνώμη μου το ραντεβού που έχουμε σήμερα δεν είναι το ραντεβού της Ευρώπης , των θεσμικών μας οργάνων , με την Αυστρία ή με το κόμμα του κ. Haider .
Είναι το ραντεβού της Ευρώπης με τον εαυτό της , με τον λόγο ύπαρξής της , με τους λόγους για τους οποίους παρευρισκόμαστε σε αυτό το ημικύκλιο .
Το ημικύκλιο αυτό δεν δημιουργήθηκε για τα εμπορεύματα , δεν δημιουργήθηκε για τα χρήματα .
Το ημικύκλιο αυτό , και τα ευρωπαϊκά θεσμικά όργανα δημιουργήθηκαν για κάποιες αξίες , για μια ηθική και για ένα πνεύμα .
Ωστόσο , κατά τον εικοστό αιώνα , είδαμε ότι οι δημοκρατίες μπορούσαν να απειληθούν και ότι η ηθική , οι αξίες και το πνεύμα που ανέφερα παραπάνω ήταν δυνατό να πληγούν θανάσιμα από κάποιους ιούς που φέρουν ένα όνομα : εθνικιστική έξαρση , λαϊκισμός και προτεραιότητα της φυλής .
Αρκεί όμως να διαβάσει κανείς το πρόγραμμα του κόμματος του κ. Haider , του Κόμματος της Ελευθερίας , καθώς σε κάθε κεφάλαιο συναντούμε την εθνικιστική έξαρση , τον λαϊκισμό και την προτεραιότητα της φυλής .
Διαβάζω μόνο μια φράση που ο φίλος μου Vidal-Quadras διάβασε πριν από εμένα " η πατρίδα ορίζεται από τον χώρο της , την κουλτούρα της και από την φυλή της , τοπικά , εθνικά και πολιτισμικά " .
Ε λοιπόν , δεν μπορούμε να δεχτούμε αυτές τις δηλώσεις .
( Χειροκροτήματα ) Εάν η Ευρώπη έχει κάποιο νόημα , και - επιτρέψτε μου να απευθυνθώ στους φίλους μου - εάν η χριστιανική δημοκρατία έχει κάποιο νόημα , εάν η ιστορία της χριστιανικής δημοκρατίας έχει κάποιο νόημα , τότε πρέπει να δηλώσει ότι είναι ριζικά ασυμβίβαστη με τις διακηρύξεις αυτού του προγράμματος και να αρνηθεί την συμφωνία με αυτού του είδους την ιδεολογία και αυτού του είδους την οργάνωση , όποιες και αν είναι οι άριστες δικαιολογίες που χρησιμοποιούμε κάθε φορά που η ιστορία αντιμετωπίζει ένα πολύ σημαντικό γεγονός .
Για αυτό τον λόγο , θα πρέπει , κατά τη γνώμη μου , το Ευρωπαϊκό Κοινοβούλιο που είναι πιο ελεύθερο ως προς τις ενέργειες και τις δηλώσεις του από ό , τι το Συμβούλιο ή η Επιτροπή , να χαιρετίσει εκείνα τα κράτη και τα ευρωπαϊκά όργανα που είχαν το θάρρος να πουν " όχι " , να πει , κυρία Πρόεδρε , ότι εξ ονόματός μας κάνατε μια δήλωση η οποία μας τιμά , να εκφράσει με σαφήνεια , χωρίς παρεκκλίσεις , την αντίθεση και την καταδίκη της για όσα δρομολογούνται στην Αυστρία και να θυμηθεί την δήλωση που έκανε την ημέρα της συμφωνίας του Μονάχου ένας μεγάλος γάλλος χριστιανοδημοκράτης , ο οποίος είχε πει ότι " εφόσον πρόκειται να πει κανείς " όχι " , η καλύτερη στιγμή για να το κάνει είναι η πρώτη " .
( Χειροκροτήματα ) Κυρία Πρόεδρε , ανησυχούμε , και όταν λέω ανησυχούμε εννοώ εμάς τους Βέλγους χριστιανοδημοκράτες μαζί με πολλούς άλλους συναδέλφους .
...
Κυρία Πρόεδρε , κυρίες και κύριοι , είναι έκδηλο ότι υπάρχει σε πολύ μεγάλο βαθμό ομοθυμία ανάμεσά μας στο Σώμα σε σχέση με την απόρριψη του Haider και της πολιτικής του .
Είναι όμως επίσης σαφές ότι υπάρχουν διαφορετικές αντιλήψεις όσον αφορά τον τρόπο με τον οποίο μπορεί να καταπολεμηθεί αποτελεσματικότερα η πολιτική αυτή .
Αναρωτηθήκατε ποτέ τι αντίκτυπο έχει άραγε στην ίδια την Αυστρία η συζήτηση που διεξάγουμε εδώ καθώς και η ανακοίνωση της Προεδρίας του Συμβουλίου το περασμένο Σαββατοκύριακο ; Αναρωτηθήκατε αν φέρουμε και εμείς ένα μέρος της ευθύνης για την περαιτέρω εξέλιξη της πολιτικής κατάστασης στη Αυστρία , εάν πάρουμε φόρα και την κρίνουμε ; Αναρωτηθήκατε τι θα γινόταν εάν εκπληρωνόταν η επιθυμία που εξέφρασε μια συνάδελφος και διεξάγονταν πράγματι τις επόμενες μέρες εκλογές στην Αυστρία ; Όλοι οι παρατηρητές είναι σύμφωνοι ότι κάτι τέτοιο θα ενδυνάμωνε ακόμα περισσότερο τον Haider .
Ποιος μπορεί να το θέλει αυτό ; Δεν έχουμε άραγε την ευθύνη να σκεφθούμε με ποιο τρόπο θα καταπολεμήσουμε την πολιτική αυτή ; Η Ευρώπη είναι μια κοινότητα δικαίου .
Στις θεμελιώδεις αρχές που οφείλουμε να υποστηρίζουμε ανήκουν η δημοκρατία , ο σεβασμός των ανθρωπίνων δικαιωμάτων και το κράτος δικαίου .
Η επιταγή της δημοκρατίας περιλαμβάνει και το ότι τα αποτελέσματα εκλογών δεν επιδέχονται κριτικής αλλά πρέπει να γίνονται σεβαστά .
Ως εκ τούτου πρέπει να σεβαστούμε το γεγονός ότι οι Αυστριακοί πήραν αυτήν την απόφαση , για λόγους που οφείλονται στην δική τους πολιτική .
Είναι ζήτημα κράτους δικαίου η Προεδρία του Συμβουλίου να μην εκφράζεται όπως έκανε , δηλαδή με έναν τρόπο που αντίκειται στις Συνθήκες .
( Χειροκροτήματα ) Και είναι ζήτημα πολιτικής σωφροσύνης να μην απομονωθεί το Λαϊκό Κόμμα της Αυστρίας .
Αντίθετα το Λαϊκό Κόμμα της Αυστρίας θα πρέπει να τύχει της υποστήριξής μας ως ένα κόμμα αναμφισβήτητα δημοκρατικό , που σέβεται τις αρχές του κράτους δικαίου και αποδεδειγμένα ευρωπαϊκό , ώστε η Αυστρία να παραμείνει επίσης αναμφισβήτητα μέλος της Ευρωπαϊκή Κοινότητας .
Για τον λόγο αυτό οι συνάδελφοί μας του Λαϊκού Κόμματος της Αυστρίας πρέπει να έχουν την υποστήριξή μας σε αυτήν τη δύσκολη κατάσταση .
Η απομόνωση είναι ο εντελώς λανθασμένος δρόμος .
( Χειροκροτήματα ) Κυρία Πρόεδρε , στα μέρη μου λένε " it ' s three times for a Welshman " ( τρεις φορές για έναν Ουαλό ) , και νομίζω πως θα διαπιστώσετε κατά τη διάρκεια της σημερινής συζήτησης πως εξέφρασα τρεις φορές την επιθυμία μου να απαντήσω πολύ συνοπτικά σε αυτή την εξαιρετική , και σε ορισμένες περιπτώσεις , συγκινητική συζήτηση .
...
Υποστηρίζει η Επιτροπή την άποψη του Συμβουλίου ; Κυρία Πρόεδρε , η Επιτροπή είπε χθες το πρωί πως λαμβάνει υπόψη τις απόψεις που εξέφρασαν υπό μορφή κοινής δήλωσης δεκατέσσερα κράτη μέλη και πως συμμερίζεται την ανησυχία από την οποία εκπορεύεται αυτή η δήλωση .
Νομίζω λοιπόν πως μπορεί να θεωρηθεί αυτονόητο πως από χθες το πρωί , μόλις η Επιτροπή μπόρεσε να συζητήσει το θέμα , η άποψή της συμφωνεί με την άποψη δεκατεσσάρων από τα κράτη μέλη . .
...
Χρησιμοποιείται εδώ και κάποιον καιρό από την Κοινότητα σε μια σειρά πολιτικών : στην πολιτική για το περιβάλλον , για την υγεία των ανθρώπων και των ζώων καθώς και στη φυτοϋγειονομική πολιτική .
Η εν λόγω αρχή αναφέρεται εξάλλου ρητώς στις περιβαλλοντικές διατάξεις της Συνθήκης της ΕΚ μετά το Μάαστριχτ .
...
Η παρούσα ανακοίνωση δεν διατείνεται πως αποτελεί την τελευταία λέξη σε αυτό το θέμα .
Ωστόσο , είναι η πρώτη φορά που η Επιτροπή προβαίνει σε μια δομημένη παρουσίαση της αρχής και της λειτουργικής της χρήσης .
...
Η επόμενη ερώτηση , κυρία Wallstrφm , είναι η εξής : Πότε θα αρχίσετε να εφαρμόζετε την αρχή αυτή στη νομοθεσία , για παράδειγμα στη νομοθεσία περί χημικών ουσιών , ή στη νομοθεσία άλλων τομέων ; Και η τελευταία ερώτηση : Θα μπορούμε να αναγνωρίσουμε σε ποιες περιπτώσεις εφαρμόστηκε η αρχή της προφύλαξης στη νομοθεσία ; Δηλαδή θα υπάρχει ειδικό ένθετο σε κάθε πρόταση που θα μας λέει ότι η αρχή της προφύλαξης έχει εξετασθεί και το συμπέρασμα είναι το προκείμενο ; Σας ευχαριστώ πάρα πολύ , κυρία Dagmar Roth-Behrendt , γι ' αυτές τις ερωτήσεις .
...
Στην περίπτωση αυτή θα ήθελα να ρωτήσω ποιος είναι ο ορισμός της έννοιας " αναγνωρισμένη μειοψηφία " ; Πώς περιγράφετε την έννοια αυτή ; Πώς καταλήγετε στην έννοια της αναγνωρισμένης μειοψηφίας ; Εάν πρόκειται για πολιτική απόφαση , θα ήθελα να ρωτήσω ποιος λαμβάνει την απόφαση αυτή .
Η Επιτροπή ; Το Συμβούλιο ; Σε ποιο βαθμό θα μπορούσε να διαδραματίσει κάποιο ρόλο και το Ευρωπαϊκό Κοινοβούλιο ; Ποιος είναι ο ρόλος της Επιστημονικής Επιτροπής ; Ποιος θα είναι αργότερα ο ρόλος της Υπηρεσίας Ασφάλειας των Τροφίμων που σκοπεύετε να συγκροτήσετε ; Τέλος , οι αποφάσεις θα ληφθούν με διάφανες και ανοικτές διαδικασίες ; Αυτά είναι τα τρία ερωτήματα που είχα να θέσω .
...
( GUE / NGL ) .
( SV ) Κύριε Πρόεδρε , έχω μία ερώτηση η οποία αφορά μία συγκεκριμένη και επίκαιρη περίπτωση στην οποία θα μπορούσε να εφαρμοστεί η αρχή της προφύλαξης .
...
Κατά πόσον η άποψη των Αμερικανών θα ταυτίζεται με τη δική μας στο συγκεκριμένο θέμα ; - ( SV ) Κύριε Πρόεδρε , βρίσκομαι στην ευχάριστη θέση να ανακοινώσω ότι μόλις υπογράψαμε στο Μόντρεαλ ένα πρωτόκολλο για τη βιοασφάλεια .
...
Η ημερήσια διάταξη προβλέπει την έκθεση ( Α5-0018 / 2000 ) του κ ..
Δημητρακόπουλου και του κ. Leinen , εξ ονόματος της Επιτροπής Συνταγματικών Υποθέσεων , σχετικά με τη τη σύγκληση της Διακυβερνητικής Διάσκεψης ( ( 14094 / 1999 - C5-0341 / 1999 - 1999 / 0825 ( CNS ) ) . εισηγητής .
Κύριε Πρόεδρε , θα ευχαριστήσω κατ ' αρχάς την πορτογαλική Προεδρία και την Επιτροπή για όλες τις πολύ χρήσιμες επαφές που είχαμε αυτό το διάστημα .
...
Ζητώ όμως παράλληλα να συμπεριληφθούν σα αυτήν και θέματα που βελτιώνουν και ολοκληρώνουν την μεταρρύθμιση , επαναλαμβάνω , όλων των θεσμικών οργάνων αλλά και θέματα που αφορούν και ενδιαφέρουν άμεσα τους ευρωπαίους πολίτες .
Όπως για παράδειγμα η υγεία , η ενέργεια , ο πολιτισμός , οι μεταφορές , ακόμα και ο τουρισμός .
Το αν θα επιτευχθεί τελικά η διεύρυνση της ημερήσιας διάταξης ή όχι , αφενός είναι ακόμη υπό συζήτηση .
Και στο σημείο αυτό θέλω πραγματικά να εξάρω την πολιτική συμπεριφορά της πορτογαλικής Προεδρίας , η οποία επανειλημμένα δεσμεύθηκε ενώπιον του Ευρωπαϊκού Κοινοβουλίου ότι θα κάνει τις προσπάθειες που πρέπει να κάνει προς την κατεύθυνση αυτή .
...
Το ίδιο ισχύει και για την Ευρωπαϊκή Επιτροπή και θέλω πάλι , για μια ακόμη φορά , να ευχαριστήσω τον Επίτροπο κ. Barnier για την επαφή του με το Ευρωπαϊκό Κοινοβούλιο και για τις πολύ εποικοδομητικές προτάσεις που μας παρουσίασε . - ( DE ) Κύριε Πρόεδρε , κύριε Πρόεδρε του Συμβουλίου , κύριε Επίτροπε , είμαι της ίδιας άποψης με τον συνεισηγητή μου Δημητρακόπουλο , ότι δηλαδή το πρόγραμμα που αποφασίσθηκε στο Ελσίνκι δεν επαρκεί για την αντιμετώπιση των προκλήσεων που ενέχει μια διεύρυνση κατά 13 νέα κράτη .
Κατά την άποψή μας μια μίνι μεταρρύθμιση θα αποτελούσε χαμένη ευκαιρία .
Η μίνι μεταρρύθμιση θα έθετε σε κίνδυνο και τη σταθερότητα της Ευρωπαϊκής Ένωσης .
Έναν τέτοιο κίνδυνο που ενδεχομένως να προκύψει λόγω της υπερβολικής διεύρυνσης και της ελλιπούς εμβάθυνσης δεν μπορεί και δεν θα πρέπει να τον αποδεχθεί το Κοινοβούλιο .
Θέλουμε εν προκειμένω να υπενθυμίσουμε και πάλι στις κυβερνήσεις ότι προτού γίνει αποδεκτό ένα νέο μέλος στην Ευρωπαϊκή Ένωση , χρειάζεται η σύμφωνη γνώμη του Κοινοβουλίου .
Το Κοινοβούλιο θα αποφασίζει για τη διεύρυνση , λαμβάνοντας ασφαλώς υπόψη και τα αποτελέσματα της Διακυβερνητικής Διάσκεψης .
Στις 18 .
Νοεμβρίου 1999 καθορίσαμε τις γενικές γραμμές της ημερήσιας διάταξης για τη Διακυβερνητική Διάσκεψη του 2000 .
Θα αναφέρω και πάλι μερικά μόνο από τα σημεία : Ρυθμίσεις για ενισχυμένη συνεργασία με αυτά τα 20 ή 25 κράτη μέλη , ένταξη της πολιτικής για την ασφάλεια και την άμυνα στο κοινοτικό πλαίσιο , ενσωμάτωση του Χάρτη Θεμελιωδών Δικαιωμάτων στη νέα Συνθήκη , συνταγματοποίηση της Ένωσης μέσω του χωρισμού των Συνθηκών σε δύο τμήματα , όπου το ένα τμήμα θα έχει θεμελιώδη χαρακτήρα , μεταρρύθμιση του άρθρου 48 , προκειμένου να διασφαλισθεί μελλοντικά η πραγματικά ισότιμη συμμετοχή του Κοινοβουλίου σε διαπραγματεύσεις αναθεώρησης των Συνθηκών .
Θα ήθελα ακόμα να αναφέρω το καθεστώς για τα ευρωπαϊκά κόμματα , ώστε στις επόμενες εκλογές για το Ευρωπαϊκό Κοινοβούλιο η εκλογική μάχη να διεξαχθεί πάνω σε ευρωπαϊκά θέματα και να μην αποτελέσει εθνική αντιπαράθεση σε θέματα εσωτερικής πολιτικής .
Τέλος , θέλω να αναφέρω την ενίσχυση των θεσμικών οργάνων και των μέσων για την άσκηση κοινοτικής οικονομικής και κοινωνικής πολιτικής καθώς και πολιτικής για την απασχόληση ως αντίβαρο στην ευρωπαϊκή νομισματική ενοποίηση και το κοινό νόμισμα , πράγματα για τα οποία έχουν άλλωστε ήδη ληφθεί αποφάσεις .
...
Προς όφελος των πολιτών θα πρέπει να διασφαλισθεί μεγαλύτερη διαφάνεια στις πολιτικές διεργασίες κατά τη διάρκεια της Διακυβερνητικής Διάσκεψης .
Συνεπώς απαιτούμε ευρύτατη συμμετοχή του Κοινοβουλίου σε όλα τα επίπεδα .
Είναι διττή η νομιμοποίηση της Ένωσης , αφενός ως ένωσης κρατών και αφετέρου ως ένωσης λαών .
Έφθασε πλέον η στιγμή να εκφρασθεί το γεγονός αυτό και στη μέθοδο επεξεργασίας μιας νέας Συνθήκης .
Οι εκπρόσωποι του Ευρωπαϊκού Κοινοβουλίου θα πρέπει να συμμετέχουν πραγματικά στην προπαρασκευαστική ομάδα , τόσο σε επίπεδο Υπουργών όσο και στις συνόδους του Ευρωπαϊκού Συμβουλίου , στις περιπτώσεις που το Συμβούλιο ασχολείται με τη Διακυβερνητική Διάσκεψη .
Οι κυβερνήσεις αποφάσισαν να κηρύξουν την έναρξη της Διακυβερνητικής Διάσκεψης στις 14 Φεβρουαρίου .
Το Κοινοβούλιο θα παρουσιάσει αύριο σε αυτήν την μίνι σύνοδο την γνωμοδότησή του και θα δημιουργήσει με τον τρόπο αυτό τις προϋποθέσεις για την έναρξη της Διακυβερνητικής .
Δεν σας κρύβω ότι πολλοί συνάδελφοι θα προτιμούσαν να περιμένουμε μέχρις ότου έχουμε στα χέρια μας μιαν έκθεση της πορτογαλικής Προεδρίας , μετά από την περιοδεία στις ευρωπαϊκές πρωτεύουσες , για να γνωρίζουμε εάν υπάρχει κινητοποίηση ή αντίστοιχη δυναμική για μια διευρυμένη ημερήσια διάταξη .
Όμως έχουμε εμπιστοσύνη στην πορτογαλική Προεδρία και στη δέσμευσή που εξάγγειλε ότι δηλαδή στη Σύνοδο Κορυφής τον Μάρτιο στη Λισσαβόνα θα προτείνει και άλλα σημεία για την ημερήσια διάταξη .
Παρακαλούμε τις κυβερνήσεις των κρατών μελών να αποδεχθούν την πρόταση της πορτογαλικής Προεδρίας .
Εν προκειμένω προκαταβάλλουμε την εμπιστοσύνη μας και ελπίζουμε ότι δεν θα δοκιμάσουμε απογοήτευση , καθώς υποβάλλουμε ήδη από τώρα τη γνωμοδότησή μας , χωρίς να γνωρίζουμε αν υπάρχει νέα δυναμική και ποια θα είναι τα περαιτέρω σημεία της ημερήσιας διάταξης .
Η γνωμοδότηση που σας υποβάλλουμε σήμερα είναι ένα σαφές μήνυμα προς τις κυβερνήσεις , να μην χάσουν την τελευταία ευκαιρία να πραγματοποιήσουν μια φιλόδοξη μεταρρύθμιση της ΕΕ ήδη πριν από τη διεύρυνση και να βελτιώσουν τις δυνατότητες αποδοχής της επόμενης Συνθήκης για την Ευρώπη , μεριμνώντας για μεγαλύτερη διαφάνεια και διασφαλίζοντας την πλήρη συμμετοχή του Κοινοβουλίου .
Ευχαριστώ και εγώ την πορτογαλική Προεδρία και τον Επίτροπο Barnier για τη συνεργασία .
Παρακαλώ το Κοινοβούλιο για την ευρύτερη δυνατή αποδοχή της γνωμοδότησής μας .
Κύριε Πρόεδρε , κύριοι βουλευτές , θα επιθυμούσα πρώτα απ ' όλα να εκφράσω την ευγνωμοσύνη μου για την εμπιστοσύνη που εξεδήλωσαν οι δύο προηγούμενοι ομιλητές στην πορτογαλική Προεδρία για το έργο που αυτή επιτελεί με σκοπό την προώθηση της συγκεκριμένης υπόθεσης .
Νομίζω ότι η δέσμευση της Πορτογαλίας να διαδραματίσει το ρόλο της ως παράγοντας ώθησης της έναρξης των εργασιών της εν λόγω Διακυβερνητικής Διάσκεψης κατέστη πλέον αρκετά σαφής , τόσο από εμένα , κατά τη συνεδρίαση της Επιτροπής Συνταγματικών Υποθέσεων στην οποία συμμετείχα , όσο και αργότερα , από τον κ. Υπουργό Εξωτερικών , επ ' ευκαιρία των δηλώσεών του ενώπιον της Ολομελείας αυτού του Κοινοβουλίου .
Πράγματι , πιστεύουμε πως έχουμε εδώ μια μοναδική ευκαιρία ώστε να επιτύχουμε την προσαρμογή της Ένωσης ενόψει της διεύρυνσης , και οφείλουμε να αναζητήσουμε το συγκεκριμένο στόχο κατά τρόπο τέτοιο που να συνδυάζουμε κάποια δόση φιλοδοξίας με την αναγκαιότητα να επιτύχουμε αποτελέσματα μέχρι τα τέλη του τρέχοντος έτους .
Αυτό είναι το εμπόδιο που καλούμεθα όλοι να αντιμετωπίσουμε , στο οποίο προφανώς θα προστεθούν οι δυσκολίες ορισμένων κυβερνήσεων να πετύχουν την αποδοχή ορισμένων εκ των μέτρων , είτε με την έγκρισή τους από τα κοινοβούλια των χωρών τους , είτε , ενδεχομένως , μέσω της διενέργειας εθνικών δημοψηφισμάτων .
Πρέπει να αναλογιστούμε ότι έχουμε μπροστά μας σχεδόν μία διετία μέχρις ότου ολοκληρωθεί η διαδικασία της κύρωσης και πως είναι σημαντικό να διασφαλίσουμε την επιτυχή έκβαση αυτής της διαδικασίας .
Οποιοδήποτε ενδεχόμενο αποτυχίας θα σημάνει μία κατά κράτος αποτυχία της Ένωσης .
Θα πρέπει , συνεπώς , να εγγυηθούμε ότι τα τελικά αποτελέσματα των εργασιών αυτής της Διακυβερνητικής θα απολαμβάνουν , σε μεγαλύτερο ή μικρότερο βαθμό , ευρείας αποδοχής από μεριάς της κοινής γνώμης και του συνόλου των πολιτικών ρευμάτων σε όλες τις χώρες της Ένωσης .
Πιστεύω ότι ο μηχανισμός που προτείναμε για τη δρομολόγηση αυτής της Διακυβερνητικής έτυχε ιδιαίτερα ευνοϊκής αποδοχής από πλευράς των διαφορετικών κυβερνήσεων .
Η συγκρότηση μίας ομάδας προπαρασκευής , της οποίας προεδρεύω , έρχεται να ανταποκριθεί στις ανησυχίες που εξέφρασε το Ευρωπαϊκό Κοινοβούλιο αναφορικά με το βαθμό συμμετοχής των εκπροσώπων του στο συγκεκριμένο στάδιο των διαπραγματεύσεων .
Βασίζομαι λοιπόν στο έργο που θα φέρουν σε πέρας οι φίλοι μας Brok και Τσάτσος , ένα έργο το οποίο θα αποδειχθεί , αναμφιβόλως , εξαιρετικά χρήσιμο για τη συζήτηση που θα λάβει χώρα στους κόλπους της προαναφερόμενης ομάδας .
Θα ήθελα να προσθέσω ότι εκτιμούμε πως η συμμετοχή τους θα είναι πλήρης και απεριόριστη , όπως ακριβώς και η συμμετοχή οιουδήποτε άλλου μέλους της ομάδας το οποίο θα ορισθεί από τα κράτη μέλη , ή η συμμετοχή οιουδήποτε εκπροσώπου της Επιτροπής .
Θεωρώ επίσης πως το γεγονός ότι η πορτογαλική Προεδρία επέλεξε να ορίσει τον υπουργό Εξωτερικών ως πρόεδρο και επικεφαλής της υπουργικής ομάδας αποτελεί άλλη μια ένδειξη της πρόθεσής μας να εξασφαλίσουμε ότι η κυρία Πρόεδρος του Ευρωπαϊκού Κοινοβουλίου θα έχει απέναντί της έναν εκπρόσωπο κατάλληλου επιπέδου , και όχι κάποιου επιπέδου που θα μπορούσε πιθανώς να ερμηνευθεί ως μη αντάξιο του ρόλου της Προέδρου ενός θεσμικού οργάνου όπως είναι αυτό το Κοινοβούλιο .
Δεν είναι εύκολο , κύριε Πρόεδρε και κύριοι βουλευτές , να προβώ σε συνοπτική απαρίθμηση των επαφών - αλλά και της έννοιας των επαφών - που είχα τον τελευταίο καιρό με τις διάφορες χώρες , για τον πρόσθετο λόγο ότι δεν έχω ακόμη ολοκληρώσει την περιοδεία μου στις διαφορετικές πρωτεύουσες , μια περιοδεία κατά την οποία επεδίωξα να μάθω πώς αντιλαμβάνονται οι διάφορες χώρες την εν λόγω Διακυβερνητική και τί αναμένουν από αυτήν .
Εκτιμώ , ωστόσο , ότι μπορώ να συμπεράνω πως από μεριάς των διαφόρων χωρών εκδηλώνεται μία διάθεση να ξεκινήσει η συζήτηση , κάτι που δεν σημαίνει κατ ' ανάγκην- και καλό είναι να αποσαφηνίσουμε αυτό το σημείο ήδη εξαρχής - ότι υπάρχει και η διάθεση να ολοκληρωθεί η συζήτηση κατά τρόπο που να συμβαδίζει με την άποψη που διατύπωσε αυτό το Κοινοβούλιο , ότι πρέπει να προωθηθούν κάποιες αναγκαίες μεταρρυθμίσεις .
Εν πάση περιπτώσει , οι διάφορες κυβερνήσεις φάνηκαν πρόθυμες να δεχθούν τη συζήτηση επί μιας σειράς θεμάτων τα οποία είχα προτείνει .
Είναι αυτονόητο ότι τα θέματα αυτά αφορούν τις υποθέσεις θεσμικού χαρακτήρα που η πορτογαλική Προεδρία εκτιμά ότι εντάσσονται στο πλαίσιο της εντολής της .
Και θα επιθυμούσα να καταστήσω σαφές ένα πράγμα : η δική μας εντολή , η εντολή που μας ανέθεσε το Ελσίνκι , δεν περιορίζεται απλώς , από πορτογαλικής σκοπιάς , στην εντολή για διευθέτηση των τριών παραλειπόμενων του Αμστερνταμ .
Η εντολή που μας ανέθεσε το Ελσίνκι αφορά μεν τα τρία παραλειπόμενα του Αμστερνταμ , αλλά περιλαμβάνει επίσης όλα τα θεσμικά ζητήματα που ενδεχομένως συνδέονται με αυτά .
Και υπό αυτή την έννοια , έχουμε προφανώς το έργο που αφορά τα κοινοτικά θεσμικά όργανα , τα όργανα της Ένωσης , έχουμε το πρόβλημα των ενισχυμένων συνεργασιών , ένα ζήτημα στενά συνδεδεμένο με τα ίδια τα παραλειπόμενα του Αμστερνταμ , αλλά έχουμε επίσης υποθέσεις όπως είναι η νομική υπόσταση της Ένωσης , η απλούστευση των Συνθηκών , καθώς και άλλα ζητήματα τα οποία συναρτώνται άμεσα από μία αναθεώρηση της Συνθήκης για την Ευρωπαϊκή Ένωση και που πιστεύουμε πως είναι σημαντικά , ιδίως εκείνα που συνδέονται , λόγου χάρη , με την ίδια τη διάρθρωση αυτού του Κοινοβουλίου ενόψει της εποχής μετά τη διεύρυνση , με τα μεταβατικά μέτρα που θα πρέπει να δρομολογηθούν σε περίπτωση που η διεύρυνση πραγματοποιηθεί πριν από τη λήξη της εντολής του Κοινοβουλίου , καθώς και με την ατομική ευθύνη των Επιτρόπων .
Εν κατακλείδι , υπάρχει ένα σύνολο θεμάτων τα οποία θεωρούμε πως θα μπορούσαν ή θα έπρεπε να εγγραφούν στην ημερήσια διάταξη αυτής της Διακυβερνητικής .
Διαπιστώσαμε εκ μέρους των κρατών μελών μία προθυμία αναφορικά με αυτό το ενδεχόμενο .
Θέλω να πω ότι επιδίωξή μου είναι να αναληφθούν και να προωθηθούν , με γοργούς ρυθμούς και με την καταβολή ουσιαστικών προσπαθειών , οι σχετικές πρωτοβουλίες κατά τη διάρκεια της θητείας της πορτογαλικής Προεδρίας .
Δεν προτίθεμαι να ξεκινήσω τις εργασίες της ομάδας προπαρασκευής απλώς και μόνο προβαίνοντας σε κάτι που θα θύμιζε ανασκόπηση των ζητημάτων , σε ένα είδος καταγραφής - όπως έλεγε ο συνάδελφός μας Napolitano - των θέσεων των διαφόρων κρατών μελών .
...
Θέλω να πω με αυτό ότι πρόθεσή μας είναι να καταμερίσουμε τις εργασίες της ομάδας προπαρασκευής σε δύο κύκλους , στη διάρκεια των οποίων θα εξεταστεί όλο το φάσμα των θεμάτων .
Σε έναν πρώτο κύκλο , θα μπορούσαμε να ξεκινήσουμε με το πρόβλημα των διαδικασιών ψηφοφορίας με ειδική πλειοψηφία , να προσπαθήσουμε στη συνέχεια να εντοπίσουμε τα θεσμικά ζητήματα που συνδέονται με τα παραλειπόμενα , και μόνον κατόπιν τούτου να ασχοληθούμε με το θέμα της Επιτροπής και της στάθμισης των ψήφων .
Μεταξύ των θεσμικών ζητημάτων θα συμπεριλάβουμε και τα θέματα που αφορούν τις ενισχυμένες συνεργασίες .
Στο τελικό στάδιο , στο πλαίσιο του δεύτερου κύκλου εργασιών , θα μπορούσαμε να εξετάσουμε εκ νέου όλα τα ζητήματα με τα οποία στο μεταξύ θα έχουμε ήδη καταπιαστεί , που θα έχουν συζητηθεί κατά τις συνεδριάσεις σε υπουργικό επίπεδο , και επιπλέον θα προσπαθούσαμε να προσδιορίσουμε ένα σύνολο νέων θεμάτων που θα μπορούσαν να προστεθούν στην ημερήσια διάταξη .
Και τότε , θα έχει ουσιαστική σημασία να γνωρίζουμε εάν τα προβλήματα που συνδέονται με την ασφάλεια και την άμυνα θα έχουν πράγματι ωριμάσει μετά από συζητήσεις που θα διεξαχθούν στα κατάλληλα βήματα , κατά τρόπο ώστε να είμαστε σε θέση να τα συμπεριλάβουμε στο τελικό στάδιο της Διακυβερνητικής .
Το ίδιο θα μπορούσαμε να πούμε αναφορικά με τον Χάρτη των Θεμελιωδών Δικαιωμάτων .
Θα εξακριβώσουμε , όταν φθάσει η στιγμή , εάν οι συζητήσεις που διεξάγονται στα ενδεδειγμένα βήματα έχουν φθάσει σε βαθμό ωριμότητας τέτοιο που να μας επιτρέπει να καταλήξουμε στο συμπέρασμα πως μπορούμε να εγγράψουμε το θέμα αυτό στην ημερήσια διάταξη της Διακυβερνητικής Διάσκεψης , συγκεκριμένα το δεύτερο εξάμηνο του τρέχοντος έτους .
Αυτές είναι , καταρχήν , οι προθέσεις της Προεδρίας όσον αφορά το συγκεκριμένο θέμα .
Θα συντάξουμε μια έκθεση που θα υποβληθεί στο Ευρωπαϊκό Συμβούλιο της Λισσαβόνας , μια έκθεση της οποίας το περιεχόμενο δεν μπορεί , φυσικά , να αποτελεί παρά μια καταγραφή γεγονότων , δεδομένου ότι θα εκπονούμε μία έκθεση το Μάρτιο ενώ οι εργασίες της Διακυβερνητικής θα έχουν ξεκινήσει μόλις το Φεβρουάριο .
Ευελπιστούμε ότι η δεύτερη έκθεση , αυτή που η Προεδρία πρόκειται να υποβάλει , με δική της ευθύνη , επ ' ευκαιρία του δεύτερου Ευρωπαϊκού Συμβουλίου , θα έχει περισσότερο ουσιαστικό περιεχόμενο και θα μπορεί πλέον να συμπεριλαμβάνει κάποια στοιχεία πιο συγκεκριμένα , τα οποία θα αφορούν , ει δυνατόν , τα κείμενα των Συνθηκών .
Σημειώνουμε προσεκτικά τις προτάσεις της Επιτροπής .
Ως Προεδρία , αποδεχόμαστε τις εν λόγω προτάσεις και σκοπεύουμε να τις θέσουμε προς συζήτηση κατά την προσεχή Διακυβερνητική ούτως ώστε να εξεταστούν δεόντως , ανεξαρτήτως της αντίληψης που ενδεχομένως έχει το κάθε κράτος μέλος αναφορικά με τις λύσεις που προκρίνει η Επιτροπή στη συγκεκριμένη πρότασή της .
Ελπίζουμε ότι θα μπορέσουμε να συμπεριλάβουμε όλες τις υποδείξεις και τα έγγραφα σχετικά με αυτό το θέμα , που ενδεχομένως θα διαβιβάσουν τα κράτη μέλη .
Εξάλλου , θα απευθύνουμε έκκληση σε αυτά τα κράτη μέλη ώστε να μας διαβιβάσουν , όσο το δυνατόν πιο σύντομα , τις συνεισφορές τους στη Διακυβερνητική , κατά τρόπο ώστε αυτές να μη φθάσουν την τελευταία στιγμή .
Είναι προφανές ότι η Διακυβερνητική θα είναι διαρκώς πρόθυμη να δεχθεί οποιαδήποτε πρόταση από πλευράς των κρατών μελών , θα επιθυμούσαμε ωστόσο να καθορίσουν τα κράτη μέλη τις θέσεις τους όσο το δυνατόν συντομότερα .
Ιδού , κύριε Πρόεδρε και κύριοι βουλευτές , πώς αντιλαμβανόμαστε τη δρομολόγηση ενός χρήσιμου έργου στο πλαίσιο αυτής της Διακυβερνητικής .
Θέλω να πω ότι , σε ό , τι μας αφορά , είμαστε σαφώς αποφασισμένοι να επιτύχουμε την προώθηση ενός αποδοτικού και σοβαρού έργου στη διάρκεια του εξαμήνου της πορτογαλικής Προεδρίας όσον αφορά τη Διακυβερνητική Διάσκεψη .
Και ευελπιστούμε ότι θα καταφέρουμε να κληροδοτήσουμε στη γαλλική Προεδρία κάτι το απτό και όσο το δυνατόν πιο αντιπροσωπευτικό των προσδοκώμενων κατευθύνσεων .
...
Με άλλα λόγια , δεν θα είμαστε πλέον σε θέση ως ψηφοφόροι να καθορίσουμε αυτές τις συνθήκες .
Δεν θα μπορούμε πλέον να τις αλλάξουμε την ημέρα τον εκλογών .
...
( Ο Πρόεδρος διακόπτει τον ομιλητή ) Κύριε Πρόεδρε , συνάδελφοι , μετά από τη δήλωση της πορτογαλικής Προεδρίας έχω την αίσθηση ότι η προσέγγιση της Διακυβερνητικής Διάσκεψης γίνεται σε μεγάλο βαθμό ανοικτά και με καλοζυγισμένες αντιλήψεις .
...
Θα πρέπει επίσης να συγκροτηθεί το τρίγωνο Επιτροπή , Συμβούλιο και Κοινοβούλιο και στον τομέα της εξωτερικής πολιτικής και της πολιτικής ασφάλειας .
...
Οι συζητήσεις που διεξάγουμε τις τελευταίες ημέρες λ.χ. για μια κυβέρνηση ενός κράτους στην Ευρώπη , δείχνουν ότι πρέπει να καθορίσουμε την πνευματική και ηθική κατεύθυνση της Ευρωπαϊκής Ένωσης η οποία προσανατολίζεται προς το κράτος δικαίου και προς το καλό της Κοινότητας και του συνόλου .
Δείχνουν επίσης ότι για τον λόγο αυτό θα πρέπει να ενταχθούν στη Συνθήκη νομικά δεσμευτικά θεμελιώδη δικαιώματα , καθότι τούτο θα αποτελέσει κρίσιμο σταθεροποιητικό παράγοντα .
Παρακαλώ εκείνους που μέχρι σήμερα ήταν ακόμα υπερβολικά συγκρατημένοι στο συγκεκριμένο ζήτημα να σκεφτούν μήπως ήρθε η στιγμή να το λάβουν υπ ' όψιν και ενδεχομένως να επιδείξουν το απαιτούμενο θάρρος ώστε να μπορέσουμε να προχωρήσουμε ανάλογα και στον τομέα των θεμελιωδών δικαιωμάτων Η Ευρωπαϊκή Ένωση δεν χρειάζεται κανένα , ή μάλλον σχεδόν κανένα νέο μέσο , ούτε νέες αρμοδιότητες .
...
Είμαι πεπεισμένος , αξιότιμη Προεδρία του Συμβουλίου ότι υπό την δική σας ηγεσία το ζήτημα αυτό θα πάρει την ανάλογη θετική μορφή. της Επιτροπής Συνταγματικών Υποθέσεων .
...
Ποια είναι η άποψη της Επιτροπής για το θέμα αυτό ; Η Πρόεδρος και δύο εκπρόσωποι του Κοινοβουλίου πρέπει να μπορούν να συμμετάσχουν στο ίδιο πολιτικό επίπεδο , δηλαδή όχι μόνο στην ομάδα προπαρασκευής , αλλά στο ίδιο πολιτικό επίπεδο με την Επιτροπή .
...
Και δεν πρόκειται για ένα πρόβλημα δεσμών με το παρελθόν .
...
Σκέφτομαι τις παρεμβάσεις των κκ .
Bonde και Sjφstedt , οι οποίοι επισημαίνουν ότι το συγκεκριμένο σχέδιο περιέχει μια σειρά σχετικά ασυνείδητων , αλλά αναμφισβήτητα ορθολογικών και εξουσιαστικών προσπαθειών , που στοχεύουν στη δημιουργία μιας συγκεντρωτικής και ομοσπονδιακής ΕΕ .
...
Κύριε Πρόεδρε , συνιστώ ένθερμα την υπερψήφιση του ψηφίσματος Δημητρακόπουλου / Leinen .
Σα αυτό εκφράζεται καθαρά τόσο η απογοήτευσή μας για την ανεπάρκεια της ημερήσιας διάταξης , όσο όμως και η θέλησή μας να γίνει το συντομότερο η Διακυβερνητική Διάσκεψη .
...
Η Σκωτία , με πληθυσμό 5 εκατομμυρίων , έχει οκτώ έδρες στο Ευρωπαϊκό Κοινοβούλιο επί του παρόντος .
Η Δανία και η Φινλανδία , με τον ίδιο πληθυσμό , έχουν δεκαέξι .
...
Κύριε Πρόεδρε , κύριε Προεδρεύων του Συμβουλίου , κύριε Επίτροπε , η σημερινή συζήτηση προσλαμβάνει μια ιδιαίτερη πολιτική σημασία : το ζητούμενο δεν είναι να κάνουμε μια συζήτηση για το περιεχόμενο των θεμάτων που έχουν ήδη εγγραφεί στην ημερήσια διάταξη ή εκείνων που όλοι μας επιθυμούμε να συμπεριληφθούν , αλλά να καταθέσουμε την πολιτική άποψη του Ευρωπαϊκού Κοινοβουλίου σχετικά με τη σύγκληση της Διακυβερνητικής Διάσκεψης .
Και αναφορικά με αυτό το ζήτημα , δεν υπάρχει τίποτα το νεότερο παρά μόνον ένα πράγμα : το γεγονός ότι το Ευρωπαϊκό Κοινοβούλιο , με την υποβολή της παρούσας γνωμοδότησης και την έγκρισή της που αναμένεται για αύριο , χαράζει μια θετική στρατηγική με στόχο τη συμβολή του ώστε να διευρυνθεί η ημερήσια διάταξη της ΔΔ .
Αλλά επίσης δηλώνει διατεθειμένο να συνεισφέρει , με τη συμμετοχή των δύο εκπροσώπων του και της Προέδρου του , στην εμβάθυνση του προβληματισμού ενόψει της εξεύρεσης μίας οριστικής λύσης στην υπόθεση της αναθεώρησης της Συνθήκης .
Πρόκειται για μια γνωμοδότηση ευνοϊκή όσον αφορά τη σύγκληση της ΔΔ , αλλά επίσης επικριτική , όπως άλλωστε πρέπει να είναι , σχετικά με το περιεχόμενο της ημερήσιας διάταξής της .
Την παρούσα στιγμή , το θεσμικό πλαίσιο έχει αποσαφηνισθεί .
Είναι γνωστή η θετική και φιλόδοξη θέση της πορτογαλικής Προεδρίας , είναι γνωστή η θέση του Ευρωπαϊκού Κοινοβουλίου , ενώ η Επιτροπή μόλις ολοκλήρωσε την εκπόνηση ενός εγγράφου όπου και αυτή παραθέτει μερικές από τις θέσεις της , αφήνοντας για ορισμένες τη δυνατότητα επιλογής .
Οπότε , αυτή τη στιγμή , το « μπαλάκι » - όπως λένε κοινώς - έχει πλέον περάσει στο Ευρωπαϊκό Συμβούλιο .
Υπό αυτή την έννοια , κύριε Πρόεδρε και αγαπητέ μου φίλε Δρ .
Seixas da Costa , η ερώτηση που σας απευθύνω είναι η ακόλουθη : χωρίς να θέλω να μάθω τίποτα περισσότερο από όσα οφείλουμε να γνωρίζουμε αυτή τη στιγμή , ώστε να μην υπονομεύσουμε τον κοινό μας στόχο , θα ήθελα να ξέρω εάν προέκυψαν , μετά τις επαφές που πραγματοποιήσατε κατά την περιοδεία σας στις πρωτεύουσες , και κατά τη δική σας κρίση , κάποια στοιχεία που θα μπορούσατε να μας μεταφέρετε και τα οποία θα μας ήταν χρήσιμα , μιας και αυτή τη στιγμή , πέρα από το έργο που διεξάγουμε στο Ευρωπαϊκό Κοινοβούλιο , μάλλον προέχει το έργο μας ως ομάδα πίεσης , το έργο που αναλαμβάνουμε με στόχο την ευαισθητοποίηση και την άσκηση επιρροής επί των εθνικών κυβερνήσεων που επιδεικνύουν τη λιγότερη προθυμία να συμπεριλάβουν και άλλα θέματα στην ημερήσια διάταξη της ΔΔ .
Η δεύτερη ερώτησή μου απευθύνεται στον κ. Επίτροπο Barnier και αφορά την πρωτοβουλία της Επιτροπής .
Εγώ υπήρξα ένας από τους επικριτές σας : είχα τη γνώμη πως η Επιτροπή θα έπρεπε να προωθήσει παραπέρα την υπόθεση στο Ευρωπαϊκό Συμβούλιο του Ελσίνκι .
Ταυτόχρονα όμως , νομίζω ότι η Επιτροπή επιτέλεσε ένα εξαίρετο έργο , ανεξάρτητα από αν συμφωνώ ή όχι με τις λύσεις που προκρίνονται στο έγγραφο που ενέκρινε στις 26 του μηνός .
Γιατί όμως η Επιτροπή αρκείται στα παραλειπόμενα του Αμστερνταμ ή , έστω , περιορίζεται στο να προσθέσει άλλο ένα σημείο ; Γιατί αρκείται απλώς στο να εξαγγείλει ότι άλλα θέματα , όπως ο Χάρτης των Θεμελιωδών Δικαιωμάτων ή τα ζητήματα που συνδέονται με την Κοινή Εξωτερική Πολιτική και Πολιτική Ασφαλείας , θα μπορούσαν ενδεχομένως να εγγραφούν στην ημερήσια διάταξη ; Αυτός είναι ο λόγος γιατί απευθύνω μια πρόκληση στην Επιτροπή : με τον ίδιο τρόπο όπως επιτέλεσε ένα σοβαρό έργο σχετικά με τις ήδη γνωστές προτάσεις , ζητώ από αυτήν να κάνει συγκεκριμένα βήματα και να αρχίσει να επεξεργάζεται , έστω και ως εναλλακτικές προτάσεις , και κάποια άλλα θέματα , που ενδεχομένως θα εγγραφούν αργότερα στην ημερήσια διάταξη , συμβάλλοντας ταυτόχρονα στην επιτυχία του χειρισμού τους .
Τελειώνοντας , κύριε Πρόεδρε , θα ήθελα να ευχηθώ κάθε επιτυχία στην πορτογαλική Προεδρία .
Το καθήκον που καλείται να αντιμετωπίσει δεν είναι εύκολο , αλλά ξέρω ότι η υπόθεση βρίσκεται σε καλά χέρια .
...
Πρόκειται για δύσκολα θέματα .
Πρόκειται για ζητήματα πολιτικής και θεσμικής μηχανικής τα οποία δεν είναι πάντα εύκολο να τα εξηγήσει κανείς .
...
Η ημερήσια διάταξη προβλέπει την κοινή συζήτηση επί των ακόλουθων εκθέσεων : Α5-0007 / 2000 , της κυρίας Berger , εξ ονόματος της Επιτροπής Νομικών Θεμάτων και Εσωτερικής Αγοράς , σχετικά με την πρόταση οδηγίας του Ευρωπαϊκού Κοινοβουλίου και του Συμβουλίου , που αφορά τους όρους απόσπασης των μισθωτών εργαζομένων υπηκόων τρίτου κράτους , στο πλαίσιο παροχής διασυνοριακών υπηρεσιών ( COM ( 1999 ) 3 - C4-0095 / 1999 - 1999 / 012 ( COD ) ) .
Α5-0012 / 2000 , της κυρίας Berger , εξ ονόματος της Επιτροπής Νομικών Θεμάτων και Εσωτερικής Αγοράς , σχετικά με την πρόταση οδηγίας του Συμβουλίου , που αφορά την επέκταση της ελεύθερης παροχής διασυνοριακών υπηρεσιών στους υπηκόους τρίτου κράτους που είναι εγκατεστημένοι στο εσωτερικό της Κοινότητας ( COM ( 1999 ) 3 - C4-0096 / 1999 - 1999 / 013 ( CNS ) ) . .
...
Ωστόσο το Ευρωπαϊκό Δικαστήριο δεν αναφέρθηκε ρητά στις προϋποθέσεις που αφορούν τις θεωρήσεις και τις άδειες παραμονής .
Τούτο αποτελεί ένα ζήτημα που δεν μπόρεσαν να αποσαφηνίσουν στη συνέχεια ούτε τα κράτη μέλη .
...
Θα αναφερθώ τώρα στις σημαντικότερες τροπολογίες που προτείνουμε .
Μία ουσιαστική διαφορά συνίσταται στο ότι αντί του συστήματος " Κάρτα παροχής υπηρεσιών , συν αναγγελία κάθε περίπτωσης παροχής υπηρεσίας " δεν προβλέπεται πλέον η δυνατότητα να απαιτείται η εκ των προτέρων αναγγελία στη χώρα υποδοχής της κάθε επιμέρους ανάθεσης .
...
Για το λόγο αυτό , η Επιτροπή υποστηρίζει και από τις δύο απόψεις την τροπολογία αριθ .
22 της κ. Palacio .
...
Ελπίζω ότι στο τέλος της συζήτησης , όταν θα έχουν λάβει το λόγο όλοι οι ομιλητές , θα μου δοθεί για άλλη μια φορά η δυνατότητα να υπεισέλθω στις διάφορες τροπολογίες . Κύριε Πρόεδρε , κυρίες και κύριοι , η Ομάδα του Ευρωπαϊκού Λαϊκού Κόμματος ( Χριστιανοδημοκράτες ) και των Ευρωπαίων Δημοκρατών θα αποδεχθεί αύριο με μεγάλη πλειοψηφία τις τροπολογίες τη Επιτροπής Νομικών Θεμάτων καθώς και την τροποποιημένη εκδοχή .
...
Έχουμε επιβαρύνει τον πολίτη με διάφορες αλλαγές .
Από την ΕΟΚ περάσαμε στην ΕΚ για να καταλήξουμε στην ΕΕ .
...
Χαιρετίζουμε το εν λόγω γεγονός και , πιστεύοντας πως αποτελεί λογική και ορθή διάταξη , θα υποστηρίξουμε το πιο φιλελεύθερο κείμενο το οποίο θεωρούμε σύμφωνο με τον νόμο. της Επιτροπής Νομικών Θεμάτων και Εσωτερικής Αγοράς .
( ES ) Κύριε Πρόεδρε , κύριε Επίτροπε , θέλω να επαινέσω καταρχάς την έξοχη εργασία που πραγματοποίησε η κ. Berger και , εν γένει , η Επιτροπή Νομικών Θεμάτων , που συμπεριέλαβε καινοτόμες ιδέες σε αυτή την οδηγία που ευελπιστώ ότι θα επικυρωθούν από την Επιτροπή και το Συμβούλιο .
Εν τούτοις , κατέθεσα μια τροπολογία .
Κυρία Berger , στο 6ο σημείο αιτιολόγησης στην τροπολογία σας αριθ .
2 επικαλείσθε την ασφάλεια δικαίου .
...
Εάν δεν πρόκειται για κράτος του χώρου Σένγκεν , στην τελευταία παράγραφο της τροπολογίας μου αριθ .
22 , προβλέπεται αυτή η δυνατότητα , που είναι απολύτως ελεγχόμενη , και πιστεύω με μεγαλύτερη ασφάλεια δικαίου .
Η διακριτική ευχέρεια του κράτους που αναφέρετε στο σημείο ε ) της τροπολογίας σας αριθ .
10 νομίζω ότι δεν είναι συνεπής με το συνολικό κείμενο της άριστης έκθεσής σας .
...
Γι ' αυτόν τον λόγο θα καταψηφίσουμε και τις δύο αυτές προτάσεις . Κύριε Πρόεδρε , κύριε Επίτροπε , κυρίες και κύριοι , θέλω αρχικά να ευχαριστήσω θερμά την εισηγήτρια και τον συνάδελφο Wieland για τις προσπάθειές τους να συνοψίσουν στην έκθεση τις διαφορετικές μεταξύ τους τροπολογίες και τα διαφορετικά συμφέροντα με τέτοια ομοιογένεια .
...
Πρόκειται η οδηγία να επηρεάσει τις ενταξιακές διαπραγματεύσεις ; Πώς θα ερμηνευθεί από τη δική σας σκοπιά το άρθρο 1 , δεδομένου ότι τούτο είναι πολύ σημαντικό για τη χώρα μου που συνορεύει με πολλά νέα κράτη με τα οποία διεξάγονται ενταξιακές διαπραγματεύσεις ; Κύριε Πρόεδρε , κύριε Επίτροπε , συνάδελφοι , μιλάμε για επιχειρηματίες οι οποίοι μέχρι σήμερα ήταν υποχρεωμένοι να διαπιστώνουν κάθε φορά ότι δύο από τις σημαντικότερες ελευθερίες , η ελεύθερη κυκλοφορία προσώπων και εμπορευμάτων , δεν ίσχυαν στην περίπτωσή τους .
...
Είμαι της γνώμης ότι με την έκθεση αυτή προχωρήσαμε ένα ακόμη βήμα προς την υλοποίηση της εσωτερικής αγοράς . Κύριε Πρόεδρε , σας ευχαριστώ που μου προσφέρετε τη δυνατότητα να υπεισέλθω ιδιαιτέρως στις διάφορες τροπολογίες .
...
2 , 11 , 12 , 15 , 16 και 22 .
Θεωρούμε αποδεκτές και τις τροπολογίες αριθ .
7 και 8 , εφόσον διαπιστωθεί η απόσπαση στο κράτος μέλος προέλευσης .
Η Επιτροπή συμφωνεί επίσης με την τροπολογία αριθ .
11 , εκτός από την προτεινόμενη περίοδο της προηγούμενης απασχόλησης για διάστημα μόνο τριών μηνών .
Αυτό το εξήγησα προηγουμένως .
Συμφωνούμε επίσης και με την τροπολογία αριθ .
13 στο βαθμό που συμβάλλει στη διεύρυνση του πεδίου εφαρμογής του δελτίου από ένα σε όλα τα κράτη μέλη .
Όσον αφορά την επιτροπολογία , οι τροπολογίες αριθ .
14 και 21 είναι αποδεκτές στο βαθμό που αφορούν τα δικαιώματα του Κοινοβουλίου .
Μετά λύπης μου πρέπει να πω ότι η τροπολογία αριθ .
10 δεν μπορεί να γίνει δεκτή από την Επιτροπή όσον αφορά την περίοδο των τριών μηνών και το ρόλο του κράτους μέλους προορισμού .
Από την άποψη αυτή , η Επιτροπή υποστηρίζει την τροπολογία αριθ .
22 , όπως άλλωστε παρατήρησα και προηγουμένως .
Οι υπόλοιπες τροπολογίες δεν μπορούν να γίνουν δεκτές .
Προσωπικά συμπαθώ περισσότερο τον όρο " κάρτα παροχής υπηρεσιών ΕΕ " ; που προτείνεται στην τροπολογία αριθ .
1 , όμως η Συνθήκη του Αμστερνταμ δεν το επιτρέπει αυτό .
Η τροπολογία αριθ .
18 παραπέμπει στην οδηγία 96 / 71 σχετικά με τους βασικούς μισθούς , η οποία ισχύει ήδη με αποτέλεσμα να μην χρειάζεται τροποποίηση .
Εάν η Επιτροπή αποδεχόταν την τροπολογία αριθ .
17 , αυτό θα σήμαινε ότι θα αρκούσε μια απλή υποχρέωση αναφοράς σε περίπτωση που δεν έχει εκδοθεί έγκυρο δελτίο .
Αυτό αντίκειται προς το συμφέρον της δημόσιας τάξης στα κράτη μέλη .
Με βάση την αιτιολόγησή μου για την τροπολογία αριθ .
10 , θεωρώ μη παραδεκτή και την τροπολογία αριθ .
19 .
Η Επιτροπή έχει την ίδια άποψη σχετικά με παρόμοιες τροπολογίες επί της δεύτερης πρότασης .
Σ ' αυτό θα ήθελα να προσθέσω ότι η τροπολογία αριθ .
10 επί της πρότασης αυτής είναι απόλυτα παραδεκτή .
Όπως παρατήρησα προηγουμένως , όσον αφορά την τροπολογία αριθ .
15 για τον ορισμό της έννοιας " ελεύθερος επαγγελματίας " ; η Επιτροπή θα φροντίσει να βρει μια ικανοποιητική λύση για τις αντιρρήσεις που προβλήθηκαν .
...
Όπως είπα , αυτό ισχύει και για το Ηνωμένο Βασίλειο .
Βεβαίως , ισχύει και για το Βέλγιο , όπου παρουσιάστηκε πρόσφατα κάποιο πρόβλημα .
...
Η ημερήσια διάταξη προβλέπει τη συζήτηση επί της έκθεσης ( Α5-0003 / 2000 ) του κυρίου Marinho , εξ ονόματος της Επιτροπής Νομικών Θεμάτων και Εσωτερικής Αγοράς , σχετικά με : Ι. το σχέδιο απόφασης του Συμβουλίου που αφορά την τροποποίηση της απόφασης 88 / 591 / ΕΚΑΧ , ΕΟΚ , ΕΚΑΕ περί ιδρύσεως Πρωτοδικείου των Ευρωπαϊκών Κοινοτήτων ( 5713 / 1999 - C5-0020 / 1999 - 1999 / 0803 ( CNS ) ) και ΙΙ το σχέδιο απόφασης του Συμβουλίου που αφορά την τροποποίηση της απόφασης 88 / 591 / ΕΚΑΧ , ΕΟΚ , ΕΚΑΕ περί ιδρύσεως Πρωτοδικείου των Ευρωπαϊκών Κοινοτήτων ( 9614 / 1999 - C5-0167 / 1999 - 1999 / 0805 ( CNS ) ) .
Κύριε Πρόεδρε , δεν είναι σίγουρο ότι η μέλλουσα μεταρρύθμιση των Συνθηκών , στο πλαίσιο της Διακυβερνητικής Διάσκεψης , θα ανοίξει το δρόμο για μία αναμόρφωση του κοινοτικού δικαιοδοτικού συστήματος .
Η ιδέα να συμπεριληφθεί αυτό το θέμα στην ημερήσια διάταξη , για την οποία συζητούμε σήμερα , διατηρείτο ανελλιπώς μέχρι τη Σύνοδο Κορυφής του Ελσίνκι , συνεχίζει να προωθείται από μια σειρά κρατών μελών και από τα ίδια τα δικαστήρια , ενώ διατηρείται στην επικαιρότητα από το Ευρωπαϊκό Κοινοβούλιο , του οποίου η Επιτροπή Νομικών Θεμάτων καταρτίζει μία γνωμοδότηση , εξαιρετικής ποιότητας κατά τη γνώμη μου , σχετικά με το χαρακτήρα και την εμβέλεια της αναμόρφωσης του δικαιοδοτικού συστήματος .
Δεν έχω καμία αμφιβολία πως η προσεχής έκθεση αυτού του Κοινοβουλίου με θέμα την προετοιμασία της Διακυβερνητικής Διάσκεψης θα επαναφέρει με έμφαση αυτό το ζήτημα στο προσκήνιο , για τρεις λόγους οι οποίοι , κατά τη γνώμη μου , είναι γενικώς αποδεκτοί : διότι είναι αναγκαίο να απονέμεται περισσότερη δικαιοσύνη σε λιγότερο χρόνο , επειδή πρέπει να οικοδομηθεί το δικαιοδοτικό υπόβαθρο για την εγκαθίδρυση ενός χώρου ελευθερίας , ασφάλειας και δικαιοσύνης και , τέλος , διότι είναι αναγκαίο να ξεπεράσουμε μια εμπορευματική και οικονομική αντίληψη για τον ευρωπαϊκό χώρο , προσφέροντας στους πολίτες τη βεβαιότητα ότι απαρτίζουν μία κοινότητα δικαίου η οποία , εφόσον θεμελιώνεται στη δημοκρατική νομοθεσία και στα δικαστήρια , είναι προσηλωμένη στις ηθικές και νομικές αξίες τους και προασπίζει τα συμφέροντά τους , ακόμη και όταν η ισχύς της εθνικής νομοθεσίας δεν επαρκεί ώστε να τους παράσχει εγγυήσεις πλήρους ιθαγένειας .
Στην πραγματικότητα , οι προαναφερόμενοι ουσιαστικοί λόγοι , που αιτιολογούν μία εκ βάθρων αναμόρφωση του κοινοτικού δικαιοδοτικού συστήματος στο σύνολό του , είναι και οι λόγοι που αιτιολογούν την πιθανή μεταρρύθμιση του Πρωτοδικείου για την οποία συζητάμε σήμερα , αλλά με μια άλλη νομική βάση , που θεμελιώνεται στη Συνθήκη του Αμστερνταμ .
Υπάρχουν , ωστόσο , δυο-τρεις λόγοι που αιτιολογούν ειδικότερα τη συγκεκριμένη μεταρρύθμιση , τους οποίους παραθέτω στη συνέχεια : η μη προσαρμογή των δικαιοδοτικών οργάνων του Λουξεμβούργου , από άποψης τεχνικών και ανθρώπινων δυνατοτήτων , στον αυξανόμενο όγκο των υποθέσεων , η ρητή υποχρέωση της πολυγλωσσίας κατά τη διεξαγωγή των δικών , που είναι επακόλουθο της ανάγκης να γίνονται σεβαστές η γλώσσα και η νομική παράδοση του κάθε κράτους , και τέλος , το γεγονός ότι το συγκεκριμένο δικαστήριο - το Πρωτοδικείο - συνιστά το μοναδικό δικαιοδοτικό όργανο στο οποίο μπορούν να προσφεύγουν οι πολίτες και οι επιχειρήσεις για την επίλυση οικονομικών διαφορών αναφορικά με αποφάσεις οργάνων που είναι δυσμενείς γι ' αυτούς .
Για το λόγο αυτό , η προτεινόμενη αύξηση του αριθμού των δικαστών σε 21 είναι απολύτως δικαιολογημένη , μιας και , σε τελευταία ανάλυση , αυτό θα συνδράμει στη βελτίωση της αποτελεσματικότητας του Πρωτοδικείου , ανοίγοντας το δρόμο για τη συγκρότηση δύο επιπλέον τριμελών τμημάτων .
Το δεύτερο σχέδιο μεταρρύθμισης που προτείνουμε αποσκοπεί στη διεύρυνση των αρμοδιοτήτων του Πρωτοδικείου , εφόσον μέχρι σήμερα εισάγονταν αποκλειστικά , στο εν λόγω δικαστήριο , προσφυγές ακύρωσης που ασκούνται από ιδιώτες , ενώ από τώρα και στο εξής θα μπορούν και τα κράτη μέλη να ασκούν προσφυγές ακύρωσης .
Τα κράτη μέλη θα έχουν τη δυνατότητα εισαγωγής προσφυγών κατά πράξεων στους τομείς που σχετίζονται με την πολιτική των μεταφορών , τους κανόνες ανταγωνισμού που ισχύουν για τις επιχειρήσεις , τις κρατικές ενισχύσεις , τα μέτρα εμπορικής άμυνας , καθώς και τη χρησιμοποίηση πόρων των ταμείων , των χρηματοδοτικών μέσων και άλλων προγραμμάτων δράσης που προβλέπουν τη χορήγηση κοινοτικής χρηματοδοτικής συνδρομής , και ειδικότερα προσφυγών που αφορούν απάτες κατά του προϋπολογισμού της Ένωσης .
Παρέχοντας στα κράτη μέλη τη δυνατότητα άσκησης προσφυγής ενώπιον του Πρωτοδικείου , όπου ενδέχεται ήδη να εξετάζεται μία υπόθεση με παρόμοιο αντικείμενο κατόπιν προσφυγής από μεριάς ενός ιδιώτη , το εν λόγω δικαστήριο θα είναι πλέον σε θέση να γνωρίζει τις προσφυγές που ασκούνται από κάποιο κράτος μέλος , θέτοντας έτσι τα κράτη και τους ιδιώτες σε ισότιμη θέση έναντι της εξέλιξης της διαδικασίας .
Θα μπορούσε κανείς να πει , κύριε Πρόεδρε , ορισμένοι ίσως θα ισχυριστούν ότι η προτεινόμενη μεταρρύθμιση δεν προχωρά σε βάθος .
Πρόκειται όμως για μία εφικτή μεταρρύθμιση , η οποία δρομολογείται βάσει κανόνων που επιτρέπουν κάτι τέτοιο και συμβαδίζουν με τις διατάξεις της Συνθήκης του Αμστερνταμ .
Επί της ουσίας , πρόκειται ακριβώς για τη μεταρρύθμιση που προέβλεψε και διεκδίκησε το ίδιο το Δικαστήριο των Κοινοτήτων , με βάση την ισχύουσα Συνθήκη και ανεξαρτήτως της Διακυβερνητικής Διάσκεψης .
Πιστεύω ότι το Κοινοβούλιο θα εκφράσει τη συμφωνία του στις δύο αυτές προτάσεις μεταρρύθμισης , για τον πρόσθετο λόγο ότι επιτεύχθηκε ευρεία συναίνεση στους κόλπους της επιτροπής , και θα ψηφίσει υπέρ του Πρωτοδικείου .
Και ευελπιστούμε πως το Συμβούλιο θα εγκρίνει επίσης , με τη σειρά του , τις προτάσεις .
Τελειώνοντας , θέλω να εκφράσω την ευχή πως το Πρωτοδικείο θα αξιοποιήσει με τον βέλτιστο τρόπο τις νέες εξουσίες , τις νέες αρμοδιότητες που αποφάσισε να του προσφέρει , την κατάλληλη στιγμή , αυτό το Κοινοβούλιο .
...
Σε αντίθετη περίπτωση , όλοι εμείς οι εκλεγμένοι εκπρόσωποι θα αντιμετωπίζουμε όλο και περισσότερο την κατακραυγή των πολιτών μας των οποίων οι υποθέσεις δεν εκδικάζονται γρήγορα και αποτελεσματικά . Κύριε Πρόεδρε , κυρίες και κύριοι , συνάδελφοι , και εγώ ευχαριστώ τον εισηγητή για αυτήν την εξαίρετη έκθεση .
...
Θεωρώ ότι η Ευρωπαϊκή Υπηρεσία για την Καταπολέμηση της Aπάτης ( OLAF ) χρειάζεται έλεγχο στη βάση των αρχών του κράτους δικαίου .
...
Στα πλαίσια αυτά θα ήθελα να σημειώσω τα ακόλουθα : Όπως γνωρίζει το Κοινοβούλιο , η Επιτροπή είναι βέβαιη ότι , χωρίς ριζική μεταρρύθμιση , οι κοινοτικές δικαστικές αρχές κινδυνεύουν σε λίγο να μην μπορούν πλέον να εκπληρώνουν τα καθήκοντά τους εμπρόθεσμα .
...
Το Κοσσυφοπέδιο έχει υποφέρει πάρα πολύ εξαιτίας των αναβολών πληρωμής . Κύριε Πρόεδρε , μιλώντας σήμερα για το Κοσσυφοπέδιο , πράγμα που έχουμε κάνει πολύ συχνά , θα πρέπει να προβούμε και σε απολογισμό σχετικά με αυτά που έχουν γίνει ήδη στο Κοσσυφοπέδιο ή ακόμα και να αναρωτηθούμε κατά πόσο έχει γίνει κάτι στο Κοσσυφοπέδιο .
...
Ο πληθυσμός υποχρεώνεται τώρα να καταβάλει φόρους , μια και δεν είναι μακροπρόθεσμα δυνατόν να εξαρτώνται όλοι μόνο από το πουγκί της Ευρωπαϊκής Ένωσης και άλλων χορηγών .
Ένα μέρος θα πρέπει στον τομέα αυτό να προέρχεται και από τις δικές τους τις δυνατότητες .
...
Αυτό μπορεί να γίνει μια δυο φορές , αλλά θεωρώ ότι οι χορηγοί από τα Ηνωμένα Έθνη θα πρέπει να συνεισφέρουν και αυτοί .
Εν προκειμένω υπάρχει ένα τεράστιο κενό που είναι ακάλυπτο και το οποίο είναι αδύνατον να καλύψουμε εμείς .
...
Χρειαζόμαστε ανεξάρτητη δικαιοσύνη - που θα είναι ασφαλώς πολύ δύσκολο να συσταθεί - χρειαζόμαστε και μέσα για τον ύπατο αρμοστή για τα ανθρώπινα δικαιώματα Όλα αυτά πρέπει να γίνουν και μάλιστα γρήγορα .
...
Για παράδειγμα , στις τροπολογίες 3 και 5 .
Εν τούτοις , σύμφωνα με την αντίληψή μας , σε αμφότερες θα έπρεπε να αφήνουμε μεγαλύτερα περιθώρια ελιγμών στη διοίκηση των Ηνωμένων Εθνών που επί τόπου γνωρίζει καλύτερα από εμάς την πραγματικότητα .
...
Αυτός είναι ο λόγος για τον οποίο εμείς θα ζητούσαμε , και δώσαμε ένα σημείωμα στον κ. Brok σε αυτή την λογική , η τροπολογία αριθ .
1 , που αποδέχεται το πνεύμα , να συνταχθεί με άλλη διατύπωση που να μην θέτει υπό αιρεσιμότητα τη συνεισφορά των κοινοτικών πόρων .
Το ίδιο θα έλεγα για την τροπολογία αριθ .
2 , που επίσης θεωρούμε ότι θα ήταν αποδεκτή με μια ελαφρά τροποποίηση , μια και , ως προς την ουσία , η ιδέα μας φαίνεται ορθή .
Η τροπολογία αριθ .
4 είναι λίγο του ιδίου πνεύματος .
...
Ναι ή όχι , επιβεβαιώνετε τη συμφωνία στην οποία προέβησαν οι υπηρεσίες σας στην Επιτροπή Προϋπολογισμών ή χαλαρώνετε αυτές τις προϋποθέσεις , κάτι που θα σήμαινε διακοπή της δέσμευσής σας απέναντι μας ; Όχι , κύριε Bourlanges , νομίζω ότι πρόκειται για ένα ζήτημα ουσίας .
Το πρόβλημα έγκειται στο πώς θα ενορχηστρώσουμε τον συμβιβασμό που αποδεχθήκαμε .
Αυτό που σας πρότεινα και που εξακολουθώ να σας λέω είναι ότι η Επιτροπή θα κάνει μια δήλωση , στην απόφαση του Συμβουλίου η οποία θα είναι η εξής : Το ακριβές ποσό και χρονοδιάγραμμα της καταβολής της δεύτερης δόσης θα αποφασισθεί εν ευθέτω χρόνω , λαμβάνοντας υπόψη τις εξελίξεις όσον αφορά τις ανάγκες εξωτερικής χρηματοδότησης του Κοσσυφοπεδίου και τις διμερείς εισφορές από άλλους χορηγούς .
...
ALTENER Η ημερήσια διάταξη προβλέπει τη συζήτηση της έκθεσης ( Α5-0011 / 2000 ) του κ. Langen , σχετικά με το εγκριθέν από την επιτροπή συνδιαλλαγής κοινό σχέδιο απόφασης του Ευρωπαϊκού Κοινοβουλίου και του Συμβουλίου για την θέσπιση πολυετούς προγράμματος για την προώθηση των ανανεώσιμων πηγών ενέργειας στην Κοινότητα - ALTENER ( C5-0333 / 1999 - 1997 / 0370 ( COD ) ) Αξιότιμε κύριε Πρόεδρε , ευχαριστώ τον κ. Langen , μολονότι δεν βρίσκεται ο ίδιος εδώ , για τις προσπάθειες που κατέβαλε ώστε να εγκριθεί το πρόγραμμα τόσο από το Κοινοβούλιο όσο και από το Συμβούλιο .
...
Σε αυτόν τον τομέα λοιπόν χρειαζόμαστε ενέργεια που να διαφυλάσσει το κλίμα , χρειαζόμαστε πυρηνική ενέργεια . - ( DE ) Κύριε Πρόεδρε , παρακαλώ να με συγχωρήσετε που έρχομαι λίγο καθυστερημένος , αλλά η εδώ συζήτηση εξελίχθηκε με ταχύτερους ρυθμούς από τους προβλεπόμενους και ευχαριστώ τη συνάδελφο που με αντικατέστησε .
Είπε ήδη μερικά πράγματα για τα προγράμματα ALTENER και SAVE .
Έχουμε λοιπόν να κάνουμε με την ολοκλήρωση μιας διαδικασίας συνδιαλλαγής σχετικά με τη λήψη μέτρων στον τομέα της ενέργειας για την περίοδο 1998-2002 .
Το πρόγραμμα ALTENER αφορά εν προκειμένω τον σημαντικό τομέα των ανανεώσιμων πηγών ενέργειας .
Στόχος του προγράμματος είναι η δημιουργία των αναγκαίων προϋποθέσεων για την υλοποίηση ενός προγράμματος δράσης στον τομέα αυτό , καθώς και η παροχή επιπλέον κινήτρων ειδικά για ιδιωτικές και δημόσιες επενδύσεις στην παραγωγή και χρήση ενέργειας που προέρχεται από ανανεώσιμες πηγές .
Δεδομένου ότι το ισχύον πρόγραμμα έληξε στα τέλη του περασμένου έτους και ότι το Συμβούλιο δεν αποδέχθηκε τις τροπολογίες που είχαν ψηφισθεί στο Κοινοβούλιο , έπρεπε να συγκληθεί η επιτροπή συνδιαλλαγής .
Μας προξενεί κατάπληξη πόσο πεισματικά επιχείρησαν τα κράτη μέλη να προβάλουν αντίσταση στο Συμβούλιο ενάντια σε αυτό το πρόγραμμα για τις ανανεώσιμες πηγές ενέργειας και ενάντια στην αρμόζουσα χρηματοδότηση .
Πρέπει ωστόσο να προσθέσω ότι η φινλανδική Προεδρία δεν μπορούσε να κάνει τίποτα , όσο τα κράτη μέλη παρεμπόδιζαν την απαιτούμενη αύξηση των εν λόγω κονδυλίων .
Η αρχική δημοσιονομική πρόβλεψη ανερχόταν σύμφωνα με την πρόταση της Επιτροπής στα 81,1 εκατ. ευρώ και το Συμβούλιο την μείωσε μονόπλευρα και δίχως καμία αιτιολόγηση στα 74 εκατομμύρια .
...
Στο πλαίσιο της διαδικασίας συνδιαλλαγής κατέστη δυνατή η επίτευξη συμφωνίας σε ουσιαστικά σημεία των απαιτήσεών μας , όπως λ.χ. να εξεταστεί επ ' ευκαιρία της επόμενης αναθεώρησης του προγράμματος το ζήτημα να ανοίξει το πρόγραμμα Altener για τις συνδεδεμένες μεσογειακές χώρες .
Όπως μας διαβεβαίωσαν , το Συμβούλιο θα δημοσιεύσει μια δήλωση στην Επίσημη Εφημερίδα των Ευρωπαϊκών Κοινοτήτων .
...
Αυτό που επιθυμούσε η αντιπροσωπεία του Κοινοβουλίου στην επιτροπή συνδιαλλαγής ήταν η συνέχιση ενός λογικού ως προς το περιεχόμενο προγράμματος .
Για τον λόγο αυτό συμφωνήσαμε στο τέλος σε μια συμβιβαστική λύση , μολονότι δεν μας ικανοποιούσε πλήρως .
Συμφωνήσαμε να αυξηθεί το δημοσιονομικό κονδύλιο σε 77 εκατ. ευρώ .
Το αποτέλεσμα αυτό έγινε αποδεκτό παρότι δεν ήταν πλήρως ικανοποιητικό .
Αποφασίσαμε να συμφωνήσουμε σε αυτόν τον συμβιβασμό για να μην θέσουμε σε κίνδυνο τη συνέχιση του προγράμματος .
Δίχως να ενταθούν οι προσπάθειες εκ μέρους των κρατών μελών θα είναι ωστόσο αδύνατη η επίτευξη του στόχου , να ανέλθει μέχρι το 2010 στο 15 % το μερίδιο των ανανεώσιμων πηγών ενέργειας στην κάλυψη της ζήτησης πρωτογενούς ενέργειας .
Έχει διασφαλισθεί πλέον η συνέχιση αυτού του ευρωπαϊκού προγράμματος που είναι τόσο σημαντικό για την περιβαλλοντική και οικονομική πολιτική και το οποίο συμβάλλει στον περιορισμό των εκπομπών διοξειδίου του άνθρακα , στην αύξηση του μεριδίου των ανανεώσιμων πηγών ενέργειας στον υπολογισμό των ενεργειακών αναγκών , στη μείωση της εξάρτησης από τις εισαγωγές ενέργειας , στην εξασφάλιση του ενεργειακού εφοδιασμού , καθώς και στην οικονομική και κοινωνική συνοχή της τοπικής και περιφερειακής ανάπτυξης .
Τούτο όμως δεν επαρκεί , πρέπει να γίνουν επιπλέον τεράστιες προσπάθειες από την πλευρά των κρατών μελών .
Η επιτροπή συνδιαλλαγής ενέκρινε στις 9 Δεκεμβρίου του παρελθόντος έτους το τελικό κείμενο του προγράμματος και με τον τρόπο αυτό άνοιξε τον δρόμο ώστε να προωθούνται και στο μέλλον μελέτες και δράσεις στον τομέα των ανανεώσιμων πηγών ενέργειας για την εκμετάλλευση του αντίστοιχου δυναμικού .
Πέραν τούτου , διασφαλίζεται ότι με τη συνέχιση του προγράμματος θα προωθηθούν και θα υλοποιηθούν πειραματικές δράσεις για τη δημιουργία και επέκταση των υποδομών , για τη μεταφορά γνώσεων , καθώς και στοχοθετημένες δράσεις για τη διευκόλυνση της διείσδυσης των ανανεώσιμων πηγών ενέργειας στην αγορά .
Τούτο είναι δυνατόν ειδικά στους τομείς της γεωθερμικής και της αιολικής ενέργειας , σε μικρότερα υδροηλεκτρικά εργοστάσια , στην παθητική και ενεργητική εκμετάλλευση της ηλιακής ενέργειας σε κτίρια και στην εκμετάλλευση της βιομάζας .
Σε αυτούς τους τομείς μπορούμε να δούμε πόσο αναγκαίο και σημαντικό είναι να εξακολουθήσουμε να παρέχουμε ένα λογικό χρηματοδοτικό πλαίσιο στον τομέα των φορέων εναλλακτικής ενέργειας σε ευρωπαϊκό επίπεδο .
Θέλω να ευχαριστήσω ιδιαίτερα την Επιτροπή και την υπεύθυνη Επίτροπο κυρία De Palacio για την υποστήριξη της θέσης του Κοινοβουλίου .
Το Ευρωπαϊκό Κοινοβούλιο κατόρθωσε να βρει έναν εύλογο συμβιβασμό και να τροποποιήσει την κοινή θέση του Συμβουλίου .
Θα ευγνωμονούσα τους συναδέλφους αν υπερψήφιζαν το πόρισμα της επιτροπής συνδιαλλαγής . Κύριε Πρόεδρε , εξ ονόματος της Ομάδας του Κόμματος των Ευρωπαίων Σοσιαλιστών χαιρετίζω το γεγονός ότι καταλήξαμε σε αποτέλεσμα κατά τη διαδικασία συνδιαλλαγής για το πρόγραμμα ALTENER II .
...
Εδώ ανήκει μεταξύ άλλων η εμβάθυνση της ανταλλαγής πληροφοριών και εμπειριών όσων ενεργοποιούνται στον τομέα των βιώσιμων πηγών ενέργειας , η επέκταση τοπικών και περιφερειακών γραφείων ενέργειας , η δημιουργία νέων γραφείων και η ενίσχυση των υπαρχόντων δικτύων .
...
SAVE Η ημερήσια διάταξη προβλέπει την συζήτηση της έκθεσης ( Α5-0010 / 2000 ) της κυρίας Ahern , εξ ονόματος της Αντιπροσωπείας του Ευρωπαϊκού Κοινοβουλίου στην Επιτροπή Συνδιαλλαγής σχετικά με το εγκριθέν από την Επιτροπή Συνδιαλλαγής κοινό σχέδιο απόφασης του Ευρωπαϊκού Κοινοβουλίου και του Συμβουλίου περί θέσπισης πολυετούς προγράμματος-πλαισίου για δράσεις στον τομέα της ενέργειας - SAVE ( C5-0334 / 1999 - 1997 / 0371 ( COD ) ) Κυρία Πρόεδρε , θα ήθελα να ευχαριστήσω το Συμβούλιο και την Επιτροπή για την πραγματοποίηση μιας επωφελούς και ενδελεχούς διαδικασίας συνδιαλλαγής , και μάλιστα μιας συνδιαλλαγής ήρεμης από κάθε άποψη , κάτι που δεν συμβαίνει πάντα .
...
Πολιτισμός 2000 Η ημερήσια διάταξη προβλέπει τη συζήτηση της έκθεσης ( Α5-0009 / 2000 ) του κ. Graηa Moura , εξ ονόματος της Αντιπροσωπείας του Ευρωπαϊκού Κοινοβουλίου στην Επιτροπή Συνδιαλλαγής , σχετικά με το εγκριθέν από την Επιτροπή Συνδιαλλαγής κοινό σχέδιο απόφασης του Ευρωπαϊκού Κοινοβουλίου και του Συμβουλίου για τη θέσπιση ενός ενιαίου μέσου χρηματοδότησης και προγραμματισμού για την πολιτιστική συνεργασία ( Πρόγραμμα " Πολιτισμός 2000 " ) ( C5 ­ 0327 / 1999 - 1998 / 0169 ( COD ) ) Κυρία Πρόεδρε , σε αντίθεση με τις διατάξεις του άρθρου 151 της Συνθήκης του Αμστερνταμ , ο πολιτισμός ανέκαθεν αντιμετωπίστηκε σαν τον φτωχό συγγενή στο πλαίσιο του περιορισμένης εμβέλειας μηχανισμού προγραμμάτων και χρηματοδοτικών , τεχνικών και ανθρώπινων μέσων που έχουν επιστρατευθεί για την προώθηση του ευρωπαϊκού σχεδίου .
Θα μπορούσε κανείς να ισχυρισθεί ότι οι στόχοι που χαράχθηκαν πριν από 50 χρόνια , όταν τέθηκαν τα θεμέλια του " ευρωπαϊκού οίκου " που διαθέτουμε σήμερα , είχαν περισσότερο οικονομικό και κοινωνικό χαρακτήρα .
Θα μπορούσαμε ακόμη να πούμε ότι , κατά τη διάρκεια των πέντε αυτών δεκαετιών , οι ευρωπαϊκές πολιτικές υπέστησαν πολλαπλά και , αρκετά συχνά , απατηλά σκαμπανεβάσματα , στο έλεος διαφόρων και πολλών συγκυριών και για μια σειρά διαφορετικούς λόγους .
Αλλά στο πνεύμα των χωρών που ίδρυσαν την Ευρώπη δεν μπορούσε παρά να είναι διαρκώς και συνεχώς παρούσα η αντίληψη ενός προτύπου πολιτισμού που τις έκανε να επιθυμούν να διαμορφώσουν τους όρους για μια μόνιμη ειρήνη .
Το συγκεκριμένο πρότυπο πολιτισμού χαρακτηρίζεται από μεγάλη πολιτιστική πολυμορφία .
Μια Ευρώπη , η οποία θεμελιώνεται στη διατράνωση της εθνικής ταυτότητας του κάθε κράτους , είναι σε θέση να ζήσει για πολύ καιρό μέσα σε συνθήκες ειρήνης και ευημερίας , υπό τον όρο ότι θα φροντίσουμε να διατηρήσουμε ζωντανή την προαναφερθείσα πολιτιστική πολυμορφία , εξαλείφοντας τις μικρόψυχες και επιθετικές εκδηλώσεις πικρίας και καχυποψίας που κατά κανόνα οδηγούν στην έξαρση των εθνικισμών .
Για την αποτροπή αυτής της εξέλιξης , θα πρέπει απαραιτήτως να ενθαρρυνθεί η αλληλογνωριμία και η αμοιβαία απόλαυση των αξιών του ανθρωπισμού και της ανεκτικότητας , της γνώσης , της καλλιτεχνικής και κάθε άλλης πολιτιστικής δημιουργίας , των αξιών αυτών που είναι ριζωμένες στο γόνιμο ευρωπαϊκό έδαφος και που εκφράζουν ό , τι πιο ευγενικό και βαθυστόχαστο έχει επινοήσει το ανθρώπινο πνεύμα .
Κατά συνέπεια , για να ανοίξει διάπλατα ο δρόμος προς την αλληλογνωριμία και την αμοιβαία απόλαυση των αξιών που προανέφερα , είναι αναγκαίο οι αξίες αυτές να θεμελιώνονται σε μια αντίληψη περί πολιτισμού που θα περιλαμβάνει την ουσιαστική διάσταση της ευρωπαϊκής δημοκρατίας .
Είναι αδιαμφισβήτητο ότι η πραγματική σύγκλιση , η οικονομική και κοινωνική συνοχή , το ενιαίο νόμισμα , η πάλη κατά της ανεργίας και του κοινωνικού αποκλεισμού , όπως επίσης και η ενθάρρυνση του ανταγωνισμού , συμβάλλουν στη διαμόρφωση μιας σειράς προϋποθέσεων , ώστε να επιτύχουμε να προσφέρουμε στους ευρωπαίους πολίτες μεγαλύτερη ισότητα , περαιτέρω ανάπτυξη , μια καλύτερη ποιότητα ζωής και περισσότερες ευκαιρίες .
Είναι αναμφίβολο ότι η κοινή αμυντική πολιτική και πολιτική ασφαλείας θα επιτρέψει την ενδυνάμωση της ταυτότητας και την κατοχύρωση του κύρους της Ευρώπης στον κόσμο .
Δεν υπάρχει αμφιβολία πως η πολιτική υπέρ της προάσπισης των ανθρωπίνων δικαιωμάτων αποβλέπει στην οικουμενική προβολή .
Αλλά σε περίπτωση που οι πολιτικές του πολιτιστικού τομέα δεν καταφέρουν να προσδώσουν μεγαλύτερο νόημα και ξεκάθαρη υπόσταση σε όλες τις προαναφερθείσες πολιτικές , τότε ούτε η Ευρώπη ούτε η ευρωπαϊκή δημοκρατία θα μπορέσουν να φθάσουν πολύ μακριά .
Μέσω του πολιτισμού , και μόνο μέσω του πολιτισμού , εκατομμύρια και εκατομμύρια πολίτες θα μπορούν να αισθάνονται Ευρωπαίοι και να καλλιεργήσουν , να αναπτύξουν και να εμβαθύνουν το αίσθημα ότι ανήκουν στην Ευρώπη .
Όμως , κυρία Πρόεδρε , αυτή ακριβώς η ώθηση είναι που έχει λείψει από την ευρωπαϊκή πολιτική .
Γίνεται λόγος για πολιτισμό , για πολιτιστική συνεργασία , για πειραματικές δράσεις , για μεγάλες πρωτοβουλίες , για δίκτυα πολιτιστικών παραγόντων και φορέων , αλλά αποφεύγεται επιμελώς η οποιαδήποτε αναφορά σε κάποια πολιτιστική πολιτική που θα εφαρμόζουν τα ευρωπαϊκά θεσμικά όργανα , μια πολιτική άλλωστε η οποία διόλου δεν θα προσέκρουε στην αρχή της επικουρικότητας .
Πολύ συχνά μάλιστα , εκφράζονται και ορισμένες κάπως βαρύγδουπες δημαγωγικές απόψεις σχετικά με τη σημασία του πολιτισμού για το ευρωπαϊκό σχέδιο , ωστόσο διατίθενται γελοίες πιστώσεις για προγράμματα τα οποία θα απέβαιναν , σε διαρκή βάση και τακτικά , προς όφελος άνω των 300 εκατομμυρίων ανθρώπων , διευκολύνοντας την πρόσβασή τους σε μια κληρονομιά που τους ανήκει και εμπνέοντάς τους μια ενεργητική και αμφίδρομη όρεξη για επαφή με τις κεντρικές αξίες και τα σημαντικά δημιουργήματα που διαπνέονται από αυτές .
Οι Ευρωπαίοι πολίτες , τους οποίους εκπροσωπούμε εδώ μέσα , έχουν κάθε δικαίωμα να απαιτήσουν από τα θεσμικά όργανα της Ένωσης να τηρήσουν μια περισσότερο συνεπή , πιο αποτελεσματική και , πάνω απ ' όλα , περισσότερο φιλοευρωπαϊκή στάση .
Οι παραπάνω σκέψεις ήταν μια εισαγωγή για να σας μιλήσω για την αξιολόγηση , από πλευράς αυτού του Κοινοβουλίου , του κοινού σχεδίου αναφορικά με το πρόγραμμα " Πολιτισμός 2000 " , το οποίο εγκρίθηκε από την επιτροπή συνδιαλλαγής στις 9 Δεκεμβρίου .
Σας υπενθυμίζω ότι στόχος του " Πολιτισμός 2000 " είναι η θέσπιση ενός ενιαίου μέσου χρηματοδότησης και προγραμματισμού για την πολιτιστική συνεργασία .
Η διαδικασία συνδιαλλαγής οδήγησε σε ικανοποιητικές λύσεις αναφορικά με όλες σχεδόν τις τροπολογίες που εγκρίθηκαν κατά τη δεύτερη ανάγνωση , και θα μπορούσαμε να πούμε ότι πετύχαμε να περάσουμε , σε εύλογο βαθμό , τις ουσιαστικές θέσεις αυτού του Κοινοβουλίου , και συγκεκριμένα το ζήτημα πολιτικής προτεραιότητας που συνίσταται στη διαμόρφωση των προϋποθέσεων , ώστε οι δράσεις που συμπεριλαμβάνονται στο " Πολιτισμός 2000 " να μπορέσουν να αγγίξουν όσο το δυνατόν μεγαλύτερο αριθμό πολιτών .
Όσον αφορά τώρα τις δημοσιονομικές πτυχές , η αντιπροσωπεία του Κοινοβουλίου βρέθηκε αντιμέτωπη με την αδιάλλακτη στάση του Συμβουλίου στο θέμα της αύξησης του δημοσιονομικού πλαισίου των 167 εκατομμυρίων ευρώ , το οποίο προβλεπόταν αρχικώς .
Παρά ταύτα , καταλήξαμε σε μία διευθέτηση που μετρίαζε κάπως αυτή τη θέση του Συμβουλίου , μία διευθέτηση , άλλωστε , που κατέστη εφικτή αποκλειστικά χάρη στις προσωπικές προσπάθειες της Επιτρόπου κυρίας Reding προς την κατεύθυνση της εξεύρεσης μιας εποικοδομητικής λύσης .
Η Επιτροπή ανέλαβε δια της εκπροσώπου της τη δέσμευση να υποβάλει έως τις 30 Ιουνίου του 2002 μία έκθεση επί της λειτουργίας του προγράμματος , όπου θα εκφέρει άποψη σχετικά με την επάρκεια ή την ανεπάρκεια των διαθέσιμων χρηματοδοτικών πόρων , προτείνοντας ενδεχομένως την αναθεώρηση αυτού του σημείου .
Αφού επισημάνω το γεγονός ότι η επιτυχής έκβαση της παραπάνω πρότασης θα εξαρτηθεί , σε τελευταία ανάλυση , από το εάν θα βρεθεί στο μεταξύ ένας θεσμικός μηχανισμός που να ανταποκρίνεται στοιχειωδώς στην έννοια της λέξης " συνδιαλλαγή " , θα ολοκληρώσω προτείνοντας σε αυτή την Ολομέλεια να υπερψηφίσει το κοινό σχέδιο αναφορικά με το πρόγραμμα " Πολιτισμός 2000 " που εγκρίθηκε από την επιτροπή συνδιαλλαγής , και εκφράζοντας ευχές για την επιτυχία του προγράμματος . Κυρία Πρόεδρε , βασικά πίστευα ότι δεν έχουμε τίποτα άλλο να πούμε , μια και τα είχαμε πει όλα στην τελευταία συζήτηση .
...
Συγχαρητήρια !
Τέλος , θα ήθελα να συγχαρώ την Επίτροπο κυρία Reding , τον Αντιπρόεδρο κ. Imbeni και τον κ. Gargani , πρόεδρο της Επιτροπής Πολιτισμού , για τη σταθερή και συνετή στάση που , ο καθένας βάσει του ρόλου του , τήρησαν σε όλη τη διάρκεια της συνδιαλλαγής . -ten Holte ( ELDR ) .
( NL ) Κυρία Πρόεδρε , κυρία Επίτροπε , κύριε εισηγητά , θα ήθελα να αρχίσω συγχαίροντας τον κ. Graηa Moura για την τεράστια συμβολή που είχε στην εξέταση του προγράμματος " Πολιτισμός 2000 " .
...
Βεβαίως , θα μπορούσε πάντα να είναι καλύτερο και εγώ προσωπικά θα συνεχίσω να ζητώ να διατεθούν περισσότερα κονδύλια και μάλιστα πιο γρήγορα .
Νομίζω όμως ότι αυτό το πρόγραμμα προσφέρει πολλές δυνατότητες σε πολλά άλλα προγράμματα .
...
Όχι πια μεγάλα προγράμματα , αλλά περιθώρια για πολιτιστικά δίκτυα , ιδιαίτερη προσοχή για την προαγωγή της ανάγνωσης , μετάφραση , οίκοι μετάφρασης , θέματα που οπωσδήποτε ενδιαφέρουν τις περιοχές των λιγότερο διαδεδομένων γλωσσών .
...
Για αυτό είναι πολύ σημαντικό για την Διακυβερνητική να παρθούν σημαντικές αποφάσεις και να γίνουν τομές , ώστε να απελευθερωθεί απα αυτήν την δέσμευση της καθεμίας κυβέρνησης η προσπάθεια του Ευρωπαϊκού Κοινοβουλίου να δοθεί σημαντική πολιτιστική ώθηση στον ευρωπαϊκό χώρο . Bortone ( UEN ) .
( IT ) Κυρία Πρόεδρε , συμμερίζομαι πλήρως τις αξιολογήσεις που έγιναν από τον εισηγητή και ευχαριστώ επίσης τον πρόεδρο της Επιτροπής Πολιτισμού , κ. Gargani , για το αξιέπαινο έργο που επιτέλεσε σε μια ουσιαστικά δύσκολη διαδικασία μεσολάβησης .
...
Δίπλα στη συζήτηση που είχαμε ενωρίτερα κατά τη διάρκεια της ημέρας ο πολιτισμός μπορεί να μη φαίνεται τόσο σημαντικός .
Εντούτοις , είναι .
...
Πολλοί στην πατρίδα μου λένε πως βλέπουν τον βρετανικό πολιτισμό να απειλείται π.χ. από την Πορτογαλία , από τη Γερμανία , από τη Φινλανδία .
Για όνομα του Θεού !
...
Κάνουμε πράγματι αρκετά ; Και θα ήθελα να πω σε εσάς , κυρία Reding , ότι σας ευχαριστώ για την υποστήριξη και τη βοήθεια που προσφέρατε μέχρι σήμερα .
...
Ελπίζω ότι αυτή η διάσκεψη θα παρακινήσει επίσης την Επιτροπή να λάβει ενεργά υπόψη της τις βιβλιοθήκες στο πέμπτο πρόγραμμα πλαίσιο της Κοινωνίας των Πληροφοριών . Κυρία Πρόεδρε , κυρία Επίτροπε , κύριε εισηγητή , κυρίες και κύριοι , κατά κάποιο τρόπο εδώ κλείνει ο κύκλος της σημερινής ημερήσιας διάταξης .
...
Πρόκειται για αντίφαση , όταν από τη μια πλευρά θέλουμε να ενισχύσουμε και όχι να αποδυναμώσουμε περαιτέρω τις αρχές της πολιτικής για τον πολιτισμό που στοχεύουν στη δημιουργία μιας ευρωπαϊκής συνείδησης , αλλά από την άλλη μιλάμε για αρχή της ομοφωνίας , διαδικασία συναπόφασης και επιτροπή συνδιαλλαγής . Κυρία Πρόεδρε , κυρίες και κύριοι , όπως ακούσαμε , έχουμε όλες οι πολιτικές ομάδες μαζί έναν κοινό πολιτικό εχθρό , το Συμβούλιο .
...
Τι σημαίνει και τι μας προσφέρει η Ευρώπη πέρα και πάνω από τις παραμέτρους των εθνικών μας συνόρων ; Η Ευρώπη είναι οι λαοί της , η ιστορία της και σήμερα ο συλλογικός της χαρακτήρας .
Ο λόγος όμως που το πρόγραμμα " Πολιτισμός 2000 " έχει για μας τόσο μεγάλη σημασία είναι ο εξής : στοιχηματίζω πως στην ερώτηση " τι είναι η Ευρώπη " απαντάμε " είναι η τέχνη μας , η λογοτεχνία μας και η κληρονομιά μας . " .
...
Όλα αυτά πρέπει να μας οδηγήσουν στην ενίσχυση της δράσης μας υπέρ της αξιοποίησης ενός κοινού πολιτιστικού χώρου , εντός του οποίου θα μπορέσουν να ανθίσουν περαιτέρω οι πολιτισμοί μας με όλες τις ιδιαιτερότητες και τις διαφορές τους .
Όμως , επιπλέον θα μπορούν να εμπλουτίζονται αμοιβαία , και οι άλλοι ευρωπαίοι πολίτες θα μπορούν να συμμετέχουν πλήρως .
