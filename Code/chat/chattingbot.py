import logging
from chat.storage import StorageAdapter
from chat.logic import LogicAdapter
from chat.search import IndexedTextSearch
...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        storage_adapter = kwargs.get('storage_adapter', 'chat.storage.SQLStorageAdapter')

        logic_adapters = kwargs.get('logic_adapters', [
            'chat.logic.BestMatch'
        ])
        ...
        preprocessors = kwargs.get(
            'preprocessors', [
                'chat.preprocessors.clean_whitespace'
            ]
        )
    ...
    def get_latest_response(self, conversation):
        ...
        """
        from chat.conversation import Statement as StatementObject
