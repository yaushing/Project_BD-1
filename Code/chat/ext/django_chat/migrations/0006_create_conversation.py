...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('django_chat', '0005_statement_created_at'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='statements',
            field=models.ManyToManyField(help_text='The statements in this conversation.', related_name='conversation', to='django_chat.Statement'),
        ),
    ]
