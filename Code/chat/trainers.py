...
from chat.conversation import Statement
from chat.tagging import PosHypernymTagger
...
class Trainer(object):
    ...
    :param boolean show_training_progress: Show progress indicators for the
           trainer. The environment variable ``chat_SHOW_TRAINING_PROGRESS``
    ...
    def __init__(self, chatbot, **kwargs):
        ...
        environment_default = os.getenv('chat_SHOW_TRAINING_PROGRESS', True)
    ...
    class TrainerInitializationException(Exception):
        ...
        def __init__(self, message=None):
            default = (
                ...
                'See http://chat.readthedocs.io/en/stable/training.html'
            )
...
class chatCorpusTrainer(Trainer):
    """
    ...
    def train(self, *corpus_paths):
        from chat.corpus import load_corpus, list_corpus_files
