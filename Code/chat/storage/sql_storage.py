...
class SQLStorageAdapter(StorageAdapter):
    """
    The SQLStorageAdapter allows chat to store conversation
    ...
    def get_statement_model(self):
        ...
        """
        from chat.ext.sqlalchemy_app.models import Statement
        return Statement
    ...
    def get_tag_model(self):
        ...
        """
        from chat.ext.sqlalchemy_app.models import Tag
        return Tag
    ...
    def create_database(self):
        ...
        """
        from chat.ext.sqlalchemy_app.models import Base
