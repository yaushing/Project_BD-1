...
Επαvάληψη της συvσδoυ Κηρύσσω την επανάληψη της συνόδου του Ευρωπαϊκού Κοινοβουλίου που είχε διακοπεί την Πέμπτη 3 Φεβρουαρίου του 2000 .
 
Έγκριση των συνοπτικών πρακτικών της προηγούμενης συνεδρίασης Τα συνοπτικά πρακτικά της συνεδρίασης της Πέμπτης 3 του περασμένου Φεβρουαρίου έχουν διανεμηθεί .
Υπάρχουν παρατηρήσεις ; Από την αντίδρασή σας συμπεραίνω ότι πολλοί βουλευτές δεν έλαβαν αυτά τα συνοπτικά πρακτικά και είναι βεβαίως προφανές ότι δεν μπορείτε να εγκρίνετε συνοπτικά πρακτικά που δεν είχατε λάβει προηγουμένως .
...
Κυρία Πρόεδρε , σχετικά με ένα θέμα διαδικασίας .
Καθώς σήμερα είναι η πρώτη φορά που γιορτάζουμε την ημέρα του Αγίου Βαλεντίνου στη νέα χιλιετία , ελπίζω πως θα συμφωνήσετε μαζί μου ότι θα ήταν αρμόζον αυτό το Σώμα να τιμήσει τη σημερινή ημέρα , δηλώνοντας την αποφασιστική δέσμευσή του για την αντιμετώπιση των καρδιοπαθειών , του μεγαλύτερου φονιά στην Ευρωπαϊκή Ένωση .
Παροτρύνω τους βουλευτές να υπογράψουν τη δέσμευση την οποία ανέλαβε σήμερα το Συνέδριο για Καρδιές χωρίς Προβλήματα , ότι δηλαδή κάθε παιδί που θα γεννηθεί στη νέα χιλιετία έχει δικαίωμα να ζήσει μέχρι την ηλικία τουλάχιστον των 65 ετών χωρίς να υποφέρει από καρδιοαγγειακές νόσους που μπορούν να προληφθούν .
Χρόνια Πολλά για την ημέρα του Αγίου Βαλεντίνου !
( Χειροκροτήματα ) Kυρία Πρόεδρε , λαμβάνω τον λόγο βάσει του άρθρου 9 του Κανονισμού του Κοινοβουλίου και αναφέρομαι στο ίδιο σημείο που έθιξε ο κ. Davies , σχετικά με τις πολύ σοβαρές καταγγελίες που έγιναν στο ραδιόφωνο του BBC σήμερα το πρωί .
...
Διάταξη τωv εργασιώv Η ημερήσια διάταξη προβλέπει την εξέταση του οριστικού σχεδίου ημερήσιας διάταξης όπως αυτό ορίστηκε από τη Διάσκεψη των Προέδρων , σύμφωνα με το άρθρο 110 του Κανονισμού. α ) Συνεδριάσεις από 14 έως 18 Φεβρουαρίου 2000 στο Στρασβούργο .
Τετάρτη : Πρόεδρος .
...
Ποιος επιθυμεί να παρουσιάσει το αίτημα αυτό , εξ ονόματος των παραπάνω Ομάδων ; Εφόσον κανείς δεν θέλει να παρέμβει , θέτω αυτό το ζήτημα σε ψηφοφορία .
( Το Σώμα εκφράζει τη σύμφωνη γνώμη του ) Πέμπτη : Πρόεδρος .
...
Εξ ονόματος της Ομάδας των Φιλελευθέρων ποιος επιθυμεί να παρουσιάσει την αίτηση για το υποσημείο " Καμπότζη " ; Κυρία Πρόεδρε , η Ομάδα των Φιλελευθέρων θεωρεί ιδιαίτερα σημαντικό να συζητηθεί η κατάσταση στην Καμπότζη και μάλιστα τώρα αμέσως .
Όχι μόνο εξαιτίας της επιστολής που απηύθυνε ο Γενικός Γραμματέας των Ηνωμένων Εθνών , Kofi Annan , προς την κυβέρνηση της χώρας , προκειμένου να προβεί η τελευταία σε ενέργεια για τη σύσταση ενός ειδικού δικαστηρίου που θα δικάσει τους ηγέτες των Ερυθρών Χμερ , αλλά επίσης και διότι το καθεστώς του Hun Sen δεν αρκέστηκε προφανώς στις δολοφονικές απόπειρες κατά του ηγέτη της αντιπολίτευσης Sam Raninsy , αλλά σκοπεύει τώρα να άρει την κοινοβουλευτική του ασυλία , έτσι ώστε να μπορέσει να προσαχθεί στα δικαστήρια σα να ήταν απλός πολίτης .
Η διεθνής κοινότητα φέρει συγκεκριμένες ευθύνες για αυτά που συμβαίνουν στην Καμπότζη .
...
Μόνο το Ευρωπαϊκό Κοινοβούλιο προέβαλε κάποιες αντιδράσεις σε αυτές τις εκλογές .
Πιστεύω ότι θα πρέπει επομένως και εμείς να αναλάβουμε τις ευθύνες μας και να συζητήσουμε την κατάσταση στην Καμπότζη .
( Το Σώμα εκφράζει τη σύμφωνη γνώμη του ) Πρόεδρος .
Συνεπώς , το υποσημείο Καμπότζη προστίθεται στο σημείο " Δικαιώματα του Ανθρώπου " και το επόμενο αίτημα όσον αφορά το υποσημείο Πινοσέτ καταπίπτει .
Επιπλέον , έχω λάβει αιτήσεις προσθήκης νέων σημείων στη συζήτηση επί επικαίρων .
Επομένως , δεν πρόκειται πλέον για προσθήκη θεμάτων στον τίτλο " Δικαιώματα του Ανθρώπου " , αλλά για ένταξη νέων σημείων .
Υπάρχουν τρεις αιτήσεις : μια πρώτη αίτηση εκ μέρους της Ομάδας της Ενωτικής Αριστεράς που αποσκοπεί στην ένταξη ενός νέου σημείου με τίτλο " Αναστολή της θανατικής ποινής στις Ηνωμένες Πολιτείες και η περίπτωση της Betty Beets " · μια δεύτερη αίτηση της Ομάδας των Φιλελευθέρων που αποσκοπεί στην ένταξη ενός νέου σημείου με τίτλο " Υπόθεση Πινοσέτ " και μια τρίτη αίτηση της Ομάδας των Πρασίνων που αποσκοπεί στην ένταξη ενός νέου σημείου με τίτλο " Περιβαλλοντική καταστροφή των υδάτων του Δούναβη " .
Δεδομένου του χρόνου που διαθέτουμε εφόσον , όπως ξέρετε , έχουμε μια δήλωση της Επιτροπής επί της αναδιάρθρωσης των επιχειρήσεων και δεδομένου ότι ο παρών κατάλογος περιλαμβάνει δύο σημεία , μπορούμε να προσθέσουμε δύο επιπλέον σημεία .
Καταρχάς θα θέσω την αίτηση της Ομάδας της Ενωτικής Αριστεράς .
( Το Σώμα απορρίπτει την αίτηση ) Πρόεδρος .
Τώρα περνάμε στην αίτηση της Ομάδας των Φιλελευθέρων .
Υπάρχει κάποιος που θέλει να παρέμβει υπέρ ; Κυρία Πρόεδρε , είναι εντυπωσιακό το γεγονός ότι το Ευρωπαϊκό Κοινοβούλιο δεν έχει υιοθετήσει μέχρι τώρα στάση σχετικά με την ενδεχόμενη απελευθέρωση του Πινοσέτ , παρά τα διεθνή εντάλματα σύλληψης που έχουν εκδοθεί ήδη για αυτόν .
...
Υπάρχει κάποιος βουλευτής που να αιτιολογήσει αυτή την αίτηση ; Κυρία Πρόεδρε , αγαπητοί συνάδελφοι , αυτό που συνέβη σε έναν από τους παραποτάμους του Δούναβη θεωρείται από πολλούς ειδικούς ατύχημα εξίσου μεγάλης περιβαλλοντικής σημασίας με το ατύχημα του Τσερνόμπιλ .
Από το ατύχημα αυτό δεν πλήττεται μόνο η Ρουμανία αλλά και η Γιουγκοσλαβία , και ουσιαστικά πλήττεται ολόκληρη η λεκάνη του Δούναβη .
Εκτιμούμε ότι το ζήτημα είναι αρκούντως σημαντικό , ώστε η Επιτροπή να αντιδράσει άμεσα σε αυτή την κατάσταση και νομίζω ότι το Κοινοβούλιο πρέπει να πει τη γνώμη του και πρέπει να ψηφίσει ένα ψήφισμα επί αυτού του θέματος .
( Χειροκροτήματα ) ( Το Σώμα εκφράζει τη σύμφωνη γνώμη του ) Πρόεδρος .
Παραμένουμε στο ζήτημα της Πέμπτης , η Ομάδα του Ευρωπαϊκού Λαϊκού Κόμματος ζήτησε να προωθηθεί και να εγγραφεί ως τελευταίο σημείο την Τετάρτη η έκθεση της κ. Cederschiφld σχετικά με την ενίσχυση της ποινικής προστασίας από την παραχάραξη εν όψει της εισαγωγής του ευρώ .
Υπάρχει κάποιος συνάδελφος που επιθυμεί να μιλήσει εξ ονόματος της Ομάδας του Ευρωπαϊκού Λαϊκού Κόμματος για να αιτιολογήσει αυτήν την αίτηση ; Κυρία Πρόεδρε , θέλω να ζητήσω από την Ολομέλεια να στηρίξει αυτήν την πρόταση , διότι έγιναν πάρα πολλές τροποποιήσεις σε αυτήν την ημερησία διάταξη .
...
( Το Σώμα εκφράζει τη σύμφωνη γνώμη του ) Παρασκευή : Πρόεδρος .
...
Υπάρχει κάποιος συνάδελφος που επιθυμεί να παρέμβει εξ ονόματος της Ομάδας του Κόμματος των Ευρωπαίων Σοσιαλιστών για να αιτιολογήσει αυτήν την αίτηση ; Κυρία Πρόεδρε , ας με συγχωρέσει ο φίλος μου Enrique Barσn , αλλά θα ήθελα να μιλήσω κατά της πρότασης αυτής .
...
( Το Σώμα εκφράζει τη σύμφωνη γνώμη του ) Κυρία Πρόεδρε , η έκθεση Cederschiφld διεγράφη , ως γνωστόν , από την ημερήσια διάταξη της Πέμπτης , με αποτέλεσμα να έχουμε μάλλον λίγο περισσότερο χρόνο στη διάθεσή μας την Πέμπτη .
...
Έτσι είναι , είμαστε σύμφωνοι. β ) Συνεδριάσεις στις 1 και 2 Μαρτίου 2000 στις Βρυξέλλες
 
Αειφόρος αστική ανάπτυξη - Αγροτική ανάπτυξη - Πρωτοβουλία EQUAL Η ημερήσια διάταξη προβλέπει την κοινή συζήτηση των ακολούθων τεσσάρων εκθέσεων : έκθεση ( Α5-0026 / 2000 ) της κ. McCarthy , εξ ονόματος της Επιτροπής Περιφερειακής Πολιτικής , Μεταφορών και Τουρισμού , σχετικά με την ανακοίνωση της Επιτροπής [ COM ( 1999 ) 477 - C5-0242 / 1999 - 1999 / 2177 ( COS ) ] στα κράτη μέλη σχετικά με τη θέσπιση γενικών κατευθύνσεων για την ανάληψη κοινοτικής πρωτοβουλίας , που αφορά την οικονομική και κοινωνική αναζωογόνηση πόλεων και οικισμών σε κρίση , έτσι ώστε να προωθηθεί η αειφόρος αστική ανάπτυξη ( URBAN ) · έκθεση ( Α5-0028 / 2000 ) του κ. Decourriθre , εξ ονόματος της Επιτροπής Περιφερειακής Πολιτικής , Μεταφορών και Τουρισμού , σχετικά με την ανακοίνωση της Επιτροπής [ COM ( 1999 ) 479 - C5 0243 / 1999 - 1999 / 2178 ( COS ) ] στα κράτη μέλη σχετικά με τη θέσπιση γενικών κατευθύνσεων για μια κοινοτική πρωτοβουλία που αφορά τη διευρωπαϊκή συνεργασία με σκοπό την ενθάρρυνση της αρμονικής και ισόρροπης ανάπτυξης του ευρωπαϊκού εδάφους ( INTERREG ) · έκθεση ( Α5-0024 / 2000 ) του κ. Procacci , εξ ονόματος της Επιτροπής Γεωργίας και Ανάπτυξης της Υπαίθρου , σχετικά με το σχέδιο ανακοίνωσης της Επιτροπής [ COM ( 1999 ) 475 - C5-0259 / 1999 - 1999 / 2185 ( COS ) ] προς τα κράτη μέλη με την οποία καθορίζονται οι γενικές κατευθύνσεις για την κοινοτική πρωτοβουλία όσον αφορά την αγροτική ανάπτυξη ( LEADER + ) · έκθεση ( Α5-0034 / 2000 ) της κ. Stenzel , εξ ονόματος της Επιτροπής Απασχόλησης και Κοινωνικών Υποθέσεων , σχετικά με την ανακοίνωση της Επιτροπής [ COM ( 1999 ) 476 - C5-0260 / 1999 - 1999 / 2186 ( COS ) ] προς τα κράτη μέλη όσον αφορά τη θέσπιση των κατευθυντήριων γραμμών για τα Προγράμματα Κοινοτικών Πρωτοβουλιών ( ΠΚΠ ) για τα οποία τα κράτη μέλη καλούνται να υποβάλουν προτάσεις για ενίσχυση στο πλαίσιο της πρωτοβουλίας EQUAL Δεδομένου ότι η κ. McCarthy θα καθυστερήσει λίγο εξαιτίας της πτήσης της , προτείνω να ακούσουμε πρώτα τον κ. Decourriθre .
...
Το πρόγραμμα INTERREG ΙΙΙ συνεχίζει αυτή τη δράση .
Σήμερα , η Ευρωπαϊκή Επιτροπή μάς υπέβαλε τις γενικές κατευθύνσεις του προγράμματος αυτού , σύμφωνα με τις διατάξεις του κανονισμού 1260 / 1999 της Ευρωπαϊκής Κοινότητας περί γενικών διατάξεων για τα διαρθρωτικά ταμεία .
...
Βασίζεται κυρίως στον χάρτη των επιλέξιμων περιοχών της προηγούμενης προγραμματικής περιόδου .
Οι υπεραπόκεντρες περιφέρειες μπορούν να επωφεληθούν μιας στήριξης στο πλαίσιο του κεφαλαίου Β .
Η Επιτροπή καταρτίζει έναν κατάλογο τομέων προτεραιότητας και μη εξαντλητικών επιλέξιμων μέτρων για το κεφάλαιο Α , αλλά εξαντλητικών μέτρων για το κεφάλαιο Β .
Επιφυλάσσεται του δικαιώματος να προτείνει αργότερα θέματα που αυτή κρίνει σημαντικά για τις ανταλλαγές εμπειριών και για την ενισχυμένη συνεργασία μεταξύ περιφερειών , όσον αφορά το κεφάλαιο Γ .
...
Περιλαμβάνονταν σε αυτό 217 ομάδες τοπικής δράσης που χρηματοδοτήθηκαν με 1.155 εκατομμύρια ευρώ .
Το LEADER II , πρόγραμμα που κάλυπτε την περίοδο 1994-1999 - για το οποίο δεν υπάρχει , δυστυχώς , ακόμη ολοκληρωμένη αξιολόγηση - είχε μεγαλύτερη συμβολή από το LEADER I .
Οι δικαιούχοι πρέπει να υπερέβησαν τους 800 και οι πιστώσεις , μετά την ανακατανομή των πόρων , πρέπει να υπερέβησαν τα 4.000 εκατομμύρια ευρώ .
...
Η πολιτική σημασία της θα γίνει έτσι ακόμη μεγαλύτερη διότι οι γυναίκες έχουν ανάγκη να νοιώσουν τα αποτελέσματα της ευρωπαϊκής πολιτικής ζωντανά στην καθημερινή τους ζωή .
...
( IT ) Κύριε Πρόεδρε , θα μιλήσω δύο λεπτά εξ ονόματος της Επιτροπής για τα Δικαιώματα της Γυναίκας και τις Ίσες Ευκαιρίες και τα άλλα δύο λεπτά εξ ονόματος της Ομάδας του Κόμματος των Ευρωπαίων Σοσιαλιστών που εκπροσωπείται στην Επιτροπή Απασχόλησης και Κοινωνικών Υποθέσεων για την έκθεση EQUAL .
Η κοινοτική πρωτοβουλία EQUAL , της οποίας στόχος είναι η προώθηση νέων μέσων ικανών να καταπολεμήσουν όλες τις μορφές διάκρισης και ανισότητας , εξετάστηκε από την Επιτροπή για τα Δικαιώματα της Γυναίκας και τις Ίσες Ευκαιρίες με μεγάλη προσοχή , όσον αφορά τις διακρίσεις εις βάρος των γυναικών .
Και αυτό γιατί οι διακρίσεις που βασίζονται στο φύλο είναι διαρθρωτικές και οριζόντιες και - δεδομένου ότι οι γυναίκες δεν αποτελούν μειονότητα , αλλά περισσότερο από το ήμισυ του παγκόσμιου πληθυσμού - η Επιτροπή για τα Δικαιώματα της Γυναίκας και τις Ίσες Ευκαιρίες είναι της άποψης ότι , ήταν ίσως λάθος να συμπεριληφθούν οι διακρίσεις που βασίζονται στο φύλο μεταξύ όλων των άλλων διακρίσεων .
Θεωρούμε ότι θα ήταν προτιμότερο να περιλαμβάνονται οι διακρίσεις που βασίζονται στο φύλο σε ειδικό κεφάλαιο της Συνθήκης , αφιερωμένο στις ίσες ευκαιρίες μεταξύ ανδρών και γυναικών , ως λογική συνέπεια του νέου κεντρικού ρόλου που δίνεται , στη Συνθήκη , στην ισότητα μεταξύ ανδρών και γυναικών .
Εκφράζουμε ωστόσο την ικανοποίησή μας για τις προτάσεις της Επιτροπής και θεωρούμε ότι η ισότητα μεταξύ ανδρών και γυναικών πρέπει να προαχθεί ως αναπόσπαστο μέρος και των τεσσάρων αξόνων της στρατηγικής για την απασχόληση , καθώς και των θεματικών τομέων , και παράλληλα να αποτελέσει το περιεχόμενο ξεχωριστού άξονα .
Όσον αφορά τις προτάσεις για το EQUAL , εκτιμούμε ότι στα προγράμματα των κοινοτικών πρωτοβουλιών πρέπει να γίνεται σαφής διαχωρισμός μεταξύ των δράσεων προτεραιότητας , που στοχεύουν στην καταπολέμηση των διακρίσεων λόγω φύλου αφενός και των άλλων μορφών διακρίσεων αφετέρου και ότι πρέπει να υιοθετηθεί μια προσέγγιση που θα αποσκοπεί στην ενσωμάτωση της ισότητας μεταξύ των φύλων σε όλες τις κοινοτικές πολιτικές και , συνεπώς , να δοθεί έμφαση στην ανάγκη να υλοποιηθούν και σχέδια που δεν θα έχουν στόχο μόνο την προώθηση της καταπολέμησης των διακρίσεων λόγω φύλου , αλλά και τη διευκόλυνση της συμφιλίωσης οικογενειακής και επαγγελματικής ζωής .
Γενικότερα , επί της έκθεσης της κ. Stenzel διεξήχθη ευρύτατη συζήτηση στην Επιτροπή Απασχόλησης και Κοινωνικών Υποθέσεων γιατί η προσέγγιση που πρότεινε η κ. Stenzel και εκείνη της Ομάδας μου διέφεραν πάρα πολύ μεταξύ τους .
Αξιολογήσαμε πολύ θετικά την πρόταση της Επιτροπής , επιδιώκοντας ωστόσο - γιατί αυτός είναι ο στόχος : να εκφράσει το Ευρωπαϊκό Κοινοβούλιο μια γνώμη που να έχει βαρύτητα στις αξιολογήσεις της Επιτροπής και του Συμβουλίου - να βρούμε λύσεις πάνω στις οποίες να μπορεί να επιτευχθεί σύγκλιση απόψεων , ούτως ώστε να ψηφιστεί η έκθεση με μεγάλη πλειοψηφία .
Ορισμένα θέματα ήταν πιο λεπτά από άλλα : οι συμπράξεις , για παράδειγμα , για τις οποίες πιστεύω ότι είναι αναγκαίο να βρεθεί ένας συμβιβασμός προκειμένου να επιβεβαιωθεί και να υποστηριχθεί η πρόταση της Επιτροπής .
Συγχρόνως , πρέπει ωστόσο να ζητήσουμε από την Επιτροπή να δείξει κάποια ευελιξία για να μπορέσουν να συμπεριληφθούν στη συνέχεια και άλλα ενδιαφερόμενα μέρη .
Είναι επίσης αναγκαίο να συμπεριληφθούν η τεχνική βοήθεια και η απλούστευση μεταξύ των θεμελιωδών θεμάτων .
Το πιο λεπτό θέμα από πολιτική άποψη ήταν εκείνο των αιτούντων άσυλο .
Στο θέμα αυτό θα ήθελα να αφιερώσω μερικά δευτερόλεπτα επειδή θεωρούμε πως η πρόταση της Επιτροπής είναι περιεκτική και θετική .
Ξοδέψαμε πολύ χρόνο για να βρούμε έναν ορισμό των αιτούντων άσυλο , διότι κάτι τέτοιο είναι δύσκολο από νομική άποψη , αλλά πιστεύω ότι έχει τώρα επιτευχθεί συμβιβασμός με την εισηγήτρια - τουλάχιστον το ελπίζω - και η σιωπή της έκθεσης , που θα ψηφίσει το Κοινοβούλιο , σχετικά με τους αιτούντες άσυλο πρέπει να εκληφθεί ως υποστήριξη της θέσης της Επιτροπής από το Κοινοβούλιο .
Δεν θα είχαμε δεχτεί ποτέ μια οπισθοδρόμηση εκ μέρους του Κοινοβουλίου - αυτή είναι η θέση μας - σε σχέση με όσα πρότεινε η Επιτροπή και αυτό πρέπει να το τονίσω .
Συμφωνώ με την εισηγήτρια να ψηφίσουμε την Τετάρτη , όπως πρότεινε , για να έχουμε ακόμα χρόνο ώστε να βρούμε όλες τις πιθανές λύσεις για να εξελιχθεί , ενδεχομένως , περισσότερο η έκθεση του Κοινοβουλίου , και όχι να οπισθοδρομήσει , σε σχέση με την πρόταση την Επιτροπής .
...
Σε αυτούς θέτω λοιπόν το εξής ερώτημα : αποτελεί μήπως στόχο της πολιτικής σας η περιθωριοποίηση των ανθρώπων ; Ποια ιδέα κρύβεται πίσω από το να απαγορεύεται να εργάζονται άνθρωποι , εφόσον αυτοί το επιθυμούν ; Αυτό δεν έρχεται σε κραυγαλέα αντίθεση προς την κατευθυντήρια γραμμή για την " απασχολησιμότητα " ; Αξίζει επίσης να αναφερθεί το γεγονός ότι εδώ πρόκειται για ένα πρόγραμμα mainstreaming , διότι η έκθεση έχει ένα μειονέκτημα .
...
Κύριε Πρόεδρε , αξιότιμοι κυρίες και κύριοι , αγαπητοί συνάδελφοι , σήμερα επισημάνθηκε ήδη το γεγονός ότι ήταν σαφώς επιτυχημένη η πρώτη πρωτοβουλία URBAN .
Το ότι η εν λόγω πρωτοβουλία θα συνεχισθεί τώρα στο πλαίσιο του URBAN ΙΙ , έστω και με μειωμένη χρηματοδότηση , το οφείλουμε αποκλειστικά σε δραστήρια μέλη αυτού του Κοινοβουλίου , και ειδικότερα - απ ' ό , τι άκουσα τουλάχιστον να λέγεται ως νέο μέλος αυτού του Κοινοβουλίου - και στην εισηγήτρια , την κ. McCarthy , την οποία θα ήθελα ως εκ τούτου να ευχαριστήσω θερμά για τον ζήλο της καθώς φυσικά και για την έκθεσή της με θέμα το URBAN ΙΙ .
( Χειροκροτήματα ) Η καινοτομία της πρωτοβουλίας URBAN ΙΙ συνίσταται στο γεγονός ότι σχεδιάσθηκε στα μέτρα μικρών πόλεων ή συνοικιών .
Αυτό είναι σημαντικό , διότι ειδικά οι μικρές πόλεις έχουν συχνά λιγότερες δυνατότητες να αποκτήσουν μέσα ενίσχυσης .
Από την άλλη πλευρά , όμως , ενδέχεται τα προβλήματα που οδηγούν σε μια έντονη ανάγκη για καινοτομία να συγκεντρωθούν ιδιαίτερα σε παρόμοιες πόλεις και να έχουν αντίστοιχα πολύ αρνητικές επιπτώσεις .
Για να αυξηθεί η αποτελεσματικότητα των μεμονωμένων μέτρων περιορίσθηκε σε 50 ο αριθμός των προγραμμάτων για το URBAN ΙΙ .
Θεωρώ σημαντικό να μην διατηρηθεί με αδιαλλαξία αυτός ο αυθαίρετα καθορισθείς αριθμητικός περιορισμός , αλλά να αφεθεί στην κρίση των κρατών μελών σε πόσα προγράμματα σκοπεύουν να διανείμουν κάθε φορά τα μέσα ενίσχυσης που δικαιούνται .
Ωστόσο , πρέπει να δοθεί προσοχή ώστε ειδικά σε μικρά κράτη μέλη να μην επωφεληθούν πάλι από την ενίσχυση κάποιες μόνον συνοικίες των μεγαλουπόλεων .
Εκεί , το URBAN II δεν θα αποτελούσε παρά μόνον σταγόνα στον ωκεανό , η επιτυχία του θα ήταν αμφίβολη και θα εξανεμιζόταν .
Κατά τη γνώμη μου , είναι επίσης σημαντικό τα κριτήρια επιλογής για το URBAN ΙΙ να μην διευρυνθούν υπερβολικά , με αποτέλεσμα να αποδυναμωθούν .
Ένας αυστηρά καθορισμένος κατάλογος κριτηρίων αποτελεί ακριβώς την προϋπόθεση για να προσλάβουν χαρακτήρα προτύπου τα προγράμματα που προωθήθηκαν και να μπορέσουν να χρησιμοποιηθούν μελλοντικά σε άλλες προβληματικές πόλεις .
Από την προσωπική μου εμπειρία σε επίπεδο πολιτικής των δήμων και των κοινοτήτων σε μια παλαιά βιομηχανοποιημένη περιφέρεια με πλειάδα προβλημάτων θα ήθελα , τελειώνοντας , να παρακαλέσω εσάς , αγαπητοί συνάδελφοι , να υποστηρίξετε δύο θέματα της έκθεσης τα οποία θεωρώ ουσιαστικά , παράλληλα με τις κοινωνικές και πολιτικές πτυχές .
Πρώτον : η πτυχή της προστασίας του περιβάλλοντος είναι απαραίτητη για μια αειφόρο αστική ανάπτυξη και , ως εκ τούτου , θα πρέπει να αποτελεί γενική προϋπόθεση για την προώθηση των προγραμμάτων .
Δεύτερον : η πρόληψη και η καταπολέμηση της καθημερινής αστικής εγκληματικότητας καθώς και της εγκληματικότητας που συνδέεται με την απόκτηση ναρκωτικών πρέπει να ξεκινήσουν σε τοπικό επίπεδο .
Είναι απαραίτητες για τη βελτίωση της ποιότητας ζωής στις αστικές περιοχές και , ως εκ τούτου , πρέπει να διαδραματίσουν επίσης κεντρικό ρόλο στην πρωτοβουλία URBAN II .
...
Υπάρχουν δύο αλληλοσυσχετιζόμενα προβλήματα που εξακολουθούν να υπάρχουν σε πολλές περιφέρειες της Ευρώπης : πρώτον , η έλλειψη επαρκούς υποδομής σε ό , τι αφορά τα οδικά δίκτυα , τις εγκαταστάσεις επεξεργασίας ύδατος και τα σχετικά δίκτυα μεταφορών .
Δεύτερον , η ανάγκη να θεσπισθούν πρωτοβουλίες για την καταπολέμηση της ανεργίας των νέων και της μακροχρόνιας ανεργίας , η οποία συνιστά μόνιμο κοινωνικό πρόβλημα σε πολλές αστικές και αγροτικές περιοχές της Ευρώπης .
...
Χαίρομαι που βλέπω ότι αυτό έγινε αποδεκτό στην έκθεση , όμως δεν μπορώ να συμφωνήσω με την τροπολογία αριθ .
9 , καθώς η εν λόγω τροπολογία στην πραγματικότητα δεν έχει διατυπωθεί σε καθόλου απλή γλώσσα .
...
Γι ' αυτό και είναι δύσκολο να επιτευχθεί ισορροπία , όχι μόνο μεταξύ των διαφόρων χωρών , όχι μόνο μεταξύ των διαφόρων τμημάτων του προγράμματος , αλλά κυρίως μεταξύ των διαφόρων ομάδων που αναφέρονται στο πρόγραμμα .
Αυτό είναι ακριβώς και το πρόβλημα που μας απασχόλησε μέχρι σήμερα .
...
Κύριε Πρόεδρε , αγαπητέ κύριε Επίτροπε Fischler , η ανάπτυξη της υπαίθρου πρέπει και μπορεί να λάβει υπόψη τρεις προβληματισμούς , δηλαδή τη διατήρηση θέσεων εργασίας , τη διατήρηση του φυσικού τοπίου καθώς και την τοπική κουλτούρα που είναι σημαντική !
Μόνον εάν μπορέσει να παραμείνει στην ύπαιθρο ο πληθυσμός , θα εξασφαλισθεί μακροπρόθεσμα και η ποιότητα ζωής στην ύπαιθρο .
Το τι σημαίνει αστυφιλία μπορούμε να το δούμε σε ορισμένες περιοχές των Αλπεων , όπου οι συνέπειες είναι ολέθριες !
Όμως σας προειδοποιώ πως δεν πρέπει να μεταφέρουμε στην ύπαιθρο την αστική κουλτούρα με αυτά τα προγράμματα .
Επίσης , θα πρέπει να αποφύγουμε τη δημιουργία διαρθρώσεων που εξαρτώνται από επιχορηγήσεις και που στηρίζονται μονίμως σε αυτές .
Για να εξασφαλισθεί τώρα αυτή η αειφορία - λέξη που κατάντησε να είναι ένα σύνθημα χωρίς ιδιαίτερο νόημα , καταλαβαίνουμε όμως όλοι τι εννοούμε με αυτό - χρειάζονται μεταξύ άλλων διασυνδέσεις , παραδείγματος χάρη στην ύπαιθρο μεταξύ του τουρισμού και της γεωργίας .
Οι επενδύσεις πρέπει να έχουν κάποια οράματα ως στόχο .
Τα νέα δημιουργικά μυαλά πρέπει να δεθούν με την ύπαιθρο .
Εάν φύγουν όλοι αυτοί , δεν πρόκειται πλέον να συμβεί τίποτα το αξιόλογο εκεί .
Κανείς από εμάς δεν εκτιμά την αρχή της ομοιομορφίας , και τα προγράμματα πιλοτικού χαρακτήρα πρέπει να ωθούν σαν χιονοστιβάδες , τρόπος του λέγειν , άλλα παρόμοια προγράμματα .
Συνηγορώ υπέρ των συστημάτων κλειστού κυκλώματος που προωθούνται , και μολονότι το LEADER Ι και το LEADER ΙΙ παρουσίαζαν ενδεχομένως ορισμένες ελλείψεις , ήταν σίγουρα θετικά στο σύνολό τους .
Θα ήθελα να σας παρακαλέσω να εξετάσετε τη δυνατότητα να μην εγκρίνονται οι εξαιρέσεις μόνον για τις βόρειες χώρες , αλλά και για τις ορεινές περιοχές , τις Αλπεις , τα Πυρηναία , τη Σιέρα Νεβάδα , απ ' όπου μόλις επέστρεψα , και μάλιστα όσον αφορά των αριθμό των κατοίκων και την πυκνότητα του πληθυσμού .
( Χειροκροτήματα ) Κύριε Πρόεδρε , θέλω να αναφερθώ στην έκθεση EQUAL και , ιδιαίτερα , στο θέμα της πολιτικής για τους πρόσφυγες .
...
Οι περιφέρειές μας έχουν συνειδητοποιήσει ότι ανήκουν σε ένα περιβάλλον με το οποίο τους συνδέει όχι μόνο η γεωγραφία , αλλά και ο πολιτισμός και η ιστορία των λαών τους .
Εξαιτίας αυτής της συνειδητοποίησης εξέφρασαν την έντονη επιθυμία τους για πιο βαθιά εδραίωση σε αυτό το περιβάλλον .
...
Κατά συνέπεια , επιζητώ μερικές μικρές προσαρμογές στις γενικές κατευθύνσεις για να υπάρξει κάπως μεγαλύτερη ευελιξία και για να προσαρμόσουμε τους τρόπους με τους οποίους τα συμφέροντα των θαλάσσιων περιοχών θα μπορέσουν να συμπεριληφθούν μεταξύ των κεφαλαίων Α και Β .
Αυτές οι προσαρμογές περιλαμβάνουν την αποσαφήνιση των δυνατοτήτων συνεργασίας μεταξύ των θαλάσσιων περιοχών , καθώς και το να καταστεί δυνατή η μεγαλύτερη ανάπτυξη πρακτικών και ορατών σχεδίων , ιδιαιτέρως εκείνων που αφορούν την υποδομή .
...
Η έκθεση ασχολείται με αυτό και προτείνει να ενσωματωθεί δράση με στόχο να επιτευχθεί η ισότητα μεταξύ γυναικών και ανδρών σε όλες τις πτυχές της εργασίας .
Αναγνωρίζει επίσης τη σημασία της συνεργασίας με τοπικούς και περιφερειακούς φορείς , που είναι εκείνοι που βρίσκονται πιο κοντά στους ανθρώπους ώστε να διασφαλίζεται το mainstreaming σε όλα τα αποτελέσματα των σχεδίων .
...
Οι αναπτυξιακές συμπράξεις στα πλαίσια των θεματικών τομέων , που αναφέρονται στην τροπολογία αριθ .
22 , θα επιτρέψουν ακόμη και στις μικρότερες οργανώσεις να διαδραματίσουν κάποιο ρόλο στην πρωτοβουλία EQUAL .
Η Ομάδα μου θα υποστηρίξει την τροπολογία αριθ .
22 .
...
Το EQUAL παραμένει αποφασιστικής σημασίας και για περιφέρειες όπως η δική μου , στα ανατολικά της Αγγλίας , η οποία βρίσκεται εκτός του πλαισίου των κυριότερων πιστώσεων του Στόχου 1 .
Εμείς έχουμε ένα επιπλέον κίνητρο για να πάρουμε χρηματοδότηση μέσω της κοινοτικής πρωτοβουλίας και εξαιρετικές επιδόσεις ως αποτέλεσμα προηγούμενων σχεδίων .
...
Παροτρύνω το Κοινοβούλιο να υποστηρίξει την τροπολογία μας αριθ .
2 , η οποία θα διασφαλίσει την ευελιξία ώστε να συμπεριληφθούν νέες περιοχές , ιδιαίτερα στις θαλάσσιες παραμεθόριες περιοχές .
...
Πώς να τεθούν εδώ προτεραιότητες ; Υπάρχει ομοφωνία όσον αφορά τη βασική αρχή που συνίσταται στην κατάργηση της περιθωριοποίησης , των διακρίσεων και των ανισοτήτων στην αγορά εργασίας .
...
Κύριε Πρόεδρε , κύριε Επίτροπε , είναι πλέον προφανές ότι η αποκλειστική ενασχόληση με τη γεωργική δραστηριότητα καθίσταται όλο και λιγότερο ικανή να κρατήσει τον πληθυσμό , και ειδικότερα τη νεολαία , στις αγροτικές περιοχές .
...
Με δεδομένη αυτή την κατάσταση , η Επιτροπή , αργά αλλά σταθερά , δυστυχώς όμως με υπερβολικά αργούς ρυθμούς , προωθούσε πρωτοβουλίες οι οποίες προσέβλεπαν , μακροπρόθεσμα , στην εξισορρόπηση και τη συμπλήρωση της ΚΓΠ , με απώτερο στόχο να επεκταθεί η εμβέλειά της στο σύνολο των ενδογενών πόρων της υπαίθρου , προωθώντας την κινητοποίηση αυτών των πόρων μέσω πρωτοβουλιών και επενδύσεων προς όφελος της αύξησης της ευημερίας και της απασχόλησης του πληθυσμού , τόσο των αγροτών όσο και των υπόλοιπων ομάδων .
Είναι η περίπτωση της πρόσφατης πολιτικής με στόχο την ανάπτυξη της υπαίθρου , που εγκαινιάστηκε επ ' ευκαιρία της μεταρρύθμισης που εισάγεται με την Ατζέντα 2000 , και ειδικότερα είναι η περίπτωση της κοινοτικής πρωτοβουλίας LEADER , η οποία ξεκίνησε με την LEADER Ι και την LEADER ΙΙ , το 1991 και το 1994 αντίστοιχα , και συνεχίζεται τώρα με την πρωτοβουλία LEADER + .
Με βάση τα παραπάνω , θα επιθυμούσα να υπογραμμίσω τρία ζητήματα : πρώτον , έχει ουσιαστική σημασία να αποφευχθεί η " πολιτικοποίηση " των κριτηρίων επιλογής των ομάδων τοπικής δράσης που θα αναλάβουν τη διοργάνωση και υλοποίηση των σχεδίων , αλλά η επιλογή αυτή πρέπει να γίνεται με αποκλειστικό κριτήριο την αξία των σχεδίων , δίνοντας προτεραιότητα στα σχέδια όπου το ποσοστό συμμετοχής μη κρατικών φορέων θα είναι υψηλότερο , παρ ' ότι αυτοί δεν θα πρέπει σε καμία περίπτωση να αντιπροσωπεύουν πάνω από το 50 % των εταίρων που συμμετέχουν στις ΟΤΔ · δεύτερον , είναι αναγκαίο , στο πλαίσιο των δράσεων συνεργασίας μεταξύ των ΟΤΔ και αντίστοιχων οργανώσεων τρίτων χωρών , να ακολουθηθεί η αρχική διατύπωση της Επιτροπής - όπως εμφανίζεται στο σημείο 18 - και όχι η περιοριστική διατύπωση της Επιτροπής STAR , η οποία πέρασε παρά τη θέληση αυτού του Κοινοβουλίου .
Αυτός είναι ο λόγος για τον οποίο υπέβαλα μία τροπολογία προς αυτή την κατεύθυνση , η οποία εγκρίθηκε από την Επιτροπή Γεωργίας και αναμένω ότι θα γίνει αποδεκτή από την Ολομέλεια · τρίτον , θα ήθελα να σας υπενθυμίσω ότι είναι απολύτως απαραίτητο , μετά το 2006 , να παύσει πλέον το LEADER να αποτελεί απλώς και μόνο μία κοινοτική πρωτοβουλία πιλοτικού χαρακτήρα και να αναβαθμισθεί σε μία συνιστώσα ανάπτυξης της υπαίθρου της ΚΓΠ , η οποία θα έπρεπε , κατά τη γνώμη μου , να ονομάζεται στο εξής " κοινή γεωργική και περιφερειακή πολιτική και πολιτική υπέρ της υπαίθρου " .
Θα επιθυμούσα να συγχαρώ τον συνάδελφο Procacci για την εξαίρετη έκθεση που μας παρουσίασε .
Κύριε Πρόεδρε , προτού εν συνεχεία δώσετε τον λόγο στους φίλους και συνάδελφους , Franz Fischler και Αννα Διαμαντοπούλου , καθώς και οι τρεις είχαμε την ευκαιρία να παρακολουθήσουμε αυτή τη συζήτηση με την ίδια προσοχή ως υπεύθυνοι των τεσσάρων αυτών κοινοτικών πρωτοβουλιών - θα ήθελα να σταθώ και να μιλήσω σχετικά με τις πρωτοβουλίες URBAN και INTERREG για τις οποίες μιλήσατε πολλοί από εσάς και επί των οποίων παρεμβήκατε .
Θέλω εξ αρχής να εκφράσω τις ευχαριστίες μου στους εισηγητές των επιτροπών , όλων των επιτροπών , καθώς επίσης και στους αγορητές των Ομάδων και στην καθεμιά και στον καθένα από εσάς για την υψηλή ποιότητα και το μεγάλο ενδιαφέρον που καταμαρτυρούν οι παρεμβάσεις σας ως προς αυτές τις δυο πρωτοβουλίες .
Αυτό ισχύει ιδιαίτερα για όσα είπε , σχετικά με το URBAN , η κ. Arlene McCarthy , την οποία θα ήθελα να ευχαριστήσω όχι μόνο για την εργασία και την έκθεση που παρουσίασε αλλά επίσης , θα το πω και εγώ με τη σειρά μου , για όσα της οφείλουμε , για όσα της οφείλετε εσείς όσον αφορά αυτή την πρωτοβουλία , όπως οφείλουμε και εμείς στο Κοινοβούλιό σας εν γένει .
Πράγματι , δεν λησμονώ ότι το Ευρωπαϊκό Κοινοβούλιο είναι εκείνο που έλαβε την πολιτική απόφαση και εξέφρασε την ελπίδα για τη διατήρηση αυτής της πρωτοβουλίας υπέρ της αναζωογόνησης των αστικών ζωνών σε κρίση , υπέρ μιας αειφόρου αστικής ανάπτυξης , η οποία ταυτόχρονα συνεπάγεται αυτή την ολοκληρωμένη προσέγγιση όσον αφορά την παράλληλη αντιμετώπιση των οικονομικών , κοινωνικών και περιβαλλοντικών πτυχών , την οποία στηρίζουμε .
Αλλα σημεία με τα οποία συμφωνούμε και τα οποία τονίζονται στην έκθεση της κ. Arlene McCarthy είναι η αποτελεσματικότητα αυτού του μέσου μέσω της οικονομικής συγκέντρωσης και μιας κρίσιμης μάζας για τις παρεμβάσεις , ο οριζόντιος μηχανισμός που κατά τη γνώμη μας ευνοεί περισσότερο τη διάδοση των αποτελεσμάτων και την αύξηση των ανταλλαγών εμπειριών και ορθών πρακτικών και τέλος , ο διευρυνόμενος ρόλος των τοπικών αρχών , όσον αφορά τη σύλληψη και τη διαχείριση των προγραμμάτων , βάσει μιας πραγματικής εταιρικής σχέσης .
Έχοντας υπενθυμίσει τα βασικά σημεία στα οποία συμφωνούν οι προτάσεις της Επιτροπής και του Κοινοβουλίου σας και έχοντας τονίσει το μεγάλο ενδιαφέρον με το οποίο άκουσα τις διάφορες παρεμβάσεις , θα ήθελα να απαντήσω σε ορισμένες επικρίσεις , σε ορισμένες συστάσεις που διατυπώθηκαν , αφού πρώτα σας ζητήσω εκ των προτέρων να με συγχωρέσετε για την αδυναμία μου να αναφέρω προσωπικά όλους όσους παρενέβησαν .
Νομίζω πάντως ότι καθένας θα αναγνωρίσει τον εαυτό του .
Καταρχάς , το πρόγραμμα URBAN και το μέγιστο όριο των πενήντα πόλεων που κάποιοι από εσάς χαρακτηρίσατε αυθαίρετο .
Κατανοώ αυτή την ανησυχία .
Γι ' αυτό ζήτησα από τις υπηρεσίες μου να είναι έτοιμες να μελετήσουν μια εύλογη αύξηση του αριθμού των επιλέξιμων στο πρόγραμμα URBAN πόλεων με ορισμένες εγγυήσεις , πρωτίστως όσον αφορά τη συγκέντρωση - αναφέρομαι κυρίως σε ορισμένες ζώνες παρέμβασης , οι οποίες θα πρέπει να αριθμούν τουλάχιστον 20.000 κατοίκους και , σε εξαιρετικές περιπτώσεις , 10.000 κατοίκους - και εν συνεχεία , την κρίσιμη οικονομική μάζα : θα πρέπει να περιοριστούμε στα 500 ευρώ ανά κάτοικο , προκειμένου η παρέμβαση της Ευρωπαϊκής Ένωσης να είναι αποτελεσματική και ταυτόχρονα ουσιαστική και προκειμένου να μην συγγενεύει κατά κάποιον τρόπο με μια υπερβολική κατάτμηση των πόρων που δεν θα είχε πλέον κανένα νόημα ούτε για τους πολίτες ούτε για τις κοινότητες .
Αυτή είναι η πρώτη μου απάντηση σχετικά με το ζήτημα του ορίου .
Όσον αφορά τώρα ένα δεύτερο ζήτημα , το οποίο αφορά τα πρόσθετα κριτήρια που θα έπρεπε να λαμβάνονται υπόψη κατά την επιλογή των ζωνών που βρίσκονται σε δύσκολη κατάσταση , είμαι έτοιμος ακόμη και εδώ , να επιδείξω μεγαλύτερη ευελιξία και να λάβω υπόψη μου , εκτός από τα κοινοτικά κριτήρια που προβλέπονται στο σημείο 11 του σχεδίου γενικών κατευθύνσεων και άλλα σχετικά κριτήρια .
Τρίτο σημείο : οι ειδικές δράσεις υπέρ ορισμένων κοινωνικών ομάδων - αναφέρθηκαν σε πολλές από τις παρεμβάσεις σας - οι γυναίκες , αλλά και οι μετανάστες , οι πρόσφυγες , θα έπρεπε να συμπεριλαμβάνονται .
Αυτό το μέλημα , κυρίες και κύριοι βουλευτές , βρίσκεται στην καρδιά της δικής μας πρωτοβουλίας URBAN και , εάν κάτι τέτοιο κριθεί απαραίτητο , είμαι πρόθυμος για μια ενδεχόμενη εκ νέου συγγραφή του κειμένου , η οποία θα επιτρέπει την περαιτέρω αποσαφήνιση του μηνύματος .
Θα ήθελα να ολοκληρώσω , όσον αφορά το URBAN , σχετικά με τους όρους εφαρμογής και πρωτίστως να αναφέρω τη διαδικασία επιλογής .
Ορισμένοι εξέφρασαν την επιθυμία η διαδικασία αυτή να γίνει λιγότερο γραφειοκρατική , πιο διαφανής , να αποφεύγεται η διπλή χρήση στο επίπεδο των σχεδίων και των χρηματοδοτήσεων .
Κυρίες και κύριοι , πρέπει να είμαστε σαφείς όσον αφορά αυτό το σημείο : στο πλαίσιο της αρχής της επικουρικότητας , η επιλογή των επιλέξιμων ζωνών ή επιλέξιμων κοινοτήτων για το URBAN ανήκει πρωτίστως στην αρμοδιότητα των κρατών μελών .
Η Επιτροπή , από την πλευρά της , είναι έτοιμη να αποφύγει την αδικαιολόγητη γραφειοκρατική υπερφόρτωση , δεν μπορούμε , ωστόσο , να μην επιβεβαιώσουμε την καταλληλότητα και την ποιότητα των προγραμμάτων που μας προτείνονται - άλλωστε , εσείς θα ήσασταν από τους πρώτους που θα μας επικρίνατε για αυτό .
Η δεύτερη παρατήρηση αφορά τις προθεσμίες υποβολής των προγραμμάτων και την δυνατότητα παρουσίασης ενός συμπληρώματος προγραμματισμού , το οποίο θα είναι συνημμένο με τα προγράμματα .
Δεν έχω καμία αντίρρηση ως προς αυτή την ιδέα υποβολής ενός συμπληρώματος προγραμματισμού , το οποίο θα είναι συνημμένο με το αρχικό πρόγραμμα .
Ωστόσο , κάτι τέτοιο δεν μπορεί να σημαίνει παράταση της αρχικής προθεσμίας , η οποία υπενθυμίζω ότι για το πρόγραμμα αυτό διαρκεί έξι μήνες .
Η προθεσμία αυτή , η οποία μάλιστα είναι ίση με εκείνη που ορίσαμε για το INTERREG και για τα ενιαία έγγραφα προγραμματισμού του στόχου 2 , πρέπει γενικά να επαρκεί , κατά τη γνώμη μου , για την εκπόνηση ενός προγράμματος , γεγονός που δεν απαγορεύει τον μεταγενέστερο προσδιορισμό των σχεδίων .
Όσον αφορά το URBAN , θα ήθελα να ολοκληρώσω με μια τελευταία σκέψη .
Κάποιος από εσάς εξέφρασε την επιθυμία η διάσταση αυτή του αστικού χώρου να μην περιοριστεί στο URBAN .
Είμαι απολύτως σύμφωνος .
Και εγώ ο ίδιος , στη συνεδρίαση των υπουργών χωροταξίας εξέφρασα το μέλημά μου - και είναι κάτι στο οποίο δίνω πολλή προσοχή - στα ενιαία έγγραφα προγραμματισμού , στο πλαίσιο των ΚΠΣ , στους προγραμματισμούς για τους οποίους ξεκινάμε τις διαπραγματεύσεις - το μέλημά μου , επαναλαμβάνω , η διάσταση του αστικού χώρου να υπάρχει και εκτός του URBAN , στο σύνολο των προγραμμάτων του στόχου 1 και του στόχου 2 .
Νομίζω ότι είμαι σε θέση να εκφράσω τόσο την επαγρύπνησή μας όσο και το γεγονός ότι αυτή η διάσταση του αστικού χώρου εκφράζεται και εκτός του URBAN , στο σύνολο των προγραμματισμών των διαρθρωτικών ταμείων .
Όμως , μελλοντικά , εφόσον πρέπει να κοιτάζουμε μπροστά , ενδιαφέρομαι πάρα πολύ να δω με ποιο συγκεκριμένο τρόπο θα εφαρμοστεί το URBAN , και ενδιαφέρομαι επίσης να δω ποιες θα είναι οι εμπειρίες ή τα διδάγματα που θα μπορούμε να συνάγουμε , καθώς είναι προφανές ότι αυτή η διάσταση του αστικού χώρου πρόκειται να είναι στο επίκεντρο αυτού που θα μπορούσε να αποτελέσει , στις προσεχείς δημοσιονομικές προοπτικές , μια νέα χωροταξική πολιτική των ευρωπαϊκών εδαφών .
Δεν ξεχνώ , δεν μπορούμε να ξεχάσουμε , ότι σήμερα το 80 % των ευρωπαίων πολιτών ζει στις πόλεις γεγονός που καθιστά το μέσο αυτό , το URBAN , εξαιρετικά σημαντικό .
Το λέω και το επαναλαμβάνω , θα είμαστε προσεχτικοί ως προς την παρουσία της διάστασης του αστικού χώρου στο σύνολο των προγραμματισμών των διαρθρωτικών ταμείων .
Τώρα , κύριε Πρόεδρε , θα ήθελα να αναφερθώ στο INTERREG και να ευχαριστήσω τον εισηγητή σας , τον κ. Francis Decourriθre , όπως έκανα προηγουμένως με την κ. Arlene McCarthy , για την ποιότητα και την ορθότητα της εργασίας του .
Επέμεινε σε πολλά σημεία με τα οποία εμείς συμφωνούμε όπως άλλωστε και πολλοί από εσάς .
Τα θέματα αυτά είναι πρώτον , η σπουδαιότητα αυτής της διευρωπαϊκής συνεργασίας με τα τρία κεφάλαιά της , το διασυνοριακό , το διακρατικό και το διαπεριφερειακό , δεύτερον , η κοινοτική προστιθέμενη αξία του INTERREG , το νόημά του σε σχέση με το γενικό πλαίσιο των διαρθρωτικών ταμείων και η πραγματικά διασυνοριακή , διακρατική ενίσχυση των προγραμμάτων και των επιλέξιμων λειτουργιών · τρίτον , η σημασία των κοινών δομών - αυτό που αποκάλεσα επ ' ευκαιρία μιας άλλης συζήτησης που αρχίζει σήμερα , της Διακυβερνητικής Διάσκεψης , το κοινό ευρωπαϊκό πνεύμα , το οποίο πρέπει να ενισχύσουμε .
Και έτσι , με αυτό τον τρόπο , με το INTERREG δηλαδή και χάρη στο INTERREG θα μπορέσουμε να ενισχύσουμε το κοινό πνεύμα μέσα από κοινές δομές για την υλοποίηση των προγραμμάτων με μια πραγματική οικονομική αλληλεγγύη .
Τέλος , η σημασία της εταιρικής σχέσης για την διασφάλιση της ενεργού συμμετοχής όλων των εμπλεκόμενων τοπικών και περιφερειακών αρχών , καθώς και των οργανισμών του ιδιωτικού τομέα και των κοινωνικοοικονομικών εταίρων .
Μετά από αυτές τις γενικές παρατηρήσεις , θα ήθελα να επικεντρώσω την παρέμβασή μου , όσον αφορά το INTERREG , στις βασικές σας παρατηρήσεις .
Οι πρώτες παρατηρήσεις συνδέονται με το χρονοδιάγραμμα και με το περιεχόμενο αυτής της πρωτοβουλίας .
Υποστηρίζετε ότι η έγκριση αυτών των γενικών κατευθύνσεων καθυστέρησε εξαιρετικά πολύ και τονίστηκε , ιδιαιτέρως από τον εισηγητή σας , ο κίνδυνος μιας ενδεχόμενης διακοπής των προηγούμενων προγραμμάτων .
Πράγματι έτσι είναι , το παραδέχομαι και εσείς , κυρίες και κύριοι βουλευτές του Ευρωπαϊκού Κοινοβουλίου , γνωρίζετε καλά ποια είναι τα αίτια .
Υπάρχει μια καθυστέρηση όσον αφορά την έγκριση των γενικών κατευθύνσεων του INTERREG για τον Μάρτιο - Απρίλιο του 2000 .
Το παραδέχομαι , το επισημαίνω και εγώ όπως και εσείς .
Ωστόσο , παρατηρώ ότι τα κράτη μέλη και οι περιφέρειες δραστηριοποιούνται ήδη στην προετοιμασία των προγραμμάτων του INTERREG ΙΙΙ και άλλωστε το σχέδιο προσανατολισμών έχει ήδη διανεμηθεί πριν από περισσότερο από τρεις μήνες .
Επισημαίνω επίσης ότι η επιλεξιμότητα των δαπανών θα γίνει αποδεκτή από την ημερομηνία παρουσίασης των προγραμμάτων και εάν το πρόγραμμα παρουσιαστεί πριν από τις 30 Απριλίου , σας επιβεβαιώνω το ενδεχόμενο αναδρομικής ισχύος από την 1η Ιανουαρίου .
Αυτά όσον αφορά την πρώτη παρατήρηση .
Δεύτερη παρατήρηση : αναφορικά με τον μη εξαντλητικό κατάλογο των επιλέξιμων μέτρων για το κεφάλαιο Β , θέλω να σας πως και να σας βεβαιώσω ότι , ζήτησα από την Επιτροπή να δεχτεί να συμπεριλάβει στον κατάλογο των επιλέξιμων δράσεων στο κεφάλαιο Β και άλλα ειδικά θέματα , κυρίως υπέρ των μικρών και μεσαίων επιχειρήσεων ή της πολιτιστικής κληρονομιάς και επομένως να μην θεωρείται πλέον εξαντλητικός αυτός ο κατάλογος .
Τρίτο σημείο : η διαπεριφερειακή συνεργασία , η σπουδαιότητα του κεφαλαίου Γ .
Η Επιτροπή συμμερίζεται τις παρατηρήσεις που έκανε το Κοινοβούλιό σας όσον αφορά τη σπουδαιότητα του κεφαλαίου Γ , για τη διαπεριφερειακή συνεργασία .
Σύμφωνα με την επιθυμία του εισηγητή σας , θα σας διαβιβάσω ορισμένες λεπτομερείς πληροφορίες σχετικά με το σύστημα εφαρμογής αυτού του κεφαλαίου .
Τέταρτη παρατήρηση : το παρατηρητήριο και η ενδεχόμενη χρήση ενός γραφείου τεχνικής βοήθειας .
Σύμφωνα με το αίτημά σας , αποφάσισα τη διαγραφή από το κείμενο οποιασδήποτε αναφοράς στην προσφυγή σε γραφείο τεχνικής βοήθειας , αναμένοντας ότι η συζήτηση που διεξάγεται τώρα στους κόλπους της Επιτροπής σχετικά με την χρησιμοποίηση εξωτερικών παροχέων υπηρεσιών θα οδηγήσει σε κάποιο αποτέλεσμα .
Ωστόσο , κυρίες και κύριοι βουλευτές , εάν διαγράψουμε κάθε αναφορά και αργότερα κάθε προσφυγή σε κάποιο γραφείο τεχνικής βοήθειας , αυτό θα έχει ως συνέπεια την αναγκαστική αύξηση του αριθμού ορισμένων θέσεων δημοσίων υπαλλήλων που θα κάνουν αυτή την εργασία , δεδομένου ότι , αφενός , οπωσδήποτε , κάποιος θα πρέπει να την κάνει και , αφετέρου , εγώ δεν θα μπορώ να ανακατανέμω επ ' αόριστον τους ίδιους υπαλλήλους , με δεδομένο ότι οι υποχρεώσεις μας αυξάνουν με τον ISPA και ότι μέλημά μας είναι να ελέγχουμε καλύτερα , με αυστηρότητα και διαφάνεια τις κοινοτικές πιστώσεις , για τις οποίες είμαι υπεύθυνος εγώ , συχνά με τη συνεργασία ή την συνυπευθυνότητα των κρατών μελών .
Όσον αφορά τώρα την εφαρμογή του INTERREG , ζήτημα στο οποίο αναφερθήκατε πολλοί από εσάς , και την ενδεχόμενη επιλεξιμότητα στο κεφάλαιο Α , την " Διασυνοριακή Συνεργασία " , δράσεων στην Αδριατική , δράσεων για την Σικελία ή για άλλες υπεραπόκεντρες περιοχές , η Επιτροπή , κυρίες και κύριοι , κατανοεί τις ανησυχίες σας και αποδέχεται το αίτημά σας επί αυτών των διαφορετικών σημείων .
Επίσης , θα ήθελα να τροποποιήσω τις κατευθύνσεις , προκειμένου να εντάξουμε στο διακρατικό κεφάλαιο Β μια ιδιαίτερη προτεραιότητα : την " Ολοκληρωμένη συνεργασία των θαλάσσιων και νησιωτικών περιφερειών " , έτσι ώστε να καλύπτονται με κατάλληλο , κατά τη γνώμη μου , τρόπο οι διαφορετικές δυνατότητες συνεργασίας μεταξύ αυτών των περιοχών .
Πρόκειται για ένα πρώτο άνοιγμα , στο οποίο προστίθεται ένα δεύτερο που προτείνουμε στο εξής στα κράτη μέλη για μια μεγαλύτερη δημοσιονομική ελαστικότητα μεταξύ του κεφαλαίου Α και Β .
Χάρη σε αυτά τα δύο ανοίγματα και κυρίως στο πρώτο , μπορώ να σας πω ότι η Επιτροπή είναι έτοιμη να εξετάσει την περίπτωση των ιταλικών περιφερειών και των περιφερειών τρίτων χωρών της Αδριατικής για να ευνοήσει την πλέον κατάλληλη συνεργασία στο πλαίσιο του INTERREG , καθώς επίσης και με άλλα μέσα , από τη στιγμή που αυτά θα είναι διαθέσιμα .
Τέλος , αποφάσισα ότι οι υπεραπόκεντρες περιφέρειες , στις οποίες επιμένω ιδιαίτερα , θα τύχουν ιδιαίτερης προτεραιότητας στο πλαίσιο του διακρατικού κεφαλαίου του INTERREG , με μια στρατηγική συνεργασίας , η οποία θα αποσκοπεί στη βελτίωση των δεσμών τους με τους γείτονές τους και τις άλλες περιφέρειες των κρατών μελών .
Θα ήθελα επίσης να εκφράσω το μέλημα να υπάρξει μια αποτελεσματική συνεργασία μεταξύ του INTERREG και του Ευρωπαϊκού Ταμείου Ανάπτυξης ( ΕΤΑ ) , κυρίως για την Καραϊβική και τον Ινδικό Ωκεανό .
Όλα αυτά , πέρα από τις πιστώσεις του στόχου 1 αλλά και με αυτές , θα έπρεπε να μας επιτρέπουν να επιβεβαιώσουμε τον ρόλο του " ενεργού συνόρου " της Ένωσης .
Λαμβάνω υπόψη μου και υιοθετώ αυτόν τον πολιτικό στόχο , βάσει του οποίου οι επτά υπεραπόκεντρες περιφέρειες της Ένωσης πρέπει να αποτελούν σαφώς τα ενεργά σύνορα της Ένωσης , ακόμη και εάν - αλλά και ακριβώς για αυτό τον λόγο - είναι απομακρυσμένες και βρίσκονται σε άλλες περιφέρειες του κόσμου , στις οποίες πρέπει να ασκούμε επιρροή και να αναπτύσσουμε δράση .
Αλλο σημείο : ο συντονισμός μεταξύ του INTERREG , και των προγραμμάτων PHARE , TACIS και MEDA .
Είναι αλήθεια και το αναγνωρίζω αντικειμενικά , ότι και σε αυτό το θέμα υπάρχουν πραγματικές νομικές δυσκολίες .
Δεν θα ήθελα να τις υποβαθμίσω , παρ ' όλα αυτά όμως σημειώνεται κάποια πρόοδος , όσον αφορά τη συνεργασία του κεφαλαίου Α με τις υποψήφιες χώρες , αν και οι δυσκολίες που συνδέονται με τις διαδικασίες διαχείρισης και με το μέγεθος των σχεδίων παραμένουν .
Η Επιτροπή θα πρέπει να συνεχίσει αυτή την πορεία , πράγμα για το οποίο δεσμεύομαι προσωπικά .
Μια πρώτη συνεδρίαση της κοινής επιτροπής PHARE / κοινοτική πρωτοβουλία θα πραγματοποιηθεί τον Φεβρουάριο για την εκπόνηση αξιολόγησης αυτού του συντονισμού και σας βεβαιώνω για την επαγρύπνηση και την διαθεσιμότητά μου προς αυτή την κατεύθυνση , μαζί με τους συναδέλφους μου Verheugen , Patten και Poul Nielson .
Τέλος , όσον αφορά την τεχνική βοήθεια , για την οποία τόσο ο εισηγητής σας όσο και πολλοί από εσάς διατυπώσατε ορισμένες παρατηρήσεις , είναι αυτονόητο ότι η Επιτροπή θα τηρήσει τις διατάξεις του άρθρου 23 του γενικού κανονισμού αναφορικά με την τεχνική βοήθεια , εάν βέβαια πρόκειται για τη βοήθεια που εκλαμβάνεται ως μέσο χρήσιμο για την εν γένει διαρθρωτική πολιτική .
Σύμφωνα πάντως με τον γενικό κανονισμό , οποιοδήποτε μέτρο τεχνικής βοήθειας για το οποίο μπορεί να προβληθεί ο ισχυρισμός ότι έχει κάποιον δεσμό με μία κοινοτική πρωτοβουλία , πρέπει να προτείνεται στο πλαίσιο του άρθρου 20 και όχι στο πλαίσιο του άρθρου 23 .
Αυτό σημαίνει ότι το ανώτατο όριο ύψους 0,25 % που προβλέπεται στο άρθρο 23 δεν ισχύει σε αυτό το είδος της τεχνικής βοήθειας .
Κυρίες και κύριοι , μέσα σε πνεύμα αυστηρότητας και διαφάνειας , θεωρώ , παρ ' όλα αυτά , σημαντική τη διατήρηση ορισμένων χρηματοδοτικών κεφαλαίων για ό , τι άπτεται των ανταλλαγών εμπειριών , της ενημέρωσης και όχι της προπαγάνδας , και της δημιουργίας δικτύων που θα διασφαλίζουν μια καλή επικοινωνία μεταξύ των βέλτιστων πρακτικών στους κόλπους της Ένωσης .
Κύριε Πρόεδρε , κυρίες και κύριοι , όσον αφορά το INTERREG συμπεραίνω ότι αυτές οι κοινοτικές πρωτοβουλίες , για τις οποίες είμαι αρμόδιος , ανταποκρίνονται σε μια πραγματική ανάγκη , πράγμα που αποδεικνύεται από όλα όσα ειπώθηκαν εδώ · προοιωνίζουν μάλιστα μια πραγματική πολιτική χωροταξίας των ευρωπαϊκών εδαφών στους κόλπους της διευρυμένης μας Ένωσης .
Η Επιτροπή λοιπόν , όπως και εσείς , προσδίδει σε αυτό το θέμα πολύ μεγάλη σημασία .
Θα είμαι στη διάθεσή σας προκειμένου , όταν έρθει η στιγμή , να σας υποβάλλω την αξιολόγηση του προηγούμενου προγραμματισμού που ζητάτε , καθώς και να σας τηρώ τακτικά ενήμερους σχετικά με την υλοποίηση αυτών των πρωτοβουλιών κατά τη διάρκεια του νέου προγραμματισμού .
Ευχαριστώντας για μια ακόμη φορά όλους εσάς και ιδιαιτέρως την κ. Arlene McCarthy και τον κ. Francis Decourriθre , θα ήθελα να πω για τις δυο αυτές πρωτοβουλίες ότι εντάσσονται σε ένα χρηματοδοτικό πλαίσιο το οποίο το γνωρίζετε καλά : μόνο 700 εκατομμύρια ευρώ για το URBAN , είναι , οπωσδήποτε καλύτερα από το τίποτα · 4 δις 800 εκατομμύρια ευρώ για το INTERREG .
Ενεργούμε λοιπόν μέσα σε αυτό το πλαίσιο και όχι εκτός αυτού .
Όσον αφορά λοιπόν αυτές τις δυο πρωτοβουλίες , με το πρίσμα που παρέχουν στις μελλοντικές στρατηγικές και πολιτικές σκέψεις όσον αφορά τη χωροταξία και στις προσεχείς δημοσιονομικές προοπτικές , θέλω να επισημάνω πόσο ενδιαφέροντα βρήκαμε αυτόν τον εποικοδομητικό διάλογο με το Κοινοβούλιο και τις επιτροπές του .
Κυρίες και κύριοι βουλευτές , αυτό που σας είπα μόλις τώρα αποδεικνύει ότι η Επιτροπή είναι αποφασισμένη να τον λάβει υπόψη της .
( Χειροκροτήματα ) Κυρία Πρόεδρε , αξιότιμοι κυρίες και κύριοι βουλευτές , αξιότιμοι κυρίες και κύριοι , καταρχάς θα ήθελα να εκφράσω τις ευχαριστίες μου στον κ. Procacci για την έκθεση που εκπόνησε .
Θα ήθελα όμως να ευχαριστήσω και συνολικά τις διάφορες επιτροπές που ασχολήθηκαν με την υπόθεση καθώς και το Κοινοβούλιο για την ευρεία υποστήριξη που παρείχαν στην πρωτοβουλία LEADER + .
Η εν λόγω πρωτοβουλία θα προσφέρει νέα κίνητρα στον αγροτικό χώρο με στόχο την ανάπτυξη και τη δοκιμή νέων και πρωτότυπων προσεγγίσεων , οι οποίες θα πρέπει αργότερα να εισαχθούν ως πρότυπο σε γενικά προγράμματα .
Με χαροποιεί επίσης το γεγονός ότι το Κοινοβούλιο υποστηρίζει σε γενικές γραμμές τη γνώμη της Επιτροπής ότι το LEADER + πρέπει να εφαρμοσθεί σε όλες τις αγροτικές περιφέρειες , ότι θα εισαχθούν ανώτερες προτεραιότητες και ότι θα ενισχυθεί προπάντων και η ενεργός συνεργασία καθώς και η δικτύωση των αγροτικών περιοχών .
Επιπλέον διαπιστώνω ότι το Κοινοβούλιο συμμερίζεται την άποψη της Επιτροπής , σύμφωνα με την οποία πρέπει να δοθεί προτεραιότητα στην εφαρμογή του LEADER + υπό μορφή συνολικής εισφοράς .
Αναφερόμενος σε κάποια επί μέρους ζητήματα που τέθηκαν εδώ , μπορώ επίσης να επιβεβαιώσω ότι επιθυμούμε μια κατά το δυνατόν ευρεία εταιρική σχέση και συμμετοχή στο LEADER + .
Οι διάφορες ομάδες , είτε πρόκειται για περιβαλλοντικές οργανώσεις είτε για ομάδες με μέλημα την απασχόληση , έχουν τη δυνατότητα να συμμετέχουν στις εργασίες κατά την εκπόνηση των οδηγιών της Επιτροπής .
Επιπλέον , δεν πρόκειται να διατεθούν λιγότερα , αλλά περισσότερα κονδύλια απ ' ό , τι κατά την τρέχουσα περίοδο .
Θα ήθελα επίσης να υπενθυμίσω το γεγονός ότι η ίδρυση μιας υπηρεσίας παρακολούθησης δεν αποτελεί καινοτομία .
Η εν λόγω υπηρεσία παρακολούθησης υπήρχε ήδη τόσο στο LEADER I όσο και στο LEADER II .
Αποκλειστικός σκοπός αυτής της υπηρεσίας είναι η διατήρηση της δικτύωσης μεταξύ των διαφόρων ομάδων LEADER .
Η χρηματοδότηση της εν λόγω υπηρεσίας παρακολούθησης δεν επιτρέπεται να υπερβαίνει το 2 % των πόρων για το LEADER .
Όσον αφορά τη δυνατότητα εφαρμογής προγραμμάτων με θέμα την εκπαίδευση και την επαγγελματική κατάρτιση , ας μου επιτραπεί να επισημάνω το γεγονός ότι αυτό ειδικά είναι ένα θέμα που ενσωματώσαμε τώρα στη νέα πολιτική για την ανάπτυξη της υπαίθρου , ούτως ώστε από τη δική μας σκοπιά να είναι πλέον περιττό να το πράξουμε στο πλαίσιο του LEADER .
Ας έρθουμε τώρα στο περιεχόμενο της έκθεσης .
Στο σημείο 14 , το Κοινοβούλιο καλεί την Επιτροπή να υποβάλει χωρίς καθυστέρηση μια έκθεση σχετικά με την αξιολόγηση του LEADER II .
Θα ήθελα απλώς να σας επισημάνω το γεγονός ότι αυτό δεν έχει πολύ νόημα κατά τη δεδομένη χρονική στιγμή , επειδή τα κονδύλια μπορούν , ως γνωστόν , να εξακολουθήσουν - και μάλιστα έως το τέλος του 2001 - να υπολογίζονται σύμφωνα με το LEADER II .
Ως εκ τούτου , είμαστε της γνώμης πως είναι λογικότερο να διεξάγουμε την εν λόγω αξιολόγηση μετά το πέρας του προγράμματος .
Φυσικά και θα το πράξουμε , και θα σας στείλουμε και μια σχετική έκθεση .
Στο σημείο 18 , το Κοινοβούλιο προτείνει την έκδοση ενός οδηγού που θα περιλαμβάνει παραδείγματα πρωτοβουλιών που σημείωσαν επιτυχία .
Το μόνο που μπορώ να πω επ ' αυτού είναι ότι ο οδηγός αυτός υπάρχει ήδη .
Εκπονήθηκε ήδη από την Επιτροπή , και μπορώ να τον θέσω στη διάθεση κάθε ενδιαφερόμενου μέλους αυτού του Σώματος .
Στο σημείο 21 , το Κοινοβούλιο τονίζει την ανάγκη να εγκριθούν με ταχύ , πλέον , ρυθμό οι κατευθυντήριες γραμμές για το LEADER + , προκειμένου να ξεκινήσουν τα προγράμματα .
Δεν μπορώ παρά να συμμερισθώ πλήρως το εν λόγω μέλημα .
Μόλις εγκριθεί εδώ στο Κοινοβούλιο η γνωμοδότηση , θα υποβληθούν εκ νέου στην Επιτροπή Γεωργικών Διαρθρώσεων και Αγροτικής Ανάπτυξης οι κατευθυντήριες γραμμές για το LEADER + , ούτως ώστε να δοθεί η δυνατότητα στα κράτη μέλη να επικυρώσουν την προσωρινή έγκριση που χορήγησαν στις 14 Νοεμβρίου .
Πιστεύω πως η Επιτροπή θα μπορέσει στη συνέχεια , κατά την περίοδο Μαρτίου / Απριλίου , να εγκρίνει την τελική διατύπωση των κατευθυντήριων γραμμών .
Και μόλις αυτές δημοσιευθούν στην Επίσημη Εφημερίδα , δεν απομένουν παρά οι μήνες , που είναι μάλιστα έξι τον αριθμό , για την υποβολή των προγραμμάτων LEADER + .
Νομίζω πως είναι σημαντικό να επισημάνω το εξής : οι δαπάνες στο πλαίσιο του LEADER + θα καταστούν επιλέξιμες από τη στιγμή που θα υποβληθεί το πρόγραμμα στην Επιτροπή .
Για τα προγράμματα που θα υποβληθούν πριν από τις 30 Απριλίου τρέχοντος έτους , υφίσταται και η δυνατότητα να καθορισθεί αναδρομικά η 1η Ιανουαρίου ως ημερομηνία έναρξης της επιλεξιμότητας .
Τέλος , στο σημείο 20 , το σχέδιο ψηφίσματος περιέχει επτά συγκεκριμένες προτάσεις τροποποίησης των κατευθυντήριων γραμμών .
Έπειτα από ενδελεχή έλεγχο μπορώ να σας πω ότι οι προτάσεις που περιλαμβάνονται στα εδάφια 2 , 4 , 5 και 7 είναι αποδεκτές από την Επιτροπή και θα εγκριθούν .
Η πρόταση στο εδάφιο 6 θα υιοθετηθεί επίσης εν μέρει , επειδή επιβεβαιώνεται το γεγονός ότι η προθεσμία για την έγκριση των προγραμμάτων στο πλαίσιο του LEADER + θα ανέρχεται κατ ' ανώτατο όριο σε πέντε μήνες .
Η τροπολογία στο εδάφιο 1 καθίσταται εν τω μεταξύ από τη δική μας σκοπιά άκυρη , επειδή το σημείο αυτό επαναδιατυπώθηκε ήδη σύμφωνα με το πνεύμα του Κοινοβουλίου αμέσως μετά τις διαβουλεύσεις με τους εκπροσώπους των κρατών μελών στην Επιτροπή Γεωργικών Διαρθρώσεων και Αγροτικής Ανάπτυξης .
Ως εκ τούτου , παραμένει μόνον η πρόταση τροποποίησης στο εδάφιο 3 .
Η Επιτροπή δεν μπορεί παρά να συμφωνήσει επί της εν λόγω επιθυμίας για τροποποίηση , διότι αυτή ανταποκρίνεται ακριβώς στις αρχικές προτάσεις της ιδίας .
Οφείλω όμως να προσθέσω ότι τα κράτη μέλη θεώρησαν πως υπερέβη τα όρια η συνεργασία των ομάδων δράσης μας με τις αντίστοιχες ομάδες τρίτων χωρών .
Ως εκ τούτου , προέκυψε μια τροποποίηση στην επιτροπή , όμως η Επιτροπή θα λάβει τώρα σύντομα υπόψη το μέλημα του Κοινοβουλίου στην επεξεργασμένη έκδοση και θα εισαγάγει με ανάλογο τρόπο τις κατευθυντήριες γραμμές .
Επίσης , θα συνεχίσει τον αγώνα , προκειμένου αυτό να γίνει αποδεκτό από τα κράτη μέλη .
Θα ήθελα να κάνω μια σύντομη αναφορά στις 13 τροπολογίες που κατατέθηκαν .
Εδώ η Επιτροπή δεν μπορεί να αποδεχθεί τρεις μόνον από αυτές , ήτοι τις τροπολογίες 3 , 12 και 13 .
Τις υπόλοιπες μπορεί να τις αποδεχθεί είτε πλήρως είτε ως προς την ουσία .
( Χειροκροτήματα ) Κυρία Πρόεδρε , κυρίες και κύριοι βουλευτές , είναι μια εξαιρετική συγκυρία το ότι σε αυτήν την περίοδο συζητούμε στο Ευρωπαϊκό Κοινοβούλιο την πρωτοβουλία EQUAL .
