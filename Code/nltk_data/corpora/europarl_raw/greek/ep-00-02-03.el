...
Οχήματα εκτός λειτουργίας Η ημερήσια διάταξη προβλέπει τη συζήτηση της σύστασης για τη δεύτερη ανάγνωση ( Α5-0006 / 2000 ) , εξ ονόματος της Επιτροπής Περιβάλλοντος , Δημόσιας Υγείας και Πολιτικής των Καταναλωτών , σχετικά με την κοινή θέση που καθόρισε το Συμβούλιο για την έκδοση οδηγίας του Ευρωπαϊκού Κοινοβουλίου και του Συμβουλίου που αφορά τα οχήματα στο τέλος του κύκλου ζωής τους ( 8095 / 1 / 1999 - C5-0180 / 1999 - 1997 / 0194 ( COD ) ) ( εισηγητής : ο κ. Florenz ) Κύριε Πρόεδρε , αξιότιμοι κυρίες και κύριοι , αγαπητοί συνάδελφοι , εννέα εκατομμύρια αυτοκίνητα αποσύρονται και καταλήγουν κάθε χρόνο στην Ευρώπη στην πρέσα και στα παλιοσίδερα .
...
Μπορούμε να την αφήσουμε όπως πρότεινε η Επιτροπή .
...
Η σχετική απόφαση δεν θα πρέπει να λαμβάνεται στο κάθε κράτος μέλος .
Εσείς , κυρία Επίτροπε , και το επιτελείο σας θα πρέπει να αποφασίσετε αν αυτά τα ελαφρά οχήματα - πολλοί μιλούν και για οχήματα κατανάλωσης τριών λίτρων - θα λάβουν ειδικό προτιμησιακό καθεστώς .
...
Το Κοινοβούλιο διαθέτει σήμερα ευρύτερες αρμοδιότητες .
...
Στο σημείο αυτό υπάρχει θεμελιώδης διαφορά από τη συζήτηση που έγινε πέρυσι στο Συμβούλιο .
Εκεί δηλαδή εξισώθηκαν αδιάκριτα η απαλλαγή του τελευταίου κατόχου από κάθε δαπάνη και το ζήτημα της χρηματοδότησης της ανακύκλωσης , ενώ τέθηκε υπό αμφισβήτηση η απαλλαγή του τελευταίου κατόχου από την επιβάρυνση .
...
Είμαι υπέρ αυστηρών περιβαλλοντικών προδιαγραφών , το γνωρίζετε από το πρόγραμμα " auto-oil " και τη συζήτηση για τις ανώτατες τιμές εκπομπής αερίων .
Ωστόσο , πιστεύω πως πρέπει να ισχύουν για όλους οι ίδιες προδιαγραφές !
...
Αυτό είναι φυσικά ένα πολύ σημαντικό σημείο .
Και αυτό δεν χρειάζεται να αλλαχθεί .
...
Αποτέλεσμα της προσπάθειας αποτελούν αυτές οι ενδιαφέρουσες τροπολογίες .
Όσον αφορά μάλιστα τη θέση αυτή , πιστεύω ότι μπορεί να βρεθεί μια έμμεση λύση στο πρόβλημα , να συμφιλιώσουμε δηλαδή τις περιβαλλοντικές απαιτήσεις με τις απαιτήσεις της αγοράς και της απασχόλησης .
...
Ποιος πληρώνει τα 262 ευρώ ανά αυτοκίνητο για τα 9 εκατομμύρια αυτοκίνητα που αποσύρονται κάθε χρόνο ; Ποιος πληρώνει για τη συλλογή , την αποσυναρμολόγηση , την απόσυρση και ούτω καθεξής ; Τέλος , πρέπει η οδηγία να έχει αναδρομική ισχύ και να καλύπτει κάθε αυτοκίνητο που έχει κατασκευαστεί μέχρι στιγμής ; Σύμφωνα με την πρόταση του Συμβουλίου , την κοινή θέση , οι κατασκευαστές πρέπει να πληρώσουν το συνολικό κόστος .
...
Αυτό θα επιτρέψει εξάλλου να δοθεί στις επιχειρήσεις ο χρόνος να εξεύρουν κεφάλαια για να αντιμετωπίσουν αυτές τις συμπληρωματικές δαπάνες Σε αυτό το πλαίσιο θα υποστηρίξω συνεπώς , όπως και η Ομάδα μου , την κοινή θέση , όπου παρουσιάζεται μια συμβιβαστική λύση που εξισορροπεί κατά τη γνώμη μου τις απαιτήσεις των επιχειρήσεων και τις απαραίτητες προόδους όσον αφορά την προστασία του περιβάλλοντος .
...
Μέχρι τώρα το Κοινοβούλιο διαδραμάτιζε θετικότατο καταλυτικό ρόλο στην προστασία του περιβάλλοντος , αλλά τώρα στο συγκεκριμένο θέμα θα καταστούμε αρνητικός παράγοντας για το περιβάλλον της Ευρώπης , εάν ψηφιστούν οι τροπολογίες των κ.κ.
Florenz και Lange .
...
Κύριε Πρόεδρε , αξιότιμοι κυρίες και κύριοι , συμφωνούμε όλοι ότι πρέπει να εξετάσουμε ποια είναι η σωστή αντιμετώπιση του προβλήματος των παλιών αυτοκινήτων στην Ευρώπη .
Ωστόσο , το Συμβούλιο στην προκειμένη περίπτωση δεν άσκησε υποδειγματική ευρωπαϊκή περιβαλλοντική πολιτική .
...
Ούτε όμως η απόφαση της φινλανδικής Προεδρίας τον Ιούνιο ήταν η καλύτερη δυνατή .
...
Δεν αναγνωρίζει τις συσχετίσεις των σημαντικών παραγόντων , και δεν μπορεί κανείς να ισχυρισθεί , όπως έκανε η συνάδελφος της Ομάδας των Πρασίνων , ότι είναι η πρώτη φορά που το Ευρωπαϊκό Κοινοβούλιο αποδυναμώνει μια κοινή θέση .
Διότι από τη σκοπιά της πολιτικής για το περιβάλλον δεν είναι καθόλου σωστό επιβάλλοντας αυστηρά και υψηλά ποσοστά ανακύκλωσης να εμποδίσουμε την παραγωγή σύγχρονων αυτοκινήτων με μικρή κατανάλωση , όπως είναι το αυτοκίνητο των 3 λίτρων , όπου βέβαια χρησιμοποιείται μεγάλη ποσότητα πλαστικών .
...
Η χωρίς περιορισμούς ευθύνη των παραγωγών ενέχει επίσης τον κίνδυνο να εξαφανιστεί η αγορά μεταχειρισμένων ανταλλακτικών .
...
Πιστεύω συνεπώς ότι το Κοινοβούλιο δεν μπορεί να επιβάλει καταναγκασμούς , και θα ήταν παράδοξο να κάνει κάτι τέτοιο προς την κατεύθυνση της επαναξιολόγησης της περιβαλλοντικής επίδρασης του κανονισμού .
Υπενθυμίζω πως οι παραγωγοί αυτοκινήτων παραδέχτηκαν ότι μπορούν να συνυπάρξουν με την οδηγία .
Οι δαπάνες δεν είναι υπερβολικές .
Η ανακύκλωση ενός αυτοκινήτου κοστίζει λιγότερο από το 1 τοις εκατό της τιμής ενός καινούργιου αυτοκινήτου .
...
Για τα υπόλοιπα αυτοκίνητα μπορεί να προβλεφθεί ωστόσο μια μορφή κατανομής των βαρών , όπως προτείνουν οι τροπολογίες αριθ .
44 και 45 , τις οποίες κατέθεσε ο κ. Lange , οι μόνες που θεωρώ συμβατές με την ισορροπία της κοινής θέσης και με την εμπειρία που έχει ήδη αποκτηθεί σε μερικές χώρες , και τις οποίες μπορούμε κατά συνέπεια να υποστηρίξουμε .
...
Κύριε Πρόεδρε , κυρία Επίτροπε , ζήτησα για άλλη μια φορά τον λόγο για να πω δυο λόγια ακόμη μετά τη συζήτηση αυτή .
Αγαπητοί συνάδελφοι , αν επισκεφθεί κανείς τις Κάτω Χώρες θα διαπιστώσει ότι εκεί ο τελευταίος κάτοχος κάθε αυτοκινήτου μπορεί να το παραδώσει χωρίς επιβάρυνση .
Θα διαπιστώσει ακόμη ότι η ανακύκλωση των οχημάτων αυτών γίνεται με ορθολογικό τρόπο , ότι αξιοποιήθηκαν νέες μέθοδοι ροής υλικών για την επαναχρησιμοποίησή τους , ότι ανακυκλώνεται το 85 % του βάρους του αυτοκινήτου και ότι στη χώρα αυτή ανακυκλώνεται το 92 % του συνόλου των αυτοκινήτων .
Η χρηματοδότηση γίνεται από ένα ταμείο στο οποίο πληρώνει εισφορά όποιος αγοράζει καινούργιο αυτοκίνητο .
Κυρία Breyer , βλέπετε αυτό να είναι κακό από οικολογική σκοπιά ; Εγώ λέω ότι δεν είναι .
Στις Κάτω Χώρες υπάρχει ένα πρότυπο υποδειγματικής ανακύκλωσης αυτοκινήτων σαν αυτό που επιθυμεί η οδηγία , και το ερώτημα αν θα πληρώνει όποιος αγοράζει καινούργιο αυτοκίνητο ή για τα παλιά οχήματα που κυκλοφορούν σήμερα , ο κατασκευαστής , δεν έχει καμία , μα απολύτως καμία σχέση με οικολογία , παρά είναι καθαρά ζήτημα ανταγωνισμού !
( Χειροκροτήματα ) Το ερώτημα εδώ είναι αν ένας Ευρωπαίος κατασκευαστής θα πρέπει να πληρώνει 250 εκατ. ευρώ και ένας Κορεάτης 2 εκατ. ευρώ .
Εγώ υποστηρίζω ότι για χάρη των ανθρώπων που εργάζονται στην ευρωπαϊκή αυτοκινητοβιομηχανία δεν πρέπει να διαμορφώσουμε έναν άνισο ανταγωνισμό .
Για χάρη της προστασίας του περιβάλλοντος θέλω ο τελευταίος κάτοχος να μην επιβαρύνεται , παρά η ανακύκλωση να χρηματοδοτείται από ένα ταμείο , ενώ φυσικά για τα νέα αυτοκίνητα πρέπει να είναι υπεύθυνος ο κατασκευαστής , γιατί τότε θα πρέπει επίσης να αναλάβει την ευθύνη κατασκευής αυτοκινήτων που μπορούν να ανακυκλωθούν εύκολα !
( Χειροκροτήματα από την Ομάδα του Κόμματος των Ευρωπαίων Σοσιαλιστών ) Κύριε Πρόεδρε , η πρόταση την οποία συζητούμε έχει πολλά θετικά σημεία , το γεγονός δηλαδή ότι προσανατολίζεται στην πρόληψη της διάθεσης αποβλήτων , στην επαναχρησιμοποίηση , την ανάκτηση και την ανακύκλωση των εξαρτημάτων , στην επαναχρησιμοποίηση των υλικών , κ.λπ ..
...
Αφού το εγχείρημα πέτυχε στη χώρα μας , γιατί να μην επιτύχει και αλλού ; Κύριε Πρόεδρε , αξιότιμοι βουλευτές του Κοινοβουλίου , σας ευχαριστώ για την ενδιαφέρουσα συζήτηση και τα πολλά και σημαντικά επιχειρήματα που διατυπώθηκαν .
...
Πρώτον : ποιος θα πληρώσει ; Δεύτερον : κατά πόσον επιδεινώνουμε με αυτή την πρόταση την ανταγωνιστικότητα της ευρωπαϊκής αυτοκινητοβιομηχανίας ; Η πρώτη ερώτηση αφορά , λοιπόν , το ποιος θα πληρώσει .
...
ΨΗΦΟΦΟΡIΕΣ Κυρία Πρόεδρε , όπως γνωρίζετε , ο λόγος για τον οποίο ψηφίζουμε σήμερα την έκθεση αυτή και όχι την προηγούμενη εβδομάδα είναι τα πολυάριθμα και σοβαρά μεταφραστική λάθη , ιδίως στα γαλλικά .
...
Υπάρχει ένα λάθος το οποίο δεν έχει ακόμη διορθωθεί σχετικά με την τροπολογία αριθ .
4 .
...
( Το Σώμα εγκρίνει το ψήφισμα ) Έκθεση ( A5-0011 / 2000 ) του κ. Langen , εξ ονόματος της αντιπροσωπείας του Ευρωπαϊκού Κοινοβουλίου στην επιτροπή συνδιαλλαγής , σχετικά με το εγκριθέν από την επιτροπή συνδιαλλαγής κοινό σχέδιο απόφασης του Ευρωπαϊκού Κοινοβουλίου και του Συμβουλίου για τη θέσπιση πολυετούς προγράμματος για την προώθηση των ανανεώσιμων πηγών ενέργειας στην Κοινότητα - ALTENER ( C5-0333 / 1999 - 1997 / 0370 ( COD ) ) ( Το Σώμα εγκρίνει το κοινό σχέδιο ) Έκθεση ( A5-0010 / 2000 ) της κ. Ahern , εξ ονόματος της αντιπροσωπείας του Ευρωπαϊκού Κοινοβουλίου στην επιτροπή συνδιαλλαγής , σχετικά με το εγκριθέν από την επιτροπή συνδιαλλαγής κοινό σχέδιο απόφασης του Ευρωπαϊκού Κοινοβουλίου και του Συμβουλίου περί θέσπισης πολυετούς προγράμματος-πλαισίου για δράσεις στον τομέα της ενέργειας- SAVE ( C5-0334 / 1999 - 1997 / 0371 ( COD ) ) ( Το Σώμα εγκρίνει το κοινό σχέδιο ) Έκθεση ( A5-0009 / 2000 ) του κ. Graηa Moura , εξ ονόματος της αντιπροσωπείας του Ευρωπαϊκού Κοινοβουλίου στην επιτροπή συνδιαλλαγής , σχετικά με το εγκριθέν από την επιτροπή συνδιαλλαγής κοινό σχέδιο απόφασης του Ευρωπαϊκού Κοινοβουλίου και του Συμβουλίου για τη θέσπιση ενός ενιαίου μέσου χρηματοδότησης και προγραμματισμού για την πολιτιστική συνεργασία ( Πρόγραμμα " Πολιτισμός 2000 " ) ( C5-0327 / 1999 - 1998 / 0169 ( COD ) ) ( Το Σώμα εγκρίνει το κοινό σχέδιο ) Σύσταση για τη δεύτερη ανάγνωση ( A5-0006 / 2000 ) , εξ ονόματος της Επιτροπής Περιβάλλοντος , Δημόσιας Υγείας και Πολιτικής των Καταναλωτών , σχετικά με την κοινή θέση που καθόρισε το Συμβούλιο ( 8095 / 1 / 1999 - C5-0180 / 1999 - 1997 / 0194 ( COD ) ) για την έκδοση οδηγίας του Ευρωπαϊκού Κοινοβουλίου και του Συμβουλίου που αφορά τα οχήματα στο τέλος του κύκλου ζωής τους ( Εισηγητής : ι κ. Florenz ) ( Η Πρόεδρος αναγγέλλει την έγκριση της κοινής θέσης όπως τροποποιήθηκε ) Έκθεση ( A5-0007 / 2000 ) του κ. Berger , εξ ονόματος της Επιτροπής Νομικών Θεμάτων και Εσωτερικής Αγοράς , σχετικά με την πρόταση οδηγίας του Ευρωπαϊκού Κοινοβουλίου και του Συμβουλίου που αφορά τoυς όρoυς απόσπασης τωv μισθωτώv εργαζoμέvωv υπηκόωv τρίτoυ κράτoυς στo πλαίσιo παρoχής διασυvoριακώv υπηρεσιώv ( COM ( 1999 ) 0003 - C5-0095 / 1999 - 1999 / 0012 ( COD ) ) ( Το Σώμα εγκρίνει το ψήφισμα νομοθετικού περιεχομένου ) Έκθεση ( A5-0012 / 2000 ) του κ. Berger , εξ ονόματος της Επιτροπής Νομικών Θεμάτων και Εσωτερικής Αγοράς , σχετικά με την πρόταση οδηγίας του Συμβουλίου που αφορά την επέκταση της ελεύθερης παρoχής διασυνoριακών υπηρεσιών στoυς υπηκόoυς τρίτoυ κράτoυς πoυ είναι εγκατεστημένoι στo εσωτερικό της Κoινότητας ( COM ( 99 ) 0003 - C5-0050 / 2000 - 1999 / 0013 ( CNS ) ) ( Το Σώμα εγκρίνει το ψήφισμα νομοθετικού περιεχομένου ) Έκθεση ( A5-0003 / 2000 ) του κ. Marinho , εξ ονόματος της Επιτροπής Νομικών Θεμάτων και Εσωτερικής Αγοράς , σχετικά με : I. το σχέδιο απόφασης του Συμβουλίου που αφορά την τροποποίηση της απόφασης 88 / 591 / ΕΚΑΧ , ΕΟΚ , ΕΚΑΕ περί ιδρύσεως Πρωτοδικείου των Ευρωπαϊκών Κοινοτήτων ( 5713 / 1999 - C5-0020 / 1999 - 1999 / 0803 ( CNS ) ) και II. το σχέδιο απόφασης του Συμβουλίου που αφορά την τροποποίηση της απόφασης 88 / 591 / ΕΚΑΧ , ΕΟΚ , ΕΚΑΕ περί ιδρύσεως Πρωτοδικείου των Ευρωπαϊκών Κοινοτήτων ( 9614 / 1999 - C5-0167 / 1999 - 1999 / 0805 ( CNS ) ) ( Με διαδοχικές ψηφοφορίες το Σώμα εγκρίνει τα δύο ψηφίσματα νομοθετικού περιεχομένου ) Έκθεση ( A5-0022 / 2000 ) του κ. Brok , εξ ονόματος της Επιτροπής Εξωτερικών Υποθέσεων , Δικαιωμάτων του Ανθρώπου , Κοινής Ασφάλειας και Αμυντικής Πολιτικής , σχετικά με την πρόταση απόφασης του Συμβουλίου που αφορά την παροχή έκτακτης χρηματοδοτικής βοήθειας στο Κοσσυφοπέδιο ( COM ( 99 ) 0598 - C5-0045 / 2000 - 1999 / 0240 ( CNS ) ) Κυρία Πρόεδρε , θα ήθελα μόνο να επισημάνω ότι κατά τη διαδικασία δεν κατέστη δυνατό ούτε να παρουσιάσουμε ούτε , κατά συνέπεια , να ψηφίσουμε τροπολογίες στα πλαίσια της επιτροπής .
...
( Το Σώμα εγκρίνει το ψήφισμα νομοθετικού περιεχομένου ) Έκθεση ( A5-0018 / 2000 ) των κ.κ.
Δημητρακόπουλου και Leinen , εξ ονόματος της Επιτροπής Συνταγματικών Υποθέσεων , σχετικά με τη σύγκληση της Διακυβερνητικής Διάσκεψης ( 14094 / 1999 - C5-0341 / 1999 - 1999 / 0825 ( CNS ) ) ( Το Σώμα εγκρίνει το ψήφισμα ) Κοινή πρόταση ψηφίσματος σχετικά με τις διαπραγματεύσεις στην Αυστρία ενόψει της συγκρότησης της κυβέρνησης Κύρια Πρόεδρε , και σε αυτό το θέμα αντιμετωπίζουμε μια σειρά προβλημάτων μετάφρασης .
...
« Condemns Mr Haider for his insults towards certain EU Member States and their leaders in the last few days in statements , which Foreign Minister Schόssel has failed to condemn . »
( Καταδικάζει τον κ. Haider για τις προσβολές που απηύθυνε εις βάρος ορισμένων κρατών μελών της ΕΕ και των ηγετών τους σε δηλώσεις του τις τελευταίες ημέρες , τις οποίες ο Υπουργός Εξωτερικών Schόssel δεν καταδίκασε . )
( Ανω των δώδεκα βουλευτών εγείρονται ) ( Το Σώμα εγκρίνει το ψήφισμα ) ΑΙΤΙΟΛΟΓΗΣΕΙΣ ΨΗΦΟΥ Έκθεση McNally ( A5-0082 / 1999 ) Εκφράζω την ικανοποίησή μου για την εξαιρετική αυτή έκθεση σχετικά με την ανακοίνωση " Γυναίκες και επιστήμη " !
...
Γιατί λοιπόν δεν θα πρέπει να επισημάνουμε πως η Επιτροπή ανέφερε στο κείμενό της πως θεωρεί απαραίτητο να επιδιωχθεί ποσοστό τουλάχιστον 40 % για τη συμμετοχή των γυναικών σε όλα τα επίπεδα της εφαρμογής και της διαχείρισης των ερευνητικών προγραμμάτων ; Δεν πρόκειται για ποσόστωση !
...
Δεύτερη ανάγνωση Florenz ( A5-0006 / 2000 ) Κυρία Πρόεδρε , αξιότιμοι κυρίες και κύριοι , αγαπητοί συνάδελφοι , σήμερα ψηφίσαμε σε δεύτερη ανάγνωση για τις τροπολογίες της οδηγίας για τα παλιά αυτοκίνητα .
...
Η οδηγία για τα εκτός λειτουργίας οχήματα θα αποτελέσει παράδειγμα για τη μελλοντική νομοθεσία , και επομένως είναι σημαντικό να είναι σαφής η ευθύνη του κατασκευαστή , κάτι που δεν πρέπει επ ' ουδενί να τεθεί υπό αμφισβήτηση . -Josse ( EDD ) , γραπτώς .
( FR ) Το Κοινοβούλιο εξετάζει σήμερα για τελευταία φορά αυτό το κείμενο σχετικά με τα οχήματα " στο τέλος του κύκλου ζωής τους " και τη μοίρα τους , δηλαδή την καταστροφή , αξιέπαινος σκοπός χάριν σεβασμού στο περιβάλλον μας .
...
Έκθεση Berger ( A5-0007 / 2000 ) Σκοπός της παρούσας πρότασης οδηγίας είναι ο καθορισμός των όρων για την απόσπαση των μισθωτών εργαζομένων υπηκόων τρίτου κράτους στο πλαίσιο της παροχής διασυνοριακών υπηρεσιών .
...
Έκθεση Berger ( A5-0007 / 2000 ) και Berger ( A5-0012 / 2000 ) Χαιρετίζω με πολύ μεγάλη ικανοποίηση τις δύο προτάσεις οδηγιών οι οποίες έχουν στόχο να διευκολύνουν την ελεύθερη κυκλοφορία των εργαζομένων υπηκόων τρίτου κράτους διευκολύνοντας ταυτόχρονα την ελεύθερη κυκλοφορία των υπηρεσιών .
...
Έκθεση Marinho ( A5-0003 / 2000 ) : , γραπτώς .
( FR ) Διατηρούμε σοβαρές επιφυλάξεις έναντι των προτάσεων τροποποίησης του Συμβουλίου .
...
Ορισμένοι θα πουν πως τίποτα δεν είναι τέλειο σε αυτόν τον κόσμο , όμως μια σύντομη ιστορική αναδρομή θα τους επιτρέψει να κατανοήσουν καλύτερα τις επιφυλάξεις μας : Την 1η Ιανουαρίου 1995 το Συμβούλιο έθεσε και πάλι το θέμα της αύξησης του αριθμού των δικαστών που ορίζεται στο άρθρο 17 της Συνθήκης Προσχώρησης της 24ης Ιουνίου 1994 .
...
Θα υπάρξει άραγε καλύτερη ευκαιρία από την επικείμενη Διακυβερνητική Διάσκεψη ; Έκθεση Δημητρακόπουλου , Leinen ( A5-0018 / 2000 ) Το σημαντικότερο έργο της επικείμενης Διακυβερνητικής Διάσκεψης είναι η μεταρρύθμιση της ΕΕ ενόψει της ένταξης των νέων κρατών μελών .
...
Leinen και Δημητρακόπουλου .
Το κείμενο είναι υπερβολικά φιλόδοξο και οι Βρετανοί ευρωβουλευτές του Εργατικού Κόμματος πιστεύουν ότι η ΔΔ πρέπει κατ ' αρχάς να ασχοληθεί με τα " υπολείμματα του Αμστερνταμ " προκειμένου να προετοιμάσει τη διεύρυνση και όχι να επεκταθεί πολύ πέρα από αυτά .
...
Θα μιλήσω για το γερμανικό σοσιαλιστικό κόμμα , το οποίο έχει την αξίωση να μας κάνει μαθήματα για τον Δεύτερο Παγκόσμιο Πόλεμο , αυτό που είναι διεθνοσοσιαλιστικό όπως οι όμοίοι του ήταν εθνικοσοσιαλιστές , πάντοτε με βάδισμα χήνας , το κόμμα των Waffen-SS · ( Η Πρόεδρος αφαιρεί τον λόγο από τον ομιλητή ) Κυρία Πρόεδρε , το ψήφισμα αυτό μου δημιούργησε μεγάλο πρόβλημα .
...
Εκτίμησα πολύ τη θέση των Ιταλών Ριζοσπαστών .
Και το λέγω αυτό διακηρύσσοντας ξεκάθαρα την ιστορική και ουσιαστική διαφορά που υπάρχει ανάμεσα στους Ιταλούς και στους Αυστριακούς Ριζοσπάστες .
...
Τα 14 ευρωπαϊκά κράτη κατέδειξαν αυτή την αποφασιστικότητα καταδικάζοντας ομόφωνα και αμέσως , με τη φωνή του Α .
Guterres , τον κίνδυνο του αυστριακού πολιτικού ολισθήματος .
...
Από τη στιγμή όμως που στερείται τα νομικά μέσα αυτής της πολιτικής βούλησης - οι κυρώσεις που προβλέπονται στο άρθρο 7 των Συνθηκών είναι σχεδόν ανεφάρμοστες - θα μπορέσει άραγε να διατηρήσει το ανάστημα ψηλά απέναντι στην απειλή συστηματικής εμπλοκής όλου του θεσμικού οικοδομήματός της ; Σήμερα διακυβεύεται η αξιοπιστία της , προτού υποδεχθεί αύριο τις νέες , εύθραυστες ακόμη , δημοκρατίες του πρώην ανατολικού μπλοκ .
...
Για τον λόγο αυτό η Ευρωπαϊκή Ένωση πρέπει να διασαφηνίσει τη θέση της σχετικά με την τρέχουσα κατάσταση στην Αυστρία. γραπτώς ( SV ) Υπερψηφίσαμε το κοινό ψήφισμα για να εκφράσουμε την αλληλεγγύη μας προς όλους αυτούς που αγωνίζονται εναντίον της ξενοφοβίας και του ρατσισμού .
...
Με μεγάλη ανησυχία παρακολουθούμε την επέλαση των δυνάμεων της άκρας Δεξιάς στην Ευρώπη , και συγκεκριμένα στην Αυστρία , στη Γερμανία , στη Γαλλία , στο Βέλγιο και στην Ιταλία .
Έχει ουσιαστική σημασία να αναζητήσουμε τα βαθύτερα αίτια αυτού του φαινομένου και να λάβουμε όλα τα αναγκαία μέτρα ώστε να το αναχαιτίσουμε .
Εφόσον γνωρίζουμε ότι η επιδείνωση των κοινωνικών ανισοτήτων , η ανεργία ή τα προβλήματα της φτώχειας και του κοινωνικού αποκλεισμού δημιουργούν πρόσφορο έδαφος για την ανάπτυξη του λαϊκισμού της άκρας Δεξιάς , προβάλλει ως επιτακτική ανάγκη να λάβουν τα ευρωπαϊκά θεσμικά όργανα όλα τα αναγκαία μέτρα ώστε να αποτρέψουν την περαιτέρω ανάπτυξη των ρατσιστικών και ξενόφοβων ιδεολογιών .
Αυτό επιβάλλει μια εκ βάθρων μεταβολή των οικονομικών και κοινωνικών πολιτικών του νεοφιλελεύθερου καπιταλισμού , επιτάσσει να τεθεί ως στόχος προτεραιότητας η δημιουργία θέσεων απασχόλησης ποιότητας οι οποίες συνεπάγονται δικαιώματα , απαιτεί την εφαρμογή πολιτικών που θα ενδυναμώνουν τη συμμετοχική δημοκρατία και την προσφορά στους πολίτες μιας παιδείας όπου θα δίδεται ιδιαίτερη έμφαση στις αξίες της δημοκρατίας και της αλληλεγγύης .
Όπως ακριβώς καταγγέλλουμε και αντιπαλεύουμε τις ιδέες και τις δραστηριότητες της άκρας Δεξιάς , έτσι ακριβώς εκφράζουμε ταυτόχρονα και την αλληλεγγύη μας προς τον λαό της Αυστρίας και υποστηρίζουμε όλες τις δυνάμεις που αγωνίζονται για την εδραίωση της δημοκρατίας παλεύοντας κατά του ρατσισμού και της ξενοφοβίας .
...
Αιτία της δύναμης του Φιλελεύθερου Kόμματος της Αυστρίας είναι η αδυναμία εκείνων που κυβερνούσαν έως σήμερα .
Εδώ το κύριο μέρος της ευθύνης φέρουν οι Σοσιαλιστές της Αυστρίας .
...
Υπό τέτοιες συνθήκες θα είναι άραγε ακόμη χρήσιμη η διοργάνωση εκλογών ; Με αυτόν τον τρόπο δεν διαμορφώνουμε τις προϋποθέσεις για να ζήσουν αρμονικά και να μπορέσουν να συνεργασθούν για ένα κοινό μέλλον τα έθνη της Ευρώπης .
Ψηφίζω κατά της κοινής πρότασης ψηφίσματος σχετικά με τα αποτελέσματα των βουλευτικών εκλογών στην Αυστρία και της πρόθεσης σχηματισμού μιας κυβέρνησης συνασπισμού μεταξύ του Αυστριακού Λαϊκού Κόμματος και του Φιλελεύθερου Kόμματος της Αυστρίας , για λόγους που κατατάσσονται σε τρεις κατηγορίες : πρώτον , επειδή δεν έγιναν αποδεκτές οι χωριστές ψηφοφορίες που είχαμε ζητήσει , αλλά ούτε εγκρίθηκαν ορισμένες από τις τροπολογίες που καταθέσαμε , οι οποίες θα προσέδιδαν στο σύνολό τους άλλη συνεκτικότητα και άλλο περιεχόμενο στο κείμενο · δεύτερον , διότι το κείμενο του ψηφίσματος που τελικώς εγκρίθηκε εμπεριέχει μια αντίφαση στην ίδια του τη διατύπωση : ενώ από τη μια στην αιτιολογική σκέψη Δ επισημαίνουμε πως η προσήλωση στην προώθηση και προάσπιση των ευρωπαϊκών δημοκρατικών αξιών από πλευράς της ΕΕ και των θεσμικών της οργάνων συνεπάγεται την αναγνώριση του συνόλου των δημοκρατικών δικαιωμάτων και των συνταγματικών προνομίων των οποίων απολαύει ο αυστριακός λαός και το αυστριακό κράτος , από την άλλη στο σημείο 4 δείχνουμε ότι συμφωνούμε , και χαιρετίζουμε κιόλας , την πολιτική πρόθεση που κρύβεται πίσω από τη δήλωση της πορτογαλικής Προεδρίας , η οποία κατά τη γνώμη μας δεν ήταν τίποτε άλλο από μια βιαστική , ατυχής και αθέμιτη επέμβαση στο αποτέλεσμα της ελεύθερης άσκησης των δημοκρατικών δικαιωμάτων και των συνταγματικών προνομίων του αυστριακού κράτους και του λαού της Αυστρίας · και εκφράζουμε αυτή την άποψη διότι όντως - και εδώ εντοπίζεται ο τρίτος λόγος που καθορίζει την ψήφο μας - το αποτέλεσμα της ελεύθερης και δημοκρατικής άσκησης του δικαιώματος ψήφου από μεριάς του αυστριακού λαού δεν μπορεί να κατακριθεί , αλλά πρέπει να γίνει σεβαστό , ή τουλάχιστον δεν μπορεί να κριθεί εκ των προτέρων , όπως συμβαίνει στην προκειμένη περίπτωση .
Πράγματι , με αυτό το ψήφισμα , όπως και με όλες τις άλλες παρεμφερείς θέσεις , δεν εκδηλώνουμε τον παραμικρό σεβασμό για την εκπεφρασμένη ετυμηγορία του εκλογικού σώματος ενός κράτους μέλους της ΕΕ , εκτός του ότι δεν ανεχόμαστε ( επικαλούμενοι κατά περίεργο τρόπο την ανεκτικότητα ) το ενδεχόμενο να αφήσουμε τη λύση διακυβέρνησης που συνεπάγεται αυτό το αποτέλεσμα να τραβήξει τον δρόμο της και να μπορέσει να αποδείξει τις κατ ' επανάληψη εκπεφρασμένες προθέσεις και πολιτικές διακηρύξεις της , συγκεκριμένα απέναντι στις κατηγορίες στις οποίες υπήρξε στόχος .
Επιπλέον , η ηλιθιότητα στην όλη υπόθεση έγκειται στο γεγονός ότι αυτό το ψήφισμα προσφέρει τη δυνατότητα ενίσχυσης των θέσεων εκείνων που αποσκοπεί να καταγγείλει , που θα το καπηλευθούν και θα θέσουν εαυτόν στη θέση του θύματος , δημιουργώντας εντέλει ένα σοβαρότατο προηγούμενο στους κόλπους της ίδιας της ΕΕ , ένα προηγούμενο που το μόνο που θα κάνει είναι να υπονομεύσει ακόμα περισσότερο το κλίμα εμπιστοσύνης και αμοιβαίου σεβασμού που πρέπει να εγκατασταθεί ανάμεσα σε έθνη και πολίτες που προσδοκούν να ακολουθήσουν μια κοινή πορεία με πνεύμα ισότητας και σεβασμού των εθνικών κυριαρχιών , ένα κλίμα που πρέπει να επικρατήσει ακόμη και με ορισμένους , όπως εμείς , που ναι μεν διαφωνούμε ριζικά με τις ρατσιστικές και ξενόφοβες αντιλήψεις που αναπτύσσονται λίγο πολύ παντού στην Ευρώπη , αλλά που προτιμούμε να τις αντιπαλέψουμε αντιμετωπίζοντας αποφασιστικά τα αίτια που τις γεννούν .
...
Αυτός είναι ο λόγος που καταψήφισα το άρθρο 2 του ψηφίσματος .
Ωστόσο , αυτό προϋποθέτει ότι όλα τα μέρη σέβονται τα ανθρώπινα δικαιώματα .
...
Διακoπή της συvσδoυ Κηρύσσω τη διακοπή της συνόδου του Ευρωπαϊκού Κοινοβουλίου .
